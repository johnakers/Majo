...
class HXCPP_CLASS_ATTRIBUTES FlxTypedBasePath_obj : public  ::flixel::FlxBasic_obj
{
	...
	public:
		...
		::Dynamic drawDebugOnCamera_dyn();
		 ...
		 ::flixel::math::FlxBasePoint copyWorldToScreenPos( ::flixel::math::FlxBasePoint point, ::flixel::FlxCamera camera, ::flixel::math::FlxBasePoint result);
		::Dynamic copyWorldToScreenPos_dyn();

		void drawNode( ::openfl::display::Graphics gfx, ::flixel::math::FlxBasePoint node,int size,int color);
		::Dynamic drawNode_dyn();

		void drawLine( ::openfl::display::Graphics gfx, ::flixel::math::FlxBasePoint node1, ::flixel::math::FlxBasePoint node2);
