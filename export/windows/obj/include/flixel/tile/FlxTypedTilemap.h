...
class HXCPP_CLASS_ATTRIBUTES FlxTypedTilemap_obj : public  ::flixel::tile::FlxBaseTilemap_obj
{
	...
	public:
		...
		virtual  ::Dynamic createTile(int index,Float width,Float height);
		...
		bool forEachOverlappingTileHelper( ::flixel::FlxObject object, ::Dynamic filter, ::flixel::math::FlxBasePoint position,bool stopAtFirst);
		::Dynamic forEachOverlappingTileHelper_dyn();
		...
		::Array< ::Dynamic> getTileCoords(int tileIndex,::hx::Null< bool >  midpoint);
