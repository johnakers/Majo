...
class HXCPP_CLASS_ATTRIBUTES FlxBaseTilemap_obj : public  ::flixel::FlxObject_obj
{
	...
	public:
		...
		virtual int getColumnAt(Float worldX,::hx::Null< bool >  bind);
		::Dynamic getColumnAt_dyn();

		virtual int getRowAt(Float worldY,::hx::Null< bool >  bind);
		::Dynamic getRowAt_dyn();

		virtual Float getColumnPos(Float column,::hx::Null< bool >  midPoint);
		::Dynamic getColumnPos_dyn();

		virtual Float getRowPos(int row,::hx::Null< bool >  midPoint);
		...
		virtual bool isOverlappingTile( ::flixel::FlxObject object, ::Dynamic filter, ::flixel::math::FlxBasePoint position);
		::Dynamic isOverlappingTile_dyn();

		virtual bool forEachOverlappingTile( ::flixel::FlxObject object, ::Dynamic func, ::flixel::math::FlxBasePoint position);
		...
		virtual bool objectOverlapsTiles( ::Dynamic object, ::Dynamic callback, ::flixel::math::FlxBasePoint position,::hx::Null< bool >  isCollision);
