...
class HXCPP_CLASS_ATTRIBUTES FlxStringUtil_obj : public ::hx::Object
{
	...
	public:
		...
		static ::String imageToCSV( ::Dynamic graphic,::hx::Null< bool >  invert,::hx::Null< int >  scale,::Array< int > colorMap);
		...
		static  ::EReg whitespace;
		static ::String capitalizeFirstLetters(::String str);
		static ::Dynamic capitalizeFirstLetters_dyn();

		static  ::EReg roman;
		static bool isRomanNumeral(::String str);
		static ::Dynamic isRomanNumeral_dyn();
