...
class HXCPP_CLASS_ATTRIBUTES FlxColor_Impl__obj : public ::hx::Object
{
	...
	public:
		...
		static int setHSB(int this1,Float Hue,Float Saturation,Float Brightness,::hx::Null< Float >  Alpha);
		static ::Dynamic setHSB_dyn();

		static int setHSL(int this1,Float Hue,Float Saturation,Float Lightness,::hx::Null< Float >  Alpha);
		...
		static Float get_luminance(int this1);
