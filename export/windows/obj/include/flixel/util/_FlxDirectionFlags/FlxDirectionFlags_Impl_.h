...
class HXCPP_CLASS_ATTRIBUTES FlxDirectionFlags_Impl__obj : public ::hx::Object
{
	...
	public:
		...
		static int _hx_not(int this1);
		static ::Dynamic _hx_not_dyn();

		static int toIntImplicit(int this1);
		static ::Dynamic toIntImplicit_dyn();
		...
		static int fromIntImplicit(int value);
		static ::Dynamic fromIntImplicit_dyn();

		static int fromInt(int value);
		static ::Dynamic fromInt_dyn();

		static int fromDir(int dir);
		static ::Dynamic fromDir_dyn();
