...
class HXCPP_CLASS_ATTRIBUTES FlxArrayUtil_obj : public ::hx::Object
{
	...
	public:
		...
		static ::cpp::VirtualArray fastSplice_flixel_system_debug_watch_WatchBase_TEntry(::cpp::VirtualArray array, ::Dynamic element);
		static ::Dynamic fastSplice_flixel_system_debug_watch_WatchBase_TEntry_dyn();
