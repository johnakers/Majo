...
HX_DECLARE_STACK_FRAME(_hx_pos_a2c5aad29e94c731_944_new)
...
HXLINE( 945)		( ( ::flixel::group::FlxTypedGroupIterator)(__this) )->_groupMembers = groupMembers;
HXLINE( 946)		( ( ::flixel::group::FlxTypedGroupIterator)(__this) )->_filter = filter;
HXLINE( 947)		( ( ::flixel::group::FlxTypedGroupIterator)(__this) )->_cursor = 0;
HXLINE( 948)		( ( ::flixel::group::FlxTypedGroupIterator)(__this) )->_length = ( ( ::flixel::group::FlxTypedGroupIterator)(__this) )->_groupMembers->get_length();
            	}
