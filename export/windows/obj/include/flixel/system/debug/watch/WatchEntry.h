...
class HXCPP_CLASS_ATTRIBUTES WatchEntry_obj : public  ::openfl::display::Sprite_obj
{
	...
	public:
		...
		void __construct(::String displayName, ::flixel::_hx_system::debug::watch::WatchEntryData data);
		...
		static ::hx::ObjectPtr< WatchEntry_obj > __new(::String displayName, ::flixel::_hx_system::debug::watch::WatchEntryData data);
		static ::hx::ObjectPtr< WatchEntry_obj > __alloc(::hx::Ctx *_hx_ctx,::String displayName, ::flixel::_hx_system::debug::watch::WatchEntryData data);
		...
		static ::Dynamic formatValue_dyn();

		 ::flixel::_hx_system::debug::watch::WatchEntryData data;
		::String displayName;
		 ::flixel::util::_FlxSignal::FlxSignal0 onRemove;
		...
		bool canEdit( ::flixel::_hx_system::debug::watch::WatchEntryData data);
		::Dynamic canEdit_dyn();
