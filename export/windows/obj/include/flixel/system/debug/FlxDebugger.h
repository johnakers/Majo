...
class HXCPP_CLASS_ATTRIBUTES FlxDebugger_obj : public  ::openfl::display::Sprite_obj
{
	...
	public:
		...
		void __construct(Float width,Float height,::hx::Null< int >  __o_scale);
		...
		static ::hx::ObjectPtr< FlxDebugger_obj > __new(Float width,Float height,::hx::Null< int >  __o_scale);
		static ::hx::ObjectPtr< FlxDebugger_obj > __alloc(::hx::Ctx *_hx_ctx,Float width,Float height,::hx::Null< int >  __o_scale);
		...
		void onResize(Float width,Float height,::hx::Null< int >  scale);
		...
		void addWindowToggleButton( ::flixel::_hx_system::debug::Window window, ::Dynamic icon);
