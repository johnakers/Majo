...
class HXCPP_CLASS_ATTRIBUTES BitmapLogFrontEnd_obj : public ::hx::Object
{
	...
	public:
		...
		::String __ToString() const { return HX_("BitmapLogFrontEnd",87,e7,7c,bb); }
		 ...
		 ::flixel::_hx_system::debug::log::BitmapLog get_window();
		::Dynamic get_window_dyn();

		void addGraphic( ::flixel::graphics::FlxGraphic graphic,::String name);
		::Dynamic addGraphic_dyn();

		::String getGraphicName( ::flixel::graphics::FlxGraphic graphic);
		::Dynamic getGraphicName_dyn();
