...
class HXCPP_CLASS_ATTRIBUTES LogFrontEnd_obj : public ::hx::Object
{
	...
	public:
		...
		void add( ::Dynamic data, ::Dynamic pos);
		::Dynamic add_dyn();

		void warn( ::Dynamic data, ::Dynamic pos);
		::Dynamic warn_dyn();

		void error( ::Dynamic data, ::Dynamic pos);
		::Dynamic error_dyn();

		void notice( ::Dynamic data, ::Dynamic pos);
		::Dynamic notice_dyn();

		void advanced( ::Dynamic data, ::flixel::_hx_system::debug::log::LogStyle style,::hx::Null< bool >  fireOnce, ::Dynamic pos);
