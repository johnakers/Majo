...
HXLINE( 234)			 ::openfl::geom::Point _hx_tmp = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 234)			_hx_tmp->x = (_hx_tmp->x * norm);
HXLINE( 235)			 ::openfl::geom::Point _hx_tmp1 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 235)			_hx_tmp1->y = (_hx_tmp1->y * norm);
            		}
            	}
