...
HXLINE(  92)				_hx_tmp = ::hx::IsNull( uriValue );
            			}
            			else {
...
HXLINE( 121)						_hx_tmp = !(::openfl::Lib_obj::isXMLName(this->_hx___prefix));
            					}
            					else {
...
HXLINE( 128)					 ::openfl::utils::QName qname = ::hx::TCast<  ::openfl::utils::QName >::cast(uriValue);
HXLINE( 129)					this->_hx___uri = qname->get_uri();
            				}
            				else {
