...
HXDLIN( 149)				return ::openfl::utils::_internal::format::amf3::AMF3Tools_obj::date(a);
            			...
            			break;
            			case (int)7: {
HXLINE( 154)				 ::haxe::ds::StringMap _g = a->_hx_getObject(0).StaticCast<  ::haxe::ds::StringMap >();
HXDLIN( 154)				 ::Dynamic _g1 = a->_hx_getObject(1);
HXDLIN( 154)				::String _g2 = a->_hx_getString(2);
...
HXDLIN( 155)				return ::openfl::utils::_internal::format::amf3::AMF3Tools_obj::external(a);
            			...
            			break;
            			case (int)9: {
HXLINE( 150)				::Array< ::Dynamic> _g = a->_hx_getObject(0).StaticCast< ::Array< ::Dynamic> >();
HXDLIN( 150)				 ::haxe::ds::StringMap _g1 = a->_hx_getObject(1).StaticCast<  ::haxe::ds::StringMap >();
...
HXDLIN( 152)				return ::openfl::utils::_internal::format::amf3::AMF3Tools_obj::floatVector(a);
            			...
            			break;
            			case (int)12: {
HXLINE( 153)				 ::openfl::_Vector::ObjectVector _g = a->_hx_getObject(0).StaticCast<  ::openfl::_Vector::ObjectVector >();
HXDLIN( 153)				::String _g1 = a->_hx_getString(1);
