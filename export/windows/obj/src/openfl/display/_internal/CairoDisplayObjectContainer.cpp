...
HXLINE(  19)						_hx_tmp1 = ::hx::IsNotNull( bitmap->_hx___bitmapData );
            					}
            					else {
HXLINE(  19)						_hx_tmp1 = false;
            					}
HXDLIN(  19)					if (_hx_tmp1) {
HXLINE(  19)						_hx_tmp = bitmap->_hx___bitmapData->_hx___isValid;
            					}
            					else {
...
HXLINE(  19)								_hx_tmp1 = bitmap->smoothing;
            							}
            							else {
HXLINE(  19)								_hx_tmp1 = false;
            							}
...
HXDLIN(  19)							::lime::graphics::cairo::_CairoPattern::CairoPattern_Impl__obj::set_filter(pattern,_hx_tmp);
...
HXLINE(  21)			_hx_tmp2 = !(displayObjectContainer->_hx___isCacheBitmapRender);
            		}
            		else {
