...
HXDLIN( 220)				int i = (_g8 - 1);
HXLINE( 222)				length1 = this->paramLengths->__get(i);
HXLINE( 224)				if ((i < boolCount)) {
...
HXLINE( 229)					{
HXLINE( 229)						int _g = 0;
HXDLIN( 229)						int _g1 = length1;
HXDLIN( 229)						while((_g < _g1)){
HXLINE( 229)							_g = (_g + 1);
HXDLIN( 229)							int j = (_g - 1);
HXLINE( 231)							{
HXLINE( 231)								 ::lime::utils::ArrayBufferView this1 = this->paramData;
...
HXDLIN( 231)								 ::__hxcpp_memory_set_float(this1->buffer->b,(this1->byteOffset + (paramPosition * 4)),val);
            							}
...
HXLINE( 235)					if ((i < (boolCount + floatCount))) {
...
HXLINE( 240)						{
HXLINE( 240)							int _g = 0;
HXDLIN( 240)							int _g1 = length1;
HXDLIN( 240)							while((_g < _g1)){
HXLINE( 240)								_g = (_g + 1);
HXDLIN( 240)								int j = (_g - 1);
HXLINE( 242)								{
HXLINE( 242)									 ::lime::utils::ArrayBufferView this1 = this->paramData;
HXDLIN( 242)									Float val = floatParam->value->__get(j);
HXDLIN( 242)									 ::__hxcpp_memory_set_float(this1->buffer->b,(this1->byteOffset + (paramPosition * 4)),val);
            								}
...
HXLINE( 251)						{
HXLINE( 251)							int _g = 0;
HXDLIN( 251)							int _g1 = length1;
HXDLIN( 251)							while((_g < _g1)){
HXLINE( 251)								_g = (_g + 1);
HXDLIN( 251)								int j = (_g - 1);
HXLINE( 253)								{
HXLINE( 253)									 ::lime::utils::ArrayBufferView this1 = this->paramData;
HXDLIN( 253)									Float val = ( (Float)(intParam->value->__get(j)) );
HXDLIN( 253)									 ::__hxcpp_memory_set_float(this1->buffer->b,(this1->byteOffset + (paramPosition * 4)),val);
            								}
