...
HXLINE(  45)					_hx_tmp1 = bitmap->smoothing;
            				}
            				else {
...
HXDLIN(  45)				::lime::graphics::cairo::_CairoPattern::CairoPattern_Impl__obj::set_filter(pattern,_hx_tmp);
...
HXLINE(  82)					_hx_tmp1 = ::hx::IsNotNull( _hx___cacheBitmap->_hx___bitmapData );
            				}
            				else {
HXLINE(  82)					_hx_tmp1 = false;
            				}
HXDLIN(  82)				if (_hx_tmp1) {
HXLINE(  82)					_hx_tmp = _hx___cacheBitmap->_hx___bitmapData->_hx___isValid;
            				}
            				else {
...
HXLINE(  82)							_hx_tmp1 = _hx___cacheBitmap->smoothing;
            						}
            						else {
HXLINE(  82)							_hx_tmp1 = false;
            						}
...
HXDLIN(  82)						::lime::graphics::cairo::_CairoPattern::CairoPattern_Impl__obj::set_filter(pattern,_hx_tmp);
...
HXLINE(  87)				Float alpha = renderer->_hx___getAlpha(bitmap->_hx___worldAlpha);
HXDLIN(  87)				bool _hx_tmp;
HXDLIN(  87)				bool _hx_tmp1;
HXDLIN(  87)				if ((alpha > 0)) {
HXLINE(  87)					_hx_tmp1 = ::hx::IsNotNull( bitmap->_hx___bitmapData );
            				}
            				else {
HXLINE(  87)					_hx_tmp1 = false;
            				}
HXDLIN(  87)				if (_hx_tmp1) {
HXLINE(  87)					_hx_tmp = bitmap->_hx___bitmapData->_hx___isValid;
            				}
            				else {
HXLINE(  87)					_hx_tmp = false;
            				}
HXDLIN(  87)				if (_hx_tmp) {
HXLINE(  87)					 ::lime::graphics::cairo::Cairo cairo = renderer->cairo;
HXDLIN(  87)					renderer->_hx___setBlendMode(bitmap->_hx___worldBlendMode);
HXDLIN(  87)					renderer->_hx___pushMaskObject(bitmap,null());
HXDLIN(  87)					renderer->applyMatrix(bitmap->_hx___renderTransform,cairo);
HXDLIN(  87)					 ::Dynamic surface = bitmap->_hx___bitmapData->getSurface();
HXDLIN(  87)					if (::hx::IsNotNull( surface )) {
HXLINE(  87)						 ::Dynamic pattern = ::lime::graphics::cairo::_CairoPattern::CairoPattern_Impl__obj::createForSurface(surface);
HXDLIN(  87)						int _hx_tmp;
HXDLIN(  87)						bool _hx_tmp1;
HXDLIN(  87)						if (renderer->_hx___allowSmoothing) {
HXLINE(  87)							_hx_tmp1 = bitmap->smoothing;
            						}
            						else {
HXLINE(  87)							_hx_tmp1 = false;
            						}
...
HXDLIN(  87)						cairo->set_source(pattern);
HXDLIN(  87)						if ((alpha == 1)) {
HXLINE(  87)							cairo->paint();
            						}
            						else {
HXLINE(  87)							cairo->paintWithAlpha(alpha);
            						}
            					}
