...
HXDLIN( 652)							::Array< ::Dynamic> _g3 = displayObject->_hx___filters;
HXDLIN( 652)							while((_g2 < _g3->length)){
HXLINE( 652)								 ::openfl::filters::BitmapFilter filter = _g3->__get(_g2).StaticCast<  ::openfl::filters::BitmapFilter >();
HXDLIN( 652)								_g2 = (_g2 + 1);
HXLINE( 654)								if (filter->_hx___preserveObject) {
HXLINE( 656)									childRenderer->_hx___setRenderTarget(bitmap3);
HXLINE( 657)									childRenderer->_hx___renderFilterPass(bitmap,childRenderer->_hx___defaultDisplayShader,filter->_hx___smooth,null());
            								}
HXLINE( 660)								{
HXLINE( 660)									int _g = 0;
HXDLIN( 660)									int _g1 = filter->_hx___numShaderPasses;
HXDLIN( 660)									while((_g < _g1)){
HXLINE( 660)										_g = (_g + 1);
HXDLIN( 660)										int i = (_g - 1);
HXLINE( 662)										 ::openfl::display::BitmapData shader1;
HXDLIN( 662)										if (filter->_hx___preserveObject) {
HXLINE( 662)											shader1 = bitmap3;
            										}
            										else {
HXLINE( 662)											shader1 = null();
            										}
HXDLIN( 662)										shader = filter->_hx___initShader(childRenderer,i,shader1);
HXLINE( 663)										childRenderer->_hx___setBlendMode(filter->_hx___shaderBlendMode);
HXLINE( 664)										childRenderer->_hx___setRenderTarget(bitmap2);
HXLINE( 665)										childRenderer->_hx___renderFilterPass(bitmap,shader,filter->_hx___smooth,null());
HXLINE( 667)										cacheBitmap = bitmap;
HXLINE( 668)										bitmap = bitmap2;
HXLINE( 669)										bitmap2 = cacheBitmap;
            									}
            								}
HXLINE( 672)								filter->_hx___renderDirty = false;
            							}
            						}
HXLINE( 675)						displayObject->_hx___cacheBitmap->_hx___bitmapData = bitmap;
            					}
...
HXLINE( 709)						bool needSecondBitmapData = false;
HXLINE( 710)						bool needCopyOfOriginal = false;
HXLINE( 712)						{
HXLINE( 712)							int _g = 0;
HXDLIN( 712)							::Array< ::Dynamic> _g1 = displayObject->_hx___filters;
HXDLIN( 712)							while((_g < _g1->length)){
HXLINE( 712)								 ::openfl::filters::BitmapFilter filter = _g1->__get(_g).StaticCast<  ::openfl::filters::BitmapFilter >();
HXDLIN( 712)								_g = (_g + 1);
HXLINE( 714)								if (filter->_hx___needSecondBitmapData) {
HXLINE( 716)									needSecondBitmapData = true;
            								}
HXLINE( 718)								if (filter->_hx___preserveObject) {
HXLINE( 720)									needCopyOfOriginal = true;
            								}
            							}
            						}
HXLINE( 724)						 ::openfl::display::BitmapData bitmap = displayObject->_hx___cacheBitmapData;
HXLINE( 725)						 ::openfl::display::BitmapData bitmap2 = null();
HXLINE( 726)						 ::openfl::display::BitmapData bitmap3 = null();
HXLINE( 728)						if (needSecondBitmapData) {
...
HXLINE( 730)								_hx_tmp2 = ::hx::IsNull( displayObject->_hx___cacheBitmapData2->image );
            							}
            							else {
HXLINE( 730)								_hx_tmp2 = true;
            							}
HXDLIN( 730)							if (!(_hx_tmp2)) {
HXLINE( 730)								_hx_tmp1 = (bitmapWidth > displayObject->_hx___cacheBitmapData2->width);
            							}
            							else {
HXLINE( 730)								_hx_tmp1 = true;
            							}
HXDLIN( 730)							if (!(_hx_tmp1)) {
HXLINE( 730)								_hx_tmp = (bitmapHeight > displayObject->_hx___cacheBitmapData2->height);
            							}
            							else {
...
HXLINE( 741)							bitmap2 = displayObject->_hx___cacheBitmapData2;
            						}
            						else {
HXLINE( 745)							bitmap2 = bitmap;
            						}
HXLINE( 748)						if (needCopyOfOriginal) {
HXLINE( 750)							bool _hx_tmp;
HXDLIN( 750)							bool _hx_tmp1;
HXDLIN( 750)							bool _hx_tmp2;
HXDLIN( 750)							if (::hx::IsNotNull( displayObject->_hx___cacheBitmapData3 )) {
HXLINE( 750)								_hx_tmp2 = ::hx::IsNull( displayObject->_hx___cacheBitmapData3->image );
            							}
            							else {
HXLINE( 750)								_hx_tmp2 = true;
            							}
HXDLIN( 750)							if (!(_hx_tmp2)) {
HXLINE( 750)								_hx_tmp1 = (bitmapWidth > displayObject->_hx___cacheBitmapData3->width);
            							}
            							else {
HXLINE( 750)								_hx_tmp1 = true;
            							}
HXDLIN( 750)							if (!(_hx_tmp1)) {
HXLINE( 750)								_hx_tmp = (bitmapHeight > displayObject->_hx___cacheBitmapData3->height);
            							}
            							else {
...
HXLINE( 761)							bitmap3 = displayObject->_hx___cacheBitmapData3;
            						}
...
HXLINE( 766)						 ::openfl::display::BitmapData cacheBitmap;
HXLINE( 767)						 ::openfl::display::BitmapData lastBitmap;
HXLINE( 769)						{
HXLINE( 769)							int _g2 = 0;
HXDLIN( 769)							::Array< ::Dynamic> _g3 = displayObject->_hx___filters;
HXDLIN( 769)							while((_g2 < _g3->length)){
HXLINE( 769)								 ::openfl::filters::BitmapFilter filter = _g3->__get(_g2).StaticCast<  ::openfl::filters::BitmapFilter >();
HXDLIN( 769)								_g2 = (_g2 + 1);
HXLINE( 771)								if (filter->_hx___preserveObject) {
HXLINE( 773)									bitmap3->copyPixels(bitmap,bitmap->rect,destPoint,null(),null(),null());
            								}
HXLINE( 776)								lastBitmap = filter->_hx___applyFilter(bitmap2,bitmap,bitmap->rect,destPoint);
HXLINE( 778)								if (filter->_hx___preserveObject) {
HXLINE( 781)									 ::openfl::geom::ColorTransform _hx_tmp;
HXDLIN( 781)									if (::hx::IsNotNull( displayObject->_hx___objectTransform )) {
HXLINE( 781)										_hx_tmp = displayObject->_hx___objectTransform->_hx___colorTransform;
            									}
            									else {
HXLINE( 781)										_hx_tmp = null();
            									}
HXLINE( 780)									lastBitmap->draw(bitmap3,null(),_hx_tmp,null(),null(),null());
            								}
HXLINE( 783)								filter->_hx___renderDirty = false;
HXLINE( 785)								bool _hx_tmp;
HXDLIN( 785)								if (needSecondBitmapData) {
HXLINE( 785)									_hx_tmp = ::hx::IsInstanceEq( lastBitmap,bitmap2 );
            								}
            								else {
HXLINE( 785)									_hx_tmp = false;
            								}
HXDLIN( 785)								if (_hx_tmp) {
HXLINE( 787)									cacheBitmap = bitmap;
HXLINE( 788)									bitmap = bitmap2;
HXLINE( 789)									bitmap2 = cacheBitmap;
            								}
            							}
            						}
HXLINE( 793)						if (::hx::IsInstanceNotEq( displayObject->_hx___cacheBitmapData,bitmap )) {
HXLINE( 799)							cacheBitmap = displayObject->_hx___cacheBitmapData;
HXLINE( 800)							displayObject->_hx___cacheBitmapData = bitmap;
HXLINE( 801)							displayObject->_hx___cacheBitmapData2 = cacheBitmap;
...
HXLINE( 821)			bool _hx_tmp10;
HXDLIN( 821)			if (!(updateTransform)) {
HXLINE( 821)				_hx_tmp10 = needRender;
            			}
            			else {
...
HXLINE( 848)			_hx_tmp1 = (displayObject->_hx___drawableType == 7);
            		}
            		else {
HXLINE( 848)			_hx_tmp1 = false;
            		}
HXDLIN( 848)		if (_hx_tmp1) {
HXLINE( 850)			 ::openfl::text::TextField textField = ( ( ::openfl::text::TextField)(displayObject) );
HXLINE( 851)			if (::hx::IsNotNull( textField->_hx___cacheBitmap )) {
HXLINE( 853)				 ::openfl::geom::Matrix fh = textField->_hx___cacheBitmap->_hx___renderTransform;
HXDLIN( 853)				fh->tx = (fh->tx - textField->_hx___offsetX);
HXLINE( 854)				 ::openfl::geom::Matrix fh1 = textField->_hx___cacheBitmap->_hx___renderTransform;
HXDLIN( 854)				fh1->ty = (fh1->ty - textField->_hx___offsetY);
            			}
            		}
