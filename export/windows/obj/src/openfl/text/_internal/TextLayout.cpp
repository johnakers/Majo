...
HXLINE( 119)				_hx_tmp = (this->_hx___hbFontSize != this->size);
            			}
            			else {
...
HXLINE( 164)			 ::Dynamic _hx_tmp1 = this->_hx___hbBuffer;
HXDLIN( 164)			Float _hx_tmp2 = (uintptr_t)this->text.wc_str();
HXDLIN( 164)			::lime::text::harfbuzz::_HBBuffer::HBBuffer_Impl__obj::addUTF16(_hx_tmp1,_hx_tmp2,this->text.length,0,-1);
...
HXLINE( 172)				_hx_tmp3 = ::hx::IsNotNull( _positions );
            			}
            			else {
...
HXLINE( 185)						{
HXLINE( 185)							int _g1 = (lastCluster + 1);
HXDLIN( 185)							int _g2 = info->cluster;
HXDLIN( 185)							while((_g1 < _g2)){
HXLINE( 185)								_g1 = (_g1 + 1);
HXDLIN( 185)								int j = (_g1 - 1);
HXLINE( 189)								::Array< ::Dynamic> _hx_tmp = this->get_positions();
HXDLIN( 189)								 ::lime::math::Vector2 _hx_tmp1 =  ::lime::math::Vector2_obj::__alloc( HX_CTX ,0,0);
HXDLIN( 189)								_hx_tmp->push( ::openfl::text::_internal::GlyphPosition_obj::__alloc( HX_CTX ,0,_hx_tmp1, ::lime::math::Vector2_obj::__alloc( HX_CTX ,0,0)));
            							}
            						}
HXLINE( 192)						::Array< ::Dynamic> _hx_tmp = this->get_positions();
HXDLIN( 192)						int info1 = info->codepoint;
HXDLIN( 192)						 ::lime::math::Vector2 _hx_tmp1 =  ::lime::math::Vector2_obj::__alloc( HX_CTX ,((( (Float)(position->xAdvance) ) / ( (Float)(64) )) + this->letterSpacing),(( (Float)(position->yAdvance) ) / ( (Float)(64) )));
HXDLIN( 192)						_hx_tmp->push( ::openfl::text::_internal::GlyphPosition_obj::__alloc( HX_CTX ,info1,_hx_tmp1, ::lime::math::Vector2_obj::__alloc( HX_CTX ,(( (Float)(position->xOffset) ) / ( (Float)(64) )),(( (Float)(position->yOffset) ) / ( (Float)(64) )))));
