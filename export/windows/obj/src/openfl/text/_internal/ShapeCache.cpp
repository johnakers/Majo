...
HXLINE(  76)			 ::haxe::ds::StringMap formatMap =  ::haxe::ds::StringMap_obj::__alloc( HX_CTX );
HXLINE(  77)			formatMap->set(wordKey,getPositions->get_positions());
HXLINE(  79)			this->_hx___shortWordMap->set(formatKey,formatMap);
            		}
...
HXLINE( 111)				 ::openfl::text::_internal::CacheMeasurement measurement =  ::openfl::text::_internal::CacheMeasurement_obj::__alloc( HX_CTX ,wordKey,getPositions->get_positions());
HXLINE( 112)				formatMap->set(hash,measurement);
            			}
            		}
            		else {
HXLINE( 117)			 ::haxe::ds::IntMap formatMap =  ::haxe::ds::IntMap_obj::__alloc( HX_CTX );
HXLINE( 118)			 ::openfl::text::_internal::CacheMeasurement measurement =  ::openfl::text::_internal::CacheMeasurement_obj::__alloc( HX_CTX ,wordKey,getPositions->get_positions());
HXLINE( 119)			measurement->hash = hash;
HXLINE( 120)			formatMap->set(hash,measurement);
HXLINE( 121)			this->_hx___longWordMap->set(formatKey,formatMap);
            		}
...
HXLINE(  29)				chr = key.charCodeAt(i);
