...
HXLINE( 632)					int length = null();
HXDLIN( 632)					bool fixed = null();
HXDLIN( 632)					 ::openfl::_Vector::IntVector indexData =  ::openfl::_Vector::IntVector_obj::__alloc( HX_CTX ,length,fixed,::Array_obj< int >::fromData( _hx_array_data_2fa0bfa7_5,6));
...
HXDLIN(1100)						 ::haxe::io::Bytes this2 = ::haxe::io::Bytes_obj::alloc(_this->byteLength);
HXDLIN(1100)						_this->buffer = this2;
...
HXLINE(1100)							 ::lime::utils::ArrayBufferView _this =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,4);
HXDLIN(1100)							::cpp::VirtualArray array = ( (::cpp::VirtualArray)(vector->__Field(HX_("__array",79,c6,ed,8f),::hx::paccDynamic)) );
HXDLIN(1100)							_this->byteOffset = 0;
HXDLIN(1100)							_this->length = array->get_length();
HXDLIN(1100)							_this->byteLength = (_this->length * _this->bytesPerElement);
HXDLIN(1100)							 ::haxe::io::Bytes this2 = ::haxe::io::Bytes_obj::alloc(_this->byteLength);
...
HXDLIN(1100)								int elementSize = _this->bytesPerElement;
HXDLIN(1100)								if ((view->type == _this->type)) {
HXLINE(1100)									int srcLength = srcData->length;
HXDLIN(1100)									int cloneLength = (srcLength - srcByteOffset);
HXDLIN(1100)									 ::haxe::io::Bytes this1 = ::haxe::io::Bytes_obj::alloc(cloneLength);
HXDLIN(1100)									_this->buffer = this1;
HXDLIN(1100)									_this->buffer->blit(0,srcData,srcByteOffset,cloneLength);
            								}
            								else {
HXLINE(1100)									HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(HX_("unimplemented",09,2f,74,b4)));
            								}
HXDLIN(1100)								_this->byteLength = (_this->bytesPerElement * srcLength);
HXDLIN(1100)								_this->byteOffset = 0;
HXDLIN(1100)								_this->length = srcLength;
HXDLIN(1100)								this1 = _this;
            							}
            							else {
...
HXLINE(1100)										HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(::lime::utils::TAError_obj::RangeError_dyn()));
            									}
HXDLIN(1100)									if ((::hx::Mod(in_byteOffset,_this->bytesPerElement) != 0)) {
HXLINE(1100)										HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(::lime::utils::TAError_obj::RangeError_dyn()));
            									}
...
HXDLIN(1100)										if ((::hx::Mod(bufferByteLength,_this->bytesPerElement) != 0)) {
HXLINE(1100)											HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(::lime::utils::TAError_obj::RangeError_dyn()));
            										}
...
HXLINE(1100)										newByteLength = (( (int)(len) ) * _this->bytesPerElement);
HXDLIN(1100)										int newRange = (in_byteOffset + newByteLength);
HXDLIN(1100)										if ((newRange > bufferByteLength)) {
HXLINE(1100)											HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(::lime::utils::TAError_obj::RangeError_dyn()));
            										}
            									}
HXDLIN(1100)									_this->buffer = buffer;
HXDLIN(1100)									_this->byteOffset = in_byteOffset;
HXDLIN(1100)									_this->byteLength = newByteLength;
HXDLIN(1100)									_this->length = ::Std_obj::_hx_int((( (Float)(newByteLength) ) / ( (Float)(_this->bytesPerElement) )));
HXDLIN(1100)									this1 = _this;
            								}
            								else {
HXLINE(1100)									HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(HX_("Invalid constructor arguments for UInt8Array",6b,44,d5,85)));
            								}
            							}
            						}
            					}
...
HXLINE(1103)				 ::lime::graphics::Image image =  ::lime::graphics::Image_obj::__alloc( HX_CTX , ::lime::graphics::ImageBuffer_obj::__alloc( HX_CTX ,data,this->backBufferWidth,this->backBufferHeight,32,2),null(),null(),null(),null(),null(),null());
HXLINE(1104)				destination->image->copyPixels(image,sourceRect,destVector,null(),null(),null());
...
HXDLIN(1448)					 ::haxe::io::Bytes this2 = ::haxe::io::Bytes_obj::alloc(_this->byteLength);
HXDLIN(1448)					_this->buffer = this2;
...
HXLINE(1448)						 ::lime::utils::ArrayBufferView _this =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,8);
HXDLIN(1448)						::cpp::VirtualArray array = ( (::cpp::VirtualArray)(vector->__Field(HX_("__array",79,c6,ed,8f),::hx::paccDynamic)) );
HXDLIN(1448)						_this->byteOffset = 0;
HXDLIN(1448)						_this->length = array->get_length();
HXDLIN(1448)						_this->byteLength = (_this->length * _this->bytesPerElement);
HXDLIN(1448)						 ::haxe::io::Bytes this2 = ::haxe::io::Bytes_obj::alloc(_this->byteLength);
...
HXDLIN(1448)							int elementSize = _this->bytesPerElement;
HXDLIN(1448)							if ((view->type == _this->type)) {
HXLINE(1448)								int srcLength = srcData->length;
HXDLIN(1448)								int cloneLength = (srcLength - srcByteOffset);
HXDLIN(1448)								 ::haxe::io::Bytes this1 = ::haxe::io::Bytes_obj::alloc(cloneLength);
HXDLIN(1448)								_this->buffer = this1;
HXDLIN(1448)								_this->buffer->blit(0,srcData,srcByteOffset,cloneLength);
            							}
            							else {
HXLINE(1448)								HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(HX_("unimplemented",09,2f,74,b4)));
            							}
HXDLIN(1448)							_this->byteLength = (_this->bytesPerElement * srcLength);
HXDLIN(1448)							_this->byteOffset = 0;
HXDLIN(1448)							_this->length = srcLength;
HXDLIN(1448)							this1 = _this;
            						}
            						else {
...
HXLINE(1448)									HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(::lime::utils::TAError_obj::RangeError_dyn()));
            								}
HXDLIN(1448)								if ((::hx::Mod(in_byteOffset,_this->bytesPerElement) != 0)) {
HXLINE(1448)									HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(::lime::utils::TAError_obj::RangeError_dyn()));
            								}
...
HXDLIN(1448)									if ((::hx::Mod(bufferByteLength,_this->bytesPerElement) != 0)) {
HXLINE(1448)										HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(::lime::utils::TAError_obj::RangeError_dyn()));
            									}
...
HXLINE(1448)									newByteLength = (( (int)(len) ) * _this->bytesPerElement);
HXDLIN(1448)									int newRange = (in_byteOffset + newByteLength);
HXDLIN(1448)									if ((newRange > bufferByteLength)) {
HXLINE(1448)										HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(::lime::utils::TAError_obj::RangeError_dyn()));
            									}
            								}
HXDLIN(1448)								_this->buffer = bytes;
HXDLIN(1448)								_this->byteOffset = in_byteOffset;
HXDLIN(1448)								_this->byteLength = newByteLength;
HXDLIN(1448)								_this->length = ::Std_obj::_hx_int((( (Float)(newByteLength) ) / ( (Float)(_this->bytesPerElement) )));
HXDLIN(1448)								this1 = _this;
            							}
            							else {
HXLINE(1448)								HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(HX_("Invalid constructor arguments for Float32Array",8e,c1,f4,d4)));
            							}
            						}
            					}
            				}
...
HXDLIN(1493)			 ::lime::utils::ArrayBufferView this1 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,16,8);
HXDLIN(1493)			 ::lime::utils::ArrayBufferView data = this1;
HXLINE(1494)			{
HXLINE(1496)				{
...
HXLINE(1532)				{
HXLINE(1532)					i = (i + 1);
HXDLIN(1532)					Float val = source->get(0);
HXDLIN(1532)					 ::__hxcpp_memory_set_float(dest->buffer->b,(dest->byteOffset + ((i - 1) * 4)),val);
            				}
HXLINE(1533)				{
HXLINE(1533)					i = (i + 1);
HXDLIN(1533)					Float val1 = source->get(1);
HXDLIN(1533)					 ::__hxcpp_memory_set_float(dest->buffer->b,(dest->byteOffset + ((i - 1) * 4)),val1);
            				}
HXLINE(1534)				{
HXLINE(1534)					i = (i + 1);
HXDLIN(1534)					Float val2 = source->get(2);
HXDLIN(1534)					 ::__hxcpp_memory_set_float(dest->buffer->b,(dest->byteOffset + ((i - 1) * 4)),val2);
            				}
HXLINE(1535)				{
HXLINE(1535)					i = (i + 1);
HXDLIN(1535)					Float val3 = source->get(3);
HXDLIN(1535)					 ::__hxcpp_memory_set_float(dest->buffer->b,(dest->byteOffset + ((i - 1) * 4)),val3);
            				}
HXLINE(1537)				{
HXLINE(1537)					i = (i + 1);
HXDLIN(1537)					Float val4 = source->get(4);
HXDLIN(1537)					 ::__hxcpp_memory_set_float(dest->buffer->b,(dest->byteOffset + ((i - 1) * 4)),val4);
            				}
HXLINE(1538)				{
HXLINE(1538)					i = (i + 1);
HXDLIN(1538)					Float val5 = source->get(5);
HXDLIN(1538)					 ::__hxcpp_memory_set_float(dest->buffer->b,(dest->byteOffset + ((i - 1) * 4)),val5);
            				}
HXLINE(1539)				{
HXLINE(1539)					i = (i + 1);
HXDLIN(1539)					Float val6 = source->get(6);
HXDLIN(1539)					 ::__hxcpp_memory_set_float(dest->buffer->b,(dest->byteOffset + ((i - 1) * 4)),val6);
            				}
HXLINE(1540)				{
HXLINE(1540)					i = (i + 1);
HXDLIN(1540)					Float val7 = source->get(7);
HXDLIN(1540)					 ::__hxcpp_memory_set_float(dest->buffer->b,(dest->byteOffset + ((i - 1) * 4)),val7);
            				}
HXLINE(1542)				{
HXLINE(1542)					i = (i + 1);
HXDLIN(1542)					Float val8 = source->get(8);
HXDLIN(1542)					 ::__hxcpp_memory_set_float(dest->buffer->b,(dest->byteOffset + ((i - 1) * 4)),val8);
            				}
HXLINE(1543)				{
HXLINE(1543)					i = (i + 1);
HXDLIN(1543)					Float val9 = source->get(9);
HXDLIN(1543)					 ::__hxcpp_memory_set_float(dest->buffer->b,(dest->byteOffset + ((i - 1) * 4)),val9);
            				}
HXLINE(1544)				{
HXLINE(1544)					i = (i + 1);
HXDLIN(1544)					Float val10 = source->get(10);
HXDLIN(1544)					 ::__hxcpp_memory_set_float(dest->buffer->b,(dest->byteOffset + ((i - 1) * 4)),val10);
            				}
HXLINE(1545)				{
HXLINE(1545)					i = (i + 1);
HXDLIN(1545)					Float val11 = source->get(11);
HXDLIN(1545)					 ::__hxcpp_memory_set_float(dest->buffer->b,(dest->byteOffset + ((i - 1) * 4)),val11);
            				}
HXLINE(1547)				{
HXLINE(1547)					i = (i + 1);
HXDLIN(1547)					Float val12 = source->get(12);
HXDLIN(1547)					 ::__hxcpp_memory_set_float(dest->buffer->b,(dest->byteOffset + ((i - 1) * 4)),val12);
            				}
HXLINE(1548)				{
HXLINE(1548)					i = (i + 1);
HXDLIN(1548)					Float val13 = source->get(13);
HXDLIN(1548)					 ::__hxcpp_memory_set_float(dest->buffer->b,(dest->byteOffset + ((i - 1) * 4)),val13);
            				}
HXLINE(1549)				{
HXLINE(1549)					i = (i + 1);
HXDLIN(1549)					Float val14 = source->get(14);
HXDLIN(1549)					 ::__hxcpp_memory_set_float(dest->buffer->b,(dest->byteOffset + ((i - 1) * 4)),val14);
            				}
HXLINE(1550)				{
HXLINE(1550)					i = (i + 1);
HXDLIN(1550)					Float val15 = source->get(15);
HXDLIN(1550)					 ::__hxcpp_memory_set_float(dest->buffer->b,(dest->byteOffset + ((i - 1) * 4)),val15);
            				}
            			}
...
HXDLIN(1911)			goto _hx_goto_36;
            		...
            		if (  (_hx_switch_0==1) ){
HXLINE(1923)			 ::lime::_internal::backend::native::NativeOpenGLRenderContext this1 = this->gl;
HXDLIN(1923)			int type = this->gl->FLOAT;
HXDLIN(1923)			int stride = buffer->_hx___stride;
HXDLIN(1923)			this1->vertexAttribPointer(index,1,type,false,stride,::lime::utils::_DataPointer::DataPointer_Impl__obj::fromInt(byteOffset));
HXDLIN(1923)			goto _hx_goto_36;
            		}
            		if (  (_hx_switch_0==2) ){
HXLINE(1920)			 ::lime::_internal::backend::native::NativeOpenGLRenderContext this1 = this->gl;
HXDLIN(1920)			int type = this->gl->FLOAT;
HXDLIN(1920)			int stride = buffer->_hx___stride;
HXDLIN(1920)			this1->vertexAttribPointer(index,2,type,false,stride,::lime::utils::_DataPointer::DataPointer_Impl__obj::fromInt(byteOffset));
HXDLIN(1920)			goto _hx_goto_36;
            		}
            		if (  (_hx_switch_0==3) ){
HXLINE(1917)			 ::lime::_internal::backend::native::NativeOpenGLRenderContext this1 = this->gl;
HXDLIN(1917)			int type = this->gl->FLOAT;
HXDLIN(1917)			int stride = buffer->_hx___stride;
HXDLIN(1917)			this1->vertexAttribPointer(index,3,type,false,stride,::lime::utils::_DataPointer::DataPointer_Impl__obj::fromInt(byteOffset));
HXDLIN(1917)			goto _hx_goto_36;
            		}
            		if (  (_hx_switch_0==4) ){
HXLINE(1914)			 ::lime::_internal::backend::native::NativeOpenGLRenderContext this1 = this->gl;
HXDLIN(1914)			int type = this->gl->FLOAT;
HXDLIN(1914)			int stride = buffer->_hx___stride;
HXDLIN(1914)			this1->vertexAttribPointer(index,4,type,false,stride,::lime::utils::_DataPointer::DataPointer_Impl__obj::fromInt(byteOffset));
...
HXLINE(2057)				_hx_tmp = ::hx::IsEq( this->_hx___state->blendSourceRGBFactor,this->_hx___state->blendSourceAlphaFactor );
            			}
            			else {
...
HXLINE(2064)				 ::lime::_internal::backend::native::NativeOpenGLRenderContext this1 = this->gl;
...
HXDLIN(2064)				this1->blendFuncSeparate(srcRGB,dstRGB,srcAlpha,this->_hx___getGLBlend(this->_hx___state->blendDestinationAlphaFactor));
            			}
...
HXDLIN(2183)			bool _hx_tmp1;
HXDLIN(2183)			if (::hx::IsNull( this->_hx___stage )) {
HXLINE(2183)				_hx_tmp1 = (this->backBufferWidth == 0);
            			}
            			else {
HXLINE(2183)				_hx_tmp1 = false;
            			}
HXDLIN(2183)			if (_hx_tmp1) {
HXLINE(2183)				_hx_tmp = (this->backBufferHeight == 0);
            			}
            			else {
...
HXDLIN(2188)			bool _hx_tmp3;
HXDLIN(2188)			if (::hx::IsNull( this->_hx___contextState->renderToTexture )) {
HXLINE(2188)				_hx_tmp3 = ::hx::IsInstanceNotEq( this->_hx___contextState->_hx___currentGLFramebuffer,this->_hx___state->_hx___primaryGLFramebuffer );
            			}
            			else {
HXLINE(2188)				_hx_tmp3 = true;
            			}
HXDLIN(2188)			if (!(_hx_tmp3)) {
HXLINE(2188)				_hx_tmp2 = (this->_hx___contextState->backBufferEnableDepthAndStencil != this->_hx___state->backBufferEnableDepthAndStencil);
            			}
            			else {
HXLINE(2188)				_hx_tmp2 = true;
            			}
...
HXLINE(2322)			{
HXLINE(2322)				 ::lime::_internal::backend::native::NativeOpenGLRenderContext this1 = this->gl;
HXDLIN(2322)				int func = this->_hx___getGLCompareMode(this->_hx___state->stencilCompareMode);
HXDLIN(2322)				this1->stencilFunc(func,this->_hx___state->stencilReferenceValue,this->_hx___state->stencilReadMask);
            			}
...
HXLINE(2381)						_hx_tmp = ::hx::IsNotNull( texture->_hx___alphaTexture );
            					}
            					else {
