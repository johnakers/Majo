...
HX_LOCAL_STACK_FRAME(_hx_pos_4f421a3440b44d31_87_destroy,"flixel.FlxSubState","destroy",0xc08a1d5d,"flixel.FlxSubState.destroy","flixel/FlxSubState.hx",87,0xd8a3e54e)
HX_LOCAL_STACK_FRAME(_hx_pos_4f421a3440b44d31_100_close,"flixel.FlxSubState","close",0x85a9195b,"flixel.FlxSubState.close","flixel/FlxSubState.hx",100,0xd8a3e54e)
HX_LOCAL_STACK_FRAME(_hx_pos_4f421a3440b44d31_107_get_bgColor,"flixel.FlxSubState","get_bgColor",0x02e53f58,"flixel.FlxSubState.get_bgColor","flixel/FlxSubState.hx",107,0xd8a3e54e)
HX_LOCAL_STACK_FRAME(_hx_pos_4f421a3440b44d31_112_set_bgColor,"flixel.FlxSubState","set_bgColor",0x0d524664,"flixel.FlxSubState.set_bgColor","flixel/FlxSubState.hx",112,0xd8a3e54e)
namespace flixel{
...
HXLINE(  77)				 ::flixel::_hx_system::FlxBGSprite _hx_tmp = this->_bgSprite;
HXDLIN(  77)				_hx_tmp->set_cameras(this->getCameras());
HXLINE(  78)				this->_bgSprite->draw();
            			}
            		}
HXLINE(  83)		this->super::draw();
            	}


void FlxSubState_obj::destroy(){
            	HX_STACKFRAME(&_hx_pos_4f421a3440b44d31_87_destroy)
HXLINE(  88)		this->super::destroy();
HXLINE(  89)		this->closeCallback = null();
HXLINE(  90)		this->openCallback = null();
HXLINE(  91)		this->_parentState = null();
HXLINE(  92)		this->_bgSprite = ( ( ::flixel::_hx_system::FlxBGSprite)(::flixel::util::FlxDestroyUtil_obj::destroy(this->_bgSprite)) );
            	}


void FlxSubState_obj::close(){
            	HX_STACKFRAME(&_hx_pos_4f421a3440b44d31_100_close)
HXDLIN( 100)		bool _hx_tmp;
HXDLIN( 100)		if (::hx::IsNotNull( this->_parentState )) {
HXDLIN( 100)			_hx_tmp = ::hx::IsInstanceEq( this->_parentState->subState,::hx::ObjectPtr<OBJ_>(this) );
            		}
            		else {
HXDLIN( 100)			_hx_tmp = false;
            		}
HXDLIN( 100)		if (_hx_tmp) {
HXLINE( 101)			this->_parentState->closeSubState();
            		}
            	}
...
int FlxSubState_obj::get_bgColor(){
            	HX_STACKFRAME(&_hx_pos_4f421a3440b44d31_107_get_bgColor)
HXDLIN( 107)		return this->_bgColor;
            	}


int FlxSubState_obj::set_bgColor(int value){
            	HX_STACKFRAME(&_hx_pos_4f421a3440b44d31_112_set_bgColor)
HXLINE( 113)		bool _hx_tmp;
HXDLIN( 113)		if (::flixel::FlxG_obj::renderTile) {
HXLINE( 113)			_hx_tmp = ::hx::IsNotNull( this->_bgSprite );
            		}
            		else {
HXLINE( 113)			_hx_tmp = false;
            		}
HXDLIN( 113)		if (_hx_tmp) {
HXLINE( 115)			this->_bgSprite->set_alpha((( (Float)(((value >> 24) & 255)) ) / ( (Float)(255) )));
HXLINE( 116)			this->_bgSprite->set_visible((this->_bgSprite->alpha > 0));
HXLINE( 117)			this->_bgSprite->set_color((value & 16777215));
            		}
HXLINE( 120)		return (this->_bgColor = value);
            	}
