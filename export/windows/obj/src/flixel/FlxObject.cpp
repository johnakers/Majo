...
HXLINE( 906)				return ( (bool)(_g(objectOrGroup,x,y,inScreenSpace1,camera1)) );
            			}
            			HX_END_LOCAL_FUNC1(return)

HXLINE( 906)			 ::Dynamic _g = this->overlapsCallback_dyn();
...
HXDLIN( 906)			return group->any( ::Dynamic(new _hx_Closure_0(y,x,_g,inScreenSpace1,camera1)));
            		}
...
HXLINE( 920)				Float object1 = object->x;
HXDLIN( 920)				Float _hx_tmp = this->x;
HXDLIN( 920)				_hx_tmp1 = (object1 < (_hx_tmp + this->get_width()));
            			}
            			else {
HXLINE( 920)				_hx_tmp1 = false;
            			}
HXDLIN( 920)			if (_hx_tmp1) {
HXLINE( 920)				Float object1 = object->y;
HXDLIN( 920)				Float _hx_tmp1 = (object1 + object->get_height());
HXDLIN( 920)				_hx_tmp = (_hx_tmp1 > this->y);
            			}
            			else {
...
HXLINE( 920)				Float object1 = object->y;
HXDLIN( 920)				Float _hx_tmp = this->y;
HXDLIN( 920)				return (object1 < (_hx_tmp + this->get_height()));
            			}
            			else {
...
HXDLIN( 928)		Float _hx_tmp2 = (objectScreenPos1 + object->get_width());
HXDLIN( 928)		if ((_hx_tmp2 > this->_point->x)) {
HXLINE( 929)			Float objectScreenPos1 = objectScreenPos->x;
HXDLIN( 929)			Float _hx_tmp = this->_point->x;
HXLINE( 928)			_hx_tmp1 = (objectScreenPos1 < (_hx_tmp + this->get_width()));
            		}
            		else {
HXLINE( 928)			_hx_tmp1 = false;
            		}
HXDLIN( 928)		if (_hx_tmp1) {
HXLINE( 930)			Float objectScreenPos1 = objectScreenPos->y;
HXDLIN( 930)			Float _hx_tmp1 = (objectScreenPos1 + object->get_height());
HXLINE( 928)			_hx_tmp = (_hx_tmp1 > this->_point->y);
            		}
            		else {
HXLINE( 928)			_hx_tmp = false;
            		}
HXDLIN( 928)		if (_hx_tmp) {
HXLINE( 931)			Float objectScreenPos1 = objectScreenPos->y;
HXDLIN( 931)			Float _hx_tmp = this->_point->y;
HXDLIN( 931)			return (objectScreenPos1 < (_hx_tmp + this->get_height()));
            		}
            		else {
...
HXLINE( 963)				return ( (bool)(_g(objectOrGroup,x1,y1,inScreenSpace1,camera1)) );
            			}
            			HX_END_LOCAL_FUNC1(return)

HXLINE( 963)			 ::Dynamic _g = this->overlapsAtCallback_dyn();
...
HXLINE( 979)				Float object1 = object->x;
HXDLIN( 979)				_hx_tmp1 = (object1 < (x + this->get_width()));
            			}
            			else {
HXLINE( 979)				_hx_tmp1 = false;
            			}
HXDLIN( 979)			if (_hx_tmp1) {
HXLINE( 979)				Float object1 = object->y;
HXDLIN( 979)				_hx_tmp = ((object1 + object->get_height()) > y);
            			}
            			else {
...
HXLINE( 979)				Float object1 = object->y;
HXDLIN( 979)				return (object1 < (y + this->get_height()));
            			}
            			else {
...
HXDLIN( 987)		Float _hx_tmp2 = (objectScreenPos1 + object->get_width());
HXDLIN( 987)		if ((_hx_tmp2 > this->_point->x)) {
HXLINE( 988)			Float objectScreenPos1 = objectScreenPos->x;
HXDLIN( 988)			Float _hx_tmp = this->_point->x;
HXLINE( 987)			_hx_tmp1 = (objectScreenPos1 < (_hx_tmp + this->get_width()));
            		}
            		else {
HXLINE( 987)			_hx_tmp1 = false;
            		}
HXDLIN( 987)		if (_hx_tmp1) {
HXLINE( 989)			Float objectScreenPos1 = objectScreenPos->y;
HXDLIN( 989)			Float _hx_tmp1 = (objectScreenPos1 + object->get_height());
HXLINE( 987)			_hx_tmp = (_hx_tmp1 > this->_point->y);
            		}
            		else {
HXLINE( 987)			_hx_tmp = false;
            		}
HXDLIN( 987)		if (_hx_tmp) {
HXLINE( 990)			Float objectScreenPos1 = objectScreenPos->y;
HXDLIN( 990)			Float _hx_tmp = this->_point->y;
HXDLIN( 990)			return (objectScreenPos1 < (_hx_tmp + this->get_height()));
            		}
            		else {
...
HXDLIN(1011)				Float _hx_tmp = this->x;
HXDLIN(1011)				_hx_tmp1 = (point1 < (_hx_tmp + this->get_width()));
            			}
            			else {
...
HXLINE(1011)				Float point1 = point->y;
HXDLIN(1011)				Float _hx_tmp = this->y;
HXDLIN(1011)				return (point1 < (_hx_tmp + this->get_height()));
            			}
            			else {
...
HXLINE(1020)		if (point->_weak) {
HXLINE(1020)			point->put();
            		}
HXLINE(1021)		bool _hx_tmp;
HXDLIN(1021)		bool _hx_tmp1;
HXDLIN(1021)		if ((xPos >= this->_point->x)) {
HXLINE(1021)			Float _hx_tmp = this->_point->x;
HXDLIN(1021)			_hx_tmp1 = (xPos < (_hx_tmp + this->get_width()));
            		}
            		else {
HXLINE(1021)			_hx_tmp1 = false;
            		}
HXDLIN(1021)		if (_hx_tmp1) {
HXLINE(1021)			_hx_tmp = (yPos >= this->_point->y);
            		}
            		else {
HXLINE(1021)			_hx_tmp = false;
            		}
HXDLIN(1021)		if (_hx_tmp) {
HXLINE(1021)			Float _hx_tmp = this->_point->y;
HXDLIN(1021)			return (yPos < (_hx_tmp + this->get_height()));
            		}
            		else {
...
HXDLIN(1032)			Float _hx_tmp1 = this->y;
HXDLIN(1032)			Float _hx_tmp2 = (_hx_tmp1 + this->get_height());
HXDLIN(1032)			_hx_tmp = (_hx_tmp2 > ::flixel::FlxG_obj::worldBounds->y);
            		}
            		else {
...
HXDLIN(1032)			 ::flixel::math::FlxRect _this = ::flixel::FlxG_obj::worldBounds;
HXDLIN(1032)			return (this->y < (_this->y + _this->height));
            		}
            		else {
...
HXDLIN(1121)		if (point->_weak) {
HXLINE(1121)			point->put();
            		}
...
HXLINE(1186)			int _hx_tmp = ::flixel::FlxG_obj::width;
HXDLIN(1186)			this->set_x(((( (Float)(_hx_tmp) ) - this->get_width()) / ( (Float)(2) )));
            		}
HXLINE(1188)		bool _hx_tmp1;
HXDLIN(1188)		if ((axes != 16)) {
HXLINE(1188)			_hx_tmp1 = (axes == 17);
            		}
            		else {
HXLINE(1188)			_hx_tmp1 = true;
            		}
HXDLIN(1188)		if (_hx_tmp1) {
HXLINE(1189)			int _hx_tmp = ::flixel::FlxG_obj::height;
HXDLIN(1189)			this->set_y(((( (Float)(_hx_tmp) ) - this->get_height()) / ( (Float)(2) )));
            		}
...
HXLINE(1314)			 ::flixel::math::FlxRect _this = this->_rect;
HXDLIN(1314)			_this->x = ( (Float)(::Math_obj::floor(_this->x)) );
HXDLIN(1314)			_this->y = ( (Float)(::Math_obj::floor(_this->y)) );
HXDLIN(1314)			_this->width = ( (Float)(::Math_obj::floor(_this->width)) );
HXDLIN(1314)			_this->height = ( (Float)(::Math_obj::floor(_this->height)) );
            		}
...
HXLINE( 141)				 ::flixel::tile::FlxBaseTilemap tilemap = ( ( ::flixel::tile::FlxBaseTilemap)(object2) );
HXLINE( 143)				 ::Dynamic recurseProcess =  ::Dynamic(new _hx_Closure_1(func,isCollision,position,object1));
HXLINE( 148)				return tilemap->overlapsWithCallback(object1,recurseProcess,false,position);
            			}
            		}
...
HXLINE( 246)					_hx_tmp = (delta2 > delta1);
            				}
            				else {
...
HXLINE( 300)					_hx_tmp = (delta2 > delta1);
            				}
            				else {
...
HXLINE( 440)						int dir = 1;
HXLINE( 438)						_hx_tmp = ((object2->allowCollisions & dir) != dir);
            					}
            					else {
...
HXDLIN( 446)						object11->touching = (object11->touching | 16);
...
HXLINE( 452)						Float object11 = object1->x;
HXDLIN( 452)						Float overlap1 = (object11 - object2->get_width());
HXDLIN( 452)						overlap = (overlap1 - object2->x);
HXLINE( 453)						bool _hx_tmp;
HXDLIN( 453)						bool _hx_tmp1;
HXDLIN( 453)						bool _hx_tmp2;
HXDLIN( 453)						if (checkMaxOverlap) {
HXLINE( 453)							_hx_tmp2 = (-(overlap) > maxOverlap);
            						}
            						else {
HXLINE( 453)							_hx_tmp2 = false;
            						}
HXDLIN( 453)						if (!(_hx_tmp2)) {
HXLINE( 454)							int dir = 1;
HXLINE( 453)							_hx_tmp1 = ((object1->allowCollisions & dir) != dir);
            						}
            						else {
HXLINE( 453)							_hx_tmp1 = true;
            						}
HXDLIN( 453)						if (!(_hx_tmp1)) {
HXLINE( 455)							int dir = 16;
HXLINE( 453)							_hx_tmp = ((object2->allowCollisions & dir) != dir);
            						}
            						else {
...
HXLINE( 461)							 ::flixel::FlxObject object11 = object1;
HXDLIN( 461)							object11->touching = (object11->touching | 1);
HXLINE( 462)							 ::flixel::FlxObject object21 = object2;
HXDLIN( 462)							object21->touching = (object21->touching | 16);
            						}
            					}
            				}
            			}
...
HXLINE( 510)						int dir = 256;
HXLINE( 508)						_hx_tmp = ((object2->allowCollisions & dir) != dir);
            					}
            					else {
...
HXLINE( 516)						 ::flixel::FlxObject object11 = object1;
HXDLIN( 516)						object11->touching = (object11->touching | 4096);
...
HXLINE( 522)						Float object11 = object1->y;
HXDLIN( 522)						Float overlap1 = (object11 - object2->get_height());
HXDLIN( 522)						overlap = (overlap1 - object2->y);
HXLINE( 523)						bool _hx_tmp;
HXDLIN( 523)						bool _hx_tmp1;
HXDLIN( 523)						bool _hx_tmp2;
HXDLIN( 523)						if (checkMaxOverlap) {
HXLINE( 523)							_hx_tmp2 = (-(overlap) > maxOverlap);
            						}
            						else {
HXLINE( 523)							_hx_tmp2 = false;
            						}
HXDLIN( 523)						if (!(_hx_tmp2)) {
HXLINE( 524)							int dir = 256;
HXLINE( 523)							_hx_tmp1 = ((object1->allowCollisions & dir) != dir);
            						}
            						else {
HXLINE( 523)							_hx_tmp1 = true;
            						}
HXDLIN( 523)						if (!(_hx_tmp1)) {
HXLINE( 525)							int dir = 4096;
HXLINE( 523)							_hx_tmp = ((object2->allowCollisions & dir) != dir);
            						}
            						else {
...
HXLINE( 531)							 ::flixel::FlxObject object11 = object1;
HXDLIN( 531)							object11->touching = (object11->touching | 256);
HXLINE( 532)							 ::flixel::FlxObject object21 = object2;
HXDLIN( 532)							object21->touching = (object21->touching | 4096);
            						}
            					}
            				}
            			}
