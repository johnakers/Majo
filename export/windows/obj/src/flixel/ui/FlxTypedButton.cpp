...
HXLINE( 420)				 ::Dynamic _hx_tmp = this->label;
HXDLIN( 420)				( ( ::flixel::FlxSprite)(_hx_tmp) )->set_frames(labelNode->getImageFrame());
            			}
            		}
...
HXDLIN( 491)			if (point2->_weak) {
HXLINE( 491)				point2->put();
            			}
...
HXLINE( 542)			 ::flixel::FlxSprite _hx_tmp = this->_spriteLabel;
HXDLIN( 542)			Float _hx_tmp1 = this->alpha;
HXDLIN( 542)			_hx_tmp->set_alpha((_hx_tmp1 * this->labelAlphas->__get(::flixel::ui::_FlxButton::FlxButtonState_Impl__obj::toInt(this->status))));
            		}
            	}
