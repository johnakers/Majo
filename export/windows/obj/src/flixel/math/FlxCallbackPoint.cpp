...
HX_DEFINE_STACK_FRAME(_hx_pos_0e989bab684323cb_1740_new,"flixel.math.FlxCallbackPoint","new",0x2af621df,"flixel.math.FlxCallbackPoint.new","flixel/math/FlxPoint.hx",1740,0xb3e1cd2c)
HX_LOCAL_STACK_FRAME(_hx_pos_0e989bab684323cb_1757_set,"flixel.math.FlxCallbackPoint","set",0x2af9ed21,"flixel.math.FlxCallbackPoint.set","flixel/math/FlxPoint.hx",1757,0xb3e1cd2c)
HX_LOCAL_STACK_FRAME(_hx_pos_0e989bab684323cb_1765_set_x,"flixel.math.FlxCallbackPoint","set_x",0x4f288a9a,"flixel.math.FlxCallbackPoint.set_x","flixel/math/FlxPoint.hx",1765,0xb3e1cd2c)
HX_LOCAL_STACK_FRAME(_hx_pos_0e989bab684323cb_1773_set_y,"flixel.math.FlxCallbackPoint","set_y",0x4f288a9b,"flixel.math.FlxCallbackPoint.set_y","flixel/math/FlxPoint.hx",1773,0xb3e1cd2c)
HX_LOCAL_STACK_FRAME(_hx_pos_0e989bab684323cb_1781_destroy,"flixel.math.FlxCallbackPoint","destroy",0xdd08a9f9,"flixel.math.FlxCallbackPoint.destroy","flixel/math/FlxPoint.hx",1781,0xb3e1cd2c)
HX_LOCAL_STACK_FRAME(_hx_pos_0e989bab684323cb_1788_put,"flixel.math.FlxCallbackPoint","put",0x2af7b44e,"flixel.math.FlxCallbackPoint.put","flixel/math/FlxPoint.hx",1788,0xb3e1cd2c)
namespace flixel{
namespace math{

void FlxCallbackPoint_obj::__construct( ::Dynamic setXCallback, ::Dynamic setYCallback, ::Dynamic setXYCallback){
            	HX_STACKFRAME(&_hx_pos_0e989bab684323cb_1740_new)
HXLINE(1741)		super::__construct(null(),null());
HXLINE(1743)		this->_setXCallback = setXCallback;
HXLINE(1744)		this->_setYCallback = setXYCallback;
HXLINE(1745)		this->_setXYCallback = setXYCallback;
HXLINE(1747)		if (::hx::IsNotNull( this->_setXCallback )) {
HXLINE(1749)			if (::hx::IsNull( this->_setYCallback )) {
HXLINE(1750)				this->_setYCallback = setXCallback;
            			}
HXLINE(1751)			if (::hx::IsNull( this->_setXYCallback )) {
HXLINE(1752)				this->_setXYCallback = setXCallback;
            			}
            		}
            	}
...
bool FlxCallbackPoint_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::flixel::math::FlxBasePoint FlxCallbackPoint_obj::set(::hx::Null< Float >  __o_x,::hx::Null< Float >  __o_y){
            	...
            	HX_STACKFRAME(&_hx_pos_0e989bab684323cb_1757_set)
HXLINE(1758)		this->super::set(x,y);
HXLINE(1759)		if (::hx::IsNotNull( this->_setXYCallback )) {
HXLINE(1760)			this->_setXYCallback(::hx::ObjectPtr<OBJ_>(this));
            		}
HXLINE(1761)		return ::hx::ObjectPtr<OBJ_>(this);
            	}


Float FlxCallbackPoint_obj::set_x(Float value){
            	HX_STACKFRAME(&_hx_pos_0e989bab684323cb_1765_set_x)
HXLINE(1766)		this->super::set_x(value);
HXLINE(1767)		if (::hx::IsNotNull( this->_setXCallback )) {
HXLINE(1768)			this->_setXCallback(::hx::ObjectPtr<OBJ_>(this));
            		}
HXLINE(1769)		return value;
            	}


Float FlxCallbackPoint_obj::set_y(Float value){
            	HX_STACKFRAME(&_hx_pos_0e989bab684323cb_1773_set_y)
HXLINE(1774)		this->super::set_y(value);
HXLINE(1775)		if (::hx::IsNotNull( this->_setYCallback )) {
HXLINE(1776)			this->_setYCallback(::hx::ObjectPtr<OBJ_>(this));
            		}
...
void FlxCallbackPoint_obj::destroy(){
            	HX_STACKFRAME(&_hx_pos_0e989bab684323cb_1781_destroy)
HXLINE(1782)		this->super::destroy();
HXLINE(1783)		this->_setXCallback = null();
HXLINE(1784)		this->_setYCallback = null();
HXLINE(1785)		this->_setXYCallback = null();
            	}


void FlxCallbackPoint_obj::put(){
            	HX_STACKFRAME(&_hx_pos_0e989bab684323cb_1788_put)
            	}
