...
HX_LOCAL_STACK_FRAME(_hx_pos_5b56d9e1983dc02b_338_get_TO_DEG,"flixel.math.FlxAngle","get_TO_DEG",0x36e6a544,"flixel.math.FlxAngle.get_TO_DEG","flixel/math/FlxAngle.hx",338,0x32e99189)
HX_LOCAL_STACK_FRAME(_hx_pos_5b56d9e1983dc02b_343_get_TO_RAD,"flixel.math.FlxAngle","get_TO_RAD",0x36f14153,"flixel.math.FlxAngle.get_TO_RAD","flixel/math/FlxAngle.hx",343,0x32e99189)
namespace flixel{
namespace math{
...
Float FlxAngle_obj::get_TO_DEG(){
            	HX_STACKFRAME(&_hx_pos_5b56d9e1983dc02b_338_get_TO_DEG)
HXDLIN( 338)		return (( (Float)(180) ) / ::Math_obj::PI);
            	}
...
Float FlxAngle_obj::get_TO_RAD(){
            	HX_STACKFRAME(&_hx_pos_5b56d9e1983dc02b_343_get_TO_RAD)
HXDLIN( 343)		return (::Math_obj::PI / ( (Float)(180) ));
            	}
