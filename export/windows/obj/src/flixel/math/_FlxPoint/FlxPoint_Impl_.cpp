...
HXDLIN( 370)		if (point->_weak) {
HXDLIN( 370)			point->put();
            		}
...
HXLINE( 424)		if (point->_weak) {
HXLINE( 424)			point->put();
            		}
...
HXLINE( 479)		if (point->_weak) {
HXLINE( 479)			point->put();
            		}
...
HXDLIN( 688)			if (this1->_weak) {
HXLINE( 688)				this1->put();
            			}
...
HXDLIN( 688)			if (pivot->_weak) {
HXLINE( 688)				pivot->put();
            			}
            		}
HXLINE( 689)		{
...
HXLINE( 691)		if (pivot->_weak) {
HXLINE( 691)			pivot->put();
            		}
...
HXLINE(1174)		if (a->_weak) {
HXLINE(1174)			a->put();
            		}
HXLINE(1175)		if (b->_weak) {
HXLINE(1175)			b->put();
            		}
HXLINE(1176)		if (p->_weak) {
HXLINE(1176)			p->put();
            		}
...
HXLINE(1216)			 ::flixel::math::FlxBasePoint point = ::flixel::math::FlxBasePoint_obj::pool->get().StaticCast<  ::flixel::math::FlxBasePoint >()->set(( (Float)(0) ),( (Float)(0) ));
HXDLIN(1216)			point->_inPool = false;
HXDLIN(1216)			intersection = point;
            		}
HXLINE(1219)		if (::Math_obj::isNaN(t)) {
HXLINE(1221)			Float y = ::Math_obj::NaN;
HXDLIN(1221)			intersection->set_x(::Math_obj::NaN);
HXDLIN(1221)			intersection->set_y(y);
            		}
            		else {
HXLINE(1225)			Float y = (a->y + (t * this1->y));
HXDLIN(1225)			intersection->set_x((a->x + (t * this1->x)));
HXDLIN(1225)			intersection->set_y(y);
            		}
HXLINE(1228)		if (a->_weak) {
HXLINE(1228)			a->put();
            		}
HXLINE(1229)		if (b->_weak) {
HXLINE(1229)			b->put();
            		}
HXLINE(1230)		if (p->_weak) {
HXLINE(1230)			p->put();
            		}
...
HXLINE(1249)					 ::flixel::math::FlxBasePoint point = ::flixel::math::FlxBasePoint_obj::pool->get().StaticCast<  ::flixel::math::FlxBasePoint >()->set(( (Float)(0) ),( (Float)(0) ));
HXDLIN(1249)					point->_inPool = false;
HXDLIN(1249)					p1 = point;
            				}
...
HXLINE(1250)				 ::flixel::math::FlxBasePoint p1 = ::flixel::math::_FlxPoint::FlxPoint_Impl__obj::_point1;
HXDLIN(1250)				if (::hx::IsNull( p1 )) {
HXLINE(1250)					 ::flixel::math::FlxBasePoint point = ::flixel::math::FlxBasePoint_obj::pool->get().StaticCast<  ::flixel::math::FlxBasePoint >()->set(( (Float)(0) ),( (Float)(0) ));
HXDLIN(1250)					point->_inPool = false;
HXDLIN(1250)					p1 = point;
            				}
HXDLIN(1250)				Float y = a->y;
HXDLIN(1250)				p1->set_x(a->x);
HXDLIN(1250)				p1->set_y(y);
HXDLIN(1250)				::flixel::math::_FlxPoint::FlxPoint_Impl__obj::_point1 = p1;
HXDLIN(1250)				{
HXLINE(1250)					 ::flixel::math::FlxBasePoint this2 = ::flixel::math::_FlxPoint::FlxPoint_Impl__obj::_point1;
HXDLIN(1250)					Float y1 = b->y;
HXDLIN(1250)					this2->set_x((this2->x - b->x));
HXDLIN(1250)					this2->set_y((this2->y - y1));
            				}
HXDLIN(1250)				 ::flixel::math::FlxBasePoint this3 = ::flixel::math::_FlxPoint::FlxPoint_Impl__obj::_point1;
HXDLIN(1250)				t2 = (((this3->y * this1->x) + (-(this3->x) * this1->y)) / ((p->y * this1->x) + (-(p->x) * this1->y)));
            			}
            		}
...
HXLINE(1253)			Float y = (a->y + (t1 * this1->y));
HXDLIN(1253)			intersection->set_x((a->x + (t1 * this1->x)));
HXDLIN(1253)			intersection->set_y(y);
            		}
            		else {
HXLINE(1257)			Float y = ::Math_obj::NaN;
HXDLIN(1257)			intersection->set_x(::Math_obj::NaN);
HXDLIN(1257)			intersection->set_y(y);
            		}
HXLINE(1260)		if (a->_weak) {
HXLINE(1260)			a->put();
            		}
HXLINE(1261)		if (b->_weak) {
HXLINE(1261)			b->put();
            		}
HXLINE(1262)		if (p->_weak) {
HXLINE(1262)			p->put();
            		}
...
HXLINE(1310)		if (a->_weak) {
HXLINE(1310)			a->put();
            		}
HXLINE(1311)		if (b->_weak) {
HXLINE(1311)			b->put();
            		}
...
HXLINE(1365)		if (normal->_weak) {
HXLINE(1365)			normal->put();
            		}
...
HXLINE(1380)			 ::flixel::math::FlxBasePoint point = ::flixel::math::FlxBasePoint_obj::pool->get().StaticCast<  ::flixel::math::FlxBasePoint >()->set(( (Float)(0) ),( (Float)(0) ));
HXDLIN(1380)			point->_inPool = false;
HXDLIN(1380)			proj1 = point;
            		}
...
HXLINE(1387)		if (normal->_weak) {
HXLINE(1387)			normal->put();
            		}
