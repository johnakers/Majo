...
HXDLIN(1700)		if (point->_weak) {
HXDLIN(1700)			point->put();
            		}
...
HXDLIN(1701)		if (point->_weak) {
HXDLIN(1701)			point->put();
            		}
...
HXDLIN(1718)		if (normal->_weak) {
HXDLIN(1718)			normal->put();
            		}
...
HXDLIN(1719)		if (normal->_weak) {
HXDLIN(1719)			normal->put();
            		}
