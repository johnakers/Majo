...
HXLINE( 205)				_hx_tmp = !(this->finished);
            			}
            			else {
...
HXLINE( 207)			 ::flixel::animation::FlxAnimation _hx_tmp1 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 207)			_hx_tmp1->_frameTimer = (_hx_tmp1->_frameTimer - curFrameDuration);
HXLINE( 208)			if (this->reversed) {
HXLINE( 210)				bool _hx_tmp;
HXDLIN( 210)				if (this->looped) {
HXLINE( 210)					_hx_tmp = (this->curFrame == this->loopPoint);
            				}
            				else {
...
HXLINE( 222)					_hx_tmp = (this->curFrame == (this->frames->length - 1));
            				}
            				else {
...
HXLINE( 269)					_hx_tmp = 0;
            				}
            				else {
HXLINE( 269)					_hx_tmp = maxFrameIndex;
            				}
HXDLIN( 269)				this->curFrame = _hx_tmp;
            			}
            			else {
...
HXLINE( 281)			_hx_tmp = ::hx::IsNotNull( this->parent );
            		}
            		else {
