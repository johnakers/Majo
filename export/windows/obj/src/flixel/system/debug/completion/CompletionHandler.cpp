...
HXLINE(  51)			_hx_tmp2 = ::StringTools_obj::endsWith(text,HX_("\"",22,00,00,00));
            		}
            		else {
HXLINE(  51)			_hx_tmp2 = true;
            		}
HXDLIN(  51)		if (!(_hx_tmp2)) {
HXLINE(  51)			_hx_tmp1 = ::StringTools_obj::endsWith(text,HX_("'",27,00,00,00));
            		}
            		else {
HXLINE(  51)			_hx_tmp1 = true;
            		}
HXDLIN(  51)		if (!(_hx_tmp1)) {
HXLINE(  51)			_hx_tmp = ::StringTools_obj::endsWith(text,HX_(";",3b,00,00,00));
            		}
            		else {
