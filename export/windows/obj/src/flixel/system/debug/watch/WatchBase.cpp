...
HXLINE(  66)					( ( ::flixel::_hx_system::debug::watch::WatchEntry)(existing) )->data = data;
            				...
            				break;
            				case (int)3: {
HXLINE(  65)					 ::Dynamic _g = data->_hx_getObject(0);
HXLINE(  66)					( ( ::flixel::_hx_system::debug::watch::WatchEntry)(existing) )->data = data;
            				}
            				break;
            				default:{
...
HXLINE(  93)					switch((int)(data->_hx_getIndex())){
            						case (int)1: {
HXLINE(  93)							::String _g = data->_hx_getString(0);
HXDLIN(  93)							_hx_tmp = true;
            						}
            						break;
            						case (int)3: {
HXLINE(  93)							 ::Dynamic _g = data->_hx_getObject(0);
HXDLIN(  93)							_hx_tmp = true;
            						}
            						break;
            						default:{
...
HXLINE( 107)		{
            			HX_BEGIN_LOCAL_FUNC_S2(::hx::LocalFunc,_hx_Closure_0, ::Dynamic,entry1, ::Dynamic,_g) HXARGC(0)
            			void _hx_run(){
            				HX_STACKFRAME(&_hx_pos_64dd92a28a81661d_107_addEntry)
HXLINE( 107)				_g(entry1);
            			}
            			HX_END_LOCAL_FUNC0((void))

HXLINE( 107)			 ::Dynamic _g = this->removeEntry_dyn();
