...
HX_DEFINE_STACK_FRAME(_hx_pos_f3919820c0c3a2ee_19_new,"flixel.system.debug.watch.Watch","new",0xfeaf943a,"flixel.system.debug.watch.Watch.new","flixel/system/debug/watch/Watch.hx",19,0x446c9b58)
namespace flixel{
...
void Watch_obj::__construct(::hx::Null< bool >  __o_closable){
            		HX_BEGIN_LOCAL_FUNC_S0(::hx::LocalFunc,_hx_Closure_0) HXARGC(2)
            		 ::flixel::_hx_system::debug::watch::WatchEntry _hx_run(::String displayName, ::flixel::_hx_system::debug::watch::WatchEntryData data){
            			HX_GC_STACKFRAME(&_hx_pos_f3919820c0c3a2ee_19_new)
HXDLIN(  19)			return  ::flixel::_hx_system::debug::watch::WatchEntry_obj::__alloc( HX_CTX ,displayName,data);
            		}
            		HX_END_LOCAL_FUNC2(return)

            		bool closable = __o_closable.Default(false);
            	HX_STACKFRAME(&_hx_pos_f3919820c0c3a2ee_19_new)
HXDLIN(  19)		super::__construct( ::Dynamic(new _hx_Closure_0()),HX_("Watch",2f,86,52,58),::flixel::_hx_system::debug::Icon_obj::watch,true,null(),closable,null());
            	}
	...
	if (inClassId<=(int)0x27ebba19) {
		...
		if (inClassId<=(int)0x5ad89704) {
			if (inClassId<=(int)0x4af7dd8e) {
				...
				return inClassId==(int)0x5ad89704;
			}
		} else {
