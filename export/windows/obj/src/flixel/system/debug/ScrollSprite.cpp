...
HXDLIN(  53)			Float _hx_tmp = this->get_mouseX();
HXDLIN(  53)			_hx_tmp2 = (_hx_tmp < this->scroll->width);
            		}
            		else {
HXDLIN(  53)			_hx_tmp2 = false;
            		}
HXDLIN(  53)		if (_hx_tmp2) {
HXDLIN(  53)			Float _hx_tmp = this->get_mouseY();
HXDLIN(  53)			_hx_tmp1 = ((_hx_tmp - this->scroll->y) > 0);
            		}
            		else {
HXDLIN(  53)			_hx_tmp1 = false;
            		}
HXDLIN(  53)		if (_hx_tmp1) {
HXDLIN(  53)			Float _hx_tmp1 = this->get_mouseY();
HXDLIN(  53)			_hx_tmp = ((_hx_tmp1 - this->scroll->y) < this->scroll->height);
            		}
            		else {
...
HXLINE(  73)			Float _hx_tmp = this->get_height();
HXDLIN(  73)			this->scroll->y = (_hx_tmp - this->scroll->height);
            		}
...
HXLINE(  94)			HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(HX_("Invalid child, not a child of this container",31,8b,e8,fe)));
            		}
HXLINE(  96)		Float _hx_tmp = child->get_y();
HXDLIN(  96)		if ((_hx_tmp < this->scroll->get_bottom())) {
HXLINE(  96)			Float _hx_tmp = child->get_y();
HXDLIN(  96)			Float _hx_tmp1 = (_hx_tmp + child->get_height());
HXDLIN(  96)			return (_hx_tmp1 > this->scroll->y);
            		}
            		else {
