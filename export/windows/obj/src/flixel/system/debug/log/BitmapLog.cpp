...
HXLINE( 154)			 ::openfl::display::Bitmap _hx_tmp = this->canvas;
HXDLIN( 154)			_hx_tmp->set_bitmapData( ::openfl::display::BitmapData_obj::__alloc( HX_CTX ,canvasWidth1,canvasHeight2,true,0));
HXLINE( 155)			this->drawCanvas();
            		}
HXLINE( 158)		 ::flixel::_hx_system::ui::FlxSystemButton _hx_tmp2 = this->buttonRemove;
HXDLIN( 158)		int _hx_tmp3 = this->_width;
HXDLIN( 158)		_hx_tmp2->set_x(((( (Float)(_hx_tmp3) ) - this->buttonRemove->get_width()) - ( (Float)(3) )));
HXLINE( 160)		this->header->resize(( (Float)((this->_width - 5)) ));
HXLINE( 161)		 ::flixel::_hx_system::debug::log::Footer _hx_tmp4 = this->footer;
HXDLIN( 161)		int _hx_tmp5 = this->_height;
HXDLIN( 161)		_hx_tmp4->set_y(( (Float)((_hx_tmp5 - this->footer->getHeight())) ));
...
HXLINE( 173)				 ::Dynamic _g1_value = _g_array->__get(_g_current);
HXDLIN( 173)				_g_current = (_g_current + 1);
HXDLIN( 173)				int _g1_key = (_g_current - 1);
HXDLIN( 173)				int i = _g1_key;
HXDLIN( 173)				 ::Dynamic entry = _g1_value;
...
HXLINE( 193)				 ::Dynamic _g1_value = _g_array->__get(_g_current);
HXDLIN( 193)				_g_current = (_g_current + 1);
HXDLIN( 193)				int _g1_key = (_g_current - 1);
HXDLIN( 193)				int i = _g1_key;
HXDLIN( 193)				 ::Dynamic entry = _g1_value;
...
HXDLIN( 278)			if (point2->_weak) {
HXLINE( 278)				point2->put();
            			}
            		}
