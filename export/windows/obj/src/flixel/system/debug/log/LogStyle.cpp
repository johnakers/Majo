...
HX_DEFINE_STACK_FRAME(_hx_pos_4946e010770d7497_12_new,"flixel.system.debug.log.LogStyle","new",0xce018851,"flixel.system.debug.log.LogStyle.new","flixel/system/debug/log/LogStyle.hx",12,0x39dedcdd)
HX_LOCAL_STACK_FRAME(_hx_pos_4946e010770d7497_100_toLogString,"flixel.system.debug.log.LogStyle","toLogString",0x1c85306b,"flixel.system.debug.log.LogStyle.toLogString","flixel/system/debug/log/LogStyle.hx",100,0x39dedcdd)
HX_LOCAL_STACK_FRAME(_hx_pos_4946e010770d7497_121_toHtmlString,"flixel.system.debug.log.LogStyle","toHtmlString",0x574f07e6,"flixel.system.debug.log.LogStyle.toHtmlString","flixel/system/debug/log/LogStyle.hx",121,0x39dedcdd)
...
HX_LOCAL_STACK_FRAME(_hx_pos_4946e010770d7497_18_boot,"flixel.system.debug.log.LogStyle","boot",0x6b6ebf21,"flixel.system.debug.log.LogStyle.boot","flixel/system/debug/log/LogStyle.hx",18,0x39dedcdd)
namespace flixel{
...
void LogStyle_obj::__construct(::String __o_prefix,::String __o_color,::hx::Null< int >  __o_size,::hx::Null< bool >  __o_bold,::hx::Null< bool >  __o_italic,::hx::Null< bool >  __o_underlined,::String errorSound,::hx::Null< bool >  __o_openConsole, ::Dynamic callbackFunction, ::Dynamic callback,::hx::Null< bool >  __o_throwException){
            	...
            	HX_GC_STACKFRAME(&_hx_pos_4946e010770d7497_12_new)
HXLINE(  59)		this->throwException = false;
HXLINE(  52)		this->onLog =  ::flixel::util::_FlxSignal::FlxSignal2_obj::__alloc( HX_CTX );
HXLINE(  80)		this->prefix = prefix;
HXLINE(  81)		this->color = color;
HXLINE(  82)		this->size = size;
HXLINE(  83)		this->bold = bold;
HXLINE(  84)		this->italic = italic;
HXLINE(  85)		this->underlined = underlined;
HXLINE(  86)		this->errorSound = errorSound;
HXLINE(  87)		this->openConsole = openConsole;
HXLINE(  88)		this->callbackFunction = callbackFunction;
HXLINE(  89)		if (::hx::IsNotNull( callback )) {
HXLINE(  90)			this->onLog->add(callback);
            		}
HXLINE(  91)		this->throwException = throwException;
            	}
...
::String LogStyle_obj::toLogString(::cpp::VirtualArray data){
            	HX_STACKFRAME(&_hx_pos_4946e010770d7497_100_toLogString)
HXLINE( 102)		::Array< ::String > texts = ::Array_obj< ::String >::__new();
HXLINE( 103)		{
HXLINE( 103)			int _g = 0;
HXDLIN( 103)			int _g1 = data->get_length();
HXDLIN( 103)			while((_g < _g1)){
HXLINE( 103)				_g = (_g + 1);
HXDLIN( 103)				int i = (_g - 1);
HXLINE( 105)				::String text = ::Std_obj::string(data->__get(i));
HXLINE( 108)				texts->push(::StringTools_obj::htmlEscape(text,null()));
            			}
            		}
HXLINE( 111)		::String _hx_tmp = this->prefix;
HXDLIN( 111)		return (_hx_tmp + texts->join(HX_(" ",20,00,00,00)));
            	}
...
::String LogStyle_obj::toHtmlString(::cpp::VirtualArray data){
            	HX_STACKFRAME(&_hx_pos_4946e010770d7497_121_toHtmlString)
HXDLIN( 121)		::String _hx_tmp = this->toLogString(data);
HXDLIN( 121)		return ::flixel::util::FlxStringUtil_obj::htmlFormat(_hx_tmp,this->size,this->color,this->bold,this->italic,this->underlined);
            	}
...
static ::hx::StorageInfo LogStyle_obj_sMemberStorageInfo[] = {
	...
	{::hx::fsObject /*  ::flixel::util::_FlxSignal::FlxSignal2 */ ,(int)offsetof(LogStyle_obj,onLog),HX_("onLog",a5,e8,69,32)},
...
HXDLIN(  14)		NORMAL =  ::flixel::_hx_system::debug::log::LogStyle_obj::__alloc( HX_CTX ,null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null());
            	}
{
            	HX_GC_STACKFRAME(&_hx_pos_4946e010770d7497_15_boot)
HXDLIN(  15)		WARNING =  ::flixel::_hx_system::debug::log::LogStyle_obj::__alloc( HX_CTX ,HX_("[WARNING] ",a4,a2,0d,4e),HX_("D9F85C",15,36,8b,30),12,false,false,false,HX_("flixel/sounds/beep",e6,b5,a9,33),true,null(),null(),null());
            	}
{
            	HX_GC_STACKFRAME(&_hx_pos_4946e010770d7497_16_boot)
HXDLIN(  16)		ERROR =  ::flixel::_hx_system::debug::log::LogStyle_obj::__alloc( HX_CTX ,HX_("[ERROR] ",d0,1f,cd,be),HX_("FF8888",40,7f,36,70),12,false,false,false,HX_("flixel/sounds/beep",e6,b5,a9,33),true,null(),null(),null());
            	}
{
            	HX_GC_STACKFRAME(&_hx_pos_4946e010770d7497_17_boot)
HXDLIN(  17)		NOTICE =  ::flixel::_hx_system::debug::log::LogStyle_obj::__alloc( HX_CTX ,HX_("[NOTICE] ",96,5e,07,09),HX_("5CF878",41,9b,32,f3),12,false,null(),null(),null(),null(),null(),null(),null());
            	}
{
            	HX_GC_STACKFRAME(&_hx_pos_4946e010770d7497_18_boot)
HXDLIN(  18)		CONSOLE =  ::flixel::_hx_system::debug::log::LogStyle_obj::__alloc( HX_CTX ,HX_("> ",22,36,00,00),HX_("5A96FA",c4,34,cc,c3),12,false,null(),null(),null(),null(),null(),null(),null());
            	}
}
