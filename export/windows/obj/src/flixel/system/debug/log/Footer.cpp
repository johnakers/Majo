...
HXLINE( 416)			::String _hx_tmp = ( (::String)(((HX_("\"",22,00,00,00) + entry->__Field(HX_("name",4b,72,ff,48),::hx::paccDynamic)) + HX_("\" | ",62,f5,91,16))) );
...
HXLINE( 416)			_hx_tmp1 = (_hx_tmp + ::flixel::util::FlxStringUtil_obj::formatBytes(( (Float)(((bitmapData->width * bitmapData->height) * 4)) ),null()));
            		}
HXDLIN( 416)		_hx_tmp->set_text(_hx_tmp1);
HXLINE( 418)		 ::openfl::text::TextField _hx_tmp2 = this->text;
HXDLIN( 418)		Float _hx_tmp3 = this->bg->get_width();
HXDLIN( 418)		_hx_tmp2->set_x(((_hx_tmp3 - this->text->get_width()) / ( (Float)(2) )));
            	}
