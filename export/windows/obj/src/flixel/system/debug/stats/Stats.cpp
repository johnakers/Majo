...
HXLINE( 240)			 ::flixel::_hx_system::debug::stats::StatsGraph _hx_tmp = this->memoryGraph;
HXDLIN( 240)			_hx_tmp->update(((::openfl::_hx_system::System_obj::get_totalMemoryNumber() / ( (Float)(1024) )) / ( (Float)(1000) )));
...
HXLINE( 249)					 ::flixel::_hx_system::debug::stats::Stats _hx_tmp = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 249)					_hx_tmp->updateTime = (_hx_tmp->updateTime + this->_update->__get(i));
            				}
            			}
HXLINE( 252)			{
...
HXLINE( 254)					 ::flixel::_hx_system::debug::stats::Stats _hx_tmp = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 254)					_hx_tmp->activeCount = (_hx_tmp->activeCount + this->_activeObject->__get(i));
            				}
            			}
...
HXDLIN( 259)					int i = (_g4 - 1);
HXLINE( 261)					 ::flixel::_hx_system::debug::stats::Stats _hx_tmp = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 261)					_hx_tmp->drawTime = (_hx_tmp->drawTime + this->_draw->__get(i));
            				}
            			}
HXLINE( 264)			{
...
HXDLIN( 264)					int i = (_g6 - 1);
HXLINE( 266)					 ::flixel::_hx_system::debug::stats::Stats _hx_tmp = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 266)					_hx_tmp->visibleCount = (_hx_tmp->visibleCount + this->_visibleObject->__get(i));
            				}
            			}
...
HXLINE( 272)				{
HXLINE( 272)					int _g = 0;
HXDLIN( 272)					int _g1 = this->_drawCallsMarker;
HXDLIN( 272)					while((_g < _g1)){
HXLINE( 272)						_g = (_g + 1);
HXDLIN( 272)						int i = (_g - 1);
HXLINE( 274)						 ::flixel::_hx_system::debug::stats::Stats _hx_tmp = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 274)						_hx_tmp->drawCallsCount = (_hx_tmp->drawCallsCount + this->_drawCalls->__get(i));
            					}
            				}
...
HXLINE( 288)			 ::flixel::_hx_system::debug::stats::Stats _hx_tmp1 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 288)			_hx_tmp1->_updateTimer = (_hx_tmp1->_updateTimer - 250);
            		}
            	}
