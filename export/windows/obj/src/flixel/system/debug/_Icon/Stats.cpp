...
HX_DEFINE_STACK_FRAME(_hx_pos_fa8bfe12a619274b_47_new,"flixel.system.debug._Icon.Stats","new",0x3d9aa273,"flixel.system.debug._Icon.Stats.new","openfl/utils/_internal/AssetsMacro.hx",47,0xfdd54705)
HX_LOCAL_STACK_FRAME(_hx_pos_4cd79e22fd8eabe4_42_boot,"flixel.system.debug._Icon.Stats","boot",0xa1cc82bf,"flixel.system.debug._Icon.Stats.boot","flixel/system/debug/Icon.hx",42,0x2ea0993c)
namespace flixel{
namespace _hx_system{
namespace debug{
namespace _Icon{

void Stats_obj::__construct(int width,int height, ::Dynamic __o_transparent, ::Dynamic __o_fillRGBA){
            	...
            	HX_STACKFRAME(&_hx_pos_fa8bfe12a619274b_47_new)
HXLINE(  71)		super::__construct(0,0,transparent,fillRGBA);
HXLINE(  73)		 ::openfl::utils::ByteArrayData byteArray = ::openfl::utils::_ByteArray::ByteArray_Impl__obj::fromBytes(::haxe::Resource_obj::getBytes(::flixel::_hx_system::debug::_Icon::Stats_obj::resourceName));
HXLINE(  74)		{
...
::String Stats_obj::resourceName;


::hx::ObjectPtr< Stats_obj > Stats_obj::__new(int width,int height, ::Dynamic __o_transparent, ::Dynamic __o_fillRGBA) {
	::hx::ObjectPtr< Stats_obj > __this = new Stats_obj();
	__this->__construct(width,height,__o_transparent,__o_fillRGBA);
	return __this;
}

::hx::ObjectPtr< Stats_obj > Stats_obj::__alloc(::hx::Ctx *_hx_ctx,int width,int height, ::Dynamic __o_transparent, ::Dynamic __o_fillRGBA) {
...
static ::hx::StaticInfo Stats_obj_sStaticStorageInfo[] = {
	{::hx::fsString,(void *) &Stats_obj::resourceName,HX_("resourceName",39,7a,62,90)},
	{ ::hx::fsUnknown, 0, null()}
};
#endif

static void Stats_obj_sMarkStatics(HX_MARK_PARAMS) {
	HX_MARK_MEMBER_NAME(Stats_obj::resourceName,"resourceName");
};

#ifdef HXCPP_VISIT_ALLOCS
static void Stats_obj_sVisitStatics(HX_VISIT_PARAMS) {
	HX_VISIT_MEMBER_NAME(Stats_obj::resourceName,"resourceName");
};
...
{
{
            	HX_STACKFRAME(&_hx_pos_4cd79e22fd8eabe4_42_boot)
HXDLIN(  42)		resourceName = HX_("__ASSET__:bitmap_flixel_system_debug__Icon_Stats",d9,2a,90,df);
            	}
}
