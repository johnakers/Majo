...
HX_DEFINE_STACK_FRAME(_hx_pos_87746b6d418a427f_47_new,"flixel.system.debug._Icon.Transform","new",0xb0271d40,"flixel.system.debug._Icon.Transform.new","openfl/utils/_internal/AssetsMacro.hx",47,0xfdd54705)
HX_LOCAL_STACK_FRAME(_hx_pos_0255f4746d6343e6_18_boot,"flixel.system.debug._Icon.Transform","boot",0x6a2b7b52,"flixel.system.debug._Icon.Transform.boot","flixel/system/debug/Icon.hx",18,0x2ea0993c)
namespace flixel{
namespace _hx_system{
namespace debug{
namespace _Icon{

void Transform_obj::__construct(int width,int height, ::Dynamic __o_transparent, ::Dynamic __o_fillRGBA){
            	...
            	HX_STACKFRAME(&_hx_pos_87746b6d418a427f_47_new)
HXLINE(  71)		super::__construct(0,0,transparent,fillRGBA);
HXLINE(  73)		 ::openfl::utils::ByteArrayData byteArray = ::openfl::utils::_ByteArray::ByteArray_Impl__obj::fromBytes(::haxe::Resource_obj::getBytes(::flixel::_hx_system::debug::_Icon::Transform_obj::resourceName));
HXLINE(  74)		{
...
::String Transform_obj::resourceName;


::hx::ObjectPtr< Transform_obj > Transform_obj::__new(int width,int height, ::Dynamic __o_transparent, ::Dynamic __o_fillRGBA) {
	::hx::ObjectPtr< Transform_obj > __this = new Transform_obj();
	__this->__construct(width,height,__o_transparent,__o_fillRGBA);
	return __this;
}

::hx::ObjectPtr< Transform_obj > Transform_obj::__alloc(::hx::Ctx *_hx_ctx,int width,int height, ::Dynamic __o_transparent, ::Dynamic __o_fillRGBA) {
...
static ::hx::StaticInfo Transform_obj_sStaticStorageInfo[] = {
	{::hx::fsString,(void *) &Transform_obj::resourceName,HX_("resourceName",39,7a,62,90)},
	{ ::hx::fsUnknown, 0, null()}
};
#endif

static void Transform_obj_sMarkStatics(HX_MARK_PARAMS) {
	HX_MARK_MEMBER_NAME(Transform_obj::resourceName,"resourceName");
};

#ifdef HXCPP_VISIT_ALLOCS
static void Transform_obj_sVisitStatics(HX_VISIT_PARAMS) {
	HX_VISIT_MEMBER_NAME(Transform_obj::resourceName,"resourceName");
};
...
{
{
            	HX_STACKFRAME(&_hx_pos_0255f4746d6343e6_18_boot)
HXDLIN(  18)		resourceName = HX_("__ASSET__:bitmap_flixel_system_debug__Icon_Transform",26,c7,09,ec);
            	}
}
