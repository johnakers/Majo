...
HXLINE( 159)			HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(HX_("expected state: IDLE",e3,7b,d4,5c)));
            		}
...
HXLINE( 170)				HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(HX_("expected state: IDLE",e3,7b,d4,5c)));
            			}
...
HXLINE( 209)			 ::openfl::display::Sprite _hx_tmp = this->handle;
HXDLIN( 209)			Float _hx_tmp1 = this->bg->get_height();
HXDLIN( 209)			_hx_tmp->set_y((_hx_tmp1 - this->handle->get_height()));
            		}
HXLINE( 211)		{
...
HXLINE( 223)			 ::flixel::_hx_system::debug::ScrollSprite _this = this->target;
HXDLIN( 223)			Float _hx_tmp1 = _this->get_height();
HXDLIN( 223)			Float _hx_tmp2 = (_hx_tmp1 - _this->scroll->height);
HXDLIN( 223)			_hx_tmp = (_hx_tmp2 < this->target->get_height());
            		}
            		else {
HXLINE( 223)			_hx_tmp = false;
            		}
HXDLIN( 223)		this->mouseEnabled = (this->mouseChildren = this->set_visible(_hx_tmp));
HXLINE( 224)		 ::openfl::display::Sprite _hx_tmp2 = this->handle;
HXDLIN( 224)		Float _hx_tmp3 = this->target->scroll->y;
HXDLIN( 224)		 ::flixel::_hx_system::debug::ScrollSprite _this1 = this->target;
HXDLIN( 224)		Float _hx_tmp4 = _this1->get_height();
HXDLIN( 224)		Float _hx_tmp5 = (_hx_tmp3 / (_hx_tmp4 - _this1->scroll->height));
HXDLIN( 224)		Float _hx_tmp6 = this->bg->get_height();
HXDLIN( 224)		_hx_tmp2->set_y((_hx_tmp5 * (_hx_tmp6 - this->handle->get_height())));
            	}
