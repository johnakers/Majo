...
HX_DEFINE_STACK_FRAME(_hx_pos_d2c099c398a4a018_15_new,"flixel.system.debug.interaction.tools.Tool","new",0xbd6c80c1,"flixel.system.debug.interaction.tools.Tool.new","flixel/system/debug/interaction/tools/Tool.hx",15,0xb5d06f0c)
HX_LOCAL_STACK_FRAME(_hx_pos_d2c099c398a4a018_26_init,"flixel.system.debug.interaction.tools.Tool","init",0xfe3cdf8f,"flixel.system.debug.interaction.tools.Tool.init","flixel/system/debug/interaction/tools/Tool.hx",26,0xb5d06f0c)
HX_LOCAL_STACK_FRAME(_hx_pos_d2c099c398a4a018_31_update,"flixel.system.debug.interaction.tools.Tool","update",0x9e988848,"flixel.system.debug.interaction.tools.Tool.update","flixel/system/debug/interaction/tools/Tool.hx",31,0xb5d06f0c)
HX_LOCAL_STACK_FRAME(_hx_pos_d2c099c398a4a018_33_draw,"flixel.system.debug.interaction.tools.Tool","draw",0xfaf1d083,"flixel.system.debug.interaction.tools.Tool.draw","flixel/system/debug/interaction/tools/Tool.hx",33,0xb5d06f0c)
HX_LOCAL_STACK_FRAME(_hx_pos_d2c099c398a4a018_35_activate,"flixel.system.debug.interaction.tools.Tool","activate",0x49b36bb2,"flixel.system.debug.interaction.tools.Tool.activate","flixel/system/debug/interaction/tools/Tool.hx",35,0xb5d06f0c)
HX_LOCAL_STACK_FRAME(_hx_pos_d2c099c398a4a018_37_deactivate,"flixel.system.debug.interaction.tools.Tool","deactivate",0x2c7be9f3,"flixel.system.debug.interaction.tools.Tool.deactivate","flixel/system/debug/interaction/tools/Tool.hx",37,0xb5d06f0c)
HX_LOCAL_STACK_FRAME(_hx_pos_d2c099c398a4a018_39_destroy,"flixel.system.debug.interaction.tools.Tool","destroy",0xad9521db,"flixel.system.debug.interaction.tools.Tool.destroy","flixel/system/debug/interaction/tools/Tool.hx",39,0xb5d06f0c)
HX_LOCAL_STACK_FRAME(_hx_pos_d2c099c398a4a018_43_isActive,"flixel.system.debug.interaction.tools.Tool","isActive",0xd2b72d4f,"flixel.system.debug.interaction.tools.Tool.isActive","flixel/system/debug/interaction/tools/Tool.hx",43,0xb5d06f0c)
HX_LOCAL_STACK_FRAME(_hx_pos_d2c099c398a4a018_47_setButton,"flixel.system.debug.interaction.tools.Tool","setButton",0x5be68655,"flixel.system.debug.interaction.tools.Tool.setButton","flixel/system/debug/interaction/tools/Tool.hx",47,0xb5d06f0c)
HX_LOCAL_STACK_FRAME(_hx_pos_d2c099c398a4a018_65_setCursor,"flixel.system.debug.interaction.tools.Tool","setCursor",0xc0eeb339,"flixel.system.debug.interaction.tools.Tool.setCursor","flixel/system/debug/interaction/tools/Tool.hx",65,0xb5d06f0c)
HX_LOCAL_STACK_FRAME(_hx_pos_d2c099c398a4a018_81_setCursorInUse,"flixel.system.debug.interaction.tools.Tool","setCursorInUse",0x1d76b369,"flixel.system.debug.interaction.tools.Tool.setCursorInUse","flixel/system/debug/interaction/tools/Tool.hx",81,0xb5d06f0c)
HX_LOCAL_STACK_FRAME(_hx_pos_d2c099c398a4a018_89_useDefaultCursor,"flixel.system.debug.interaction.tools.Tool","useDefaultCursor",0x26a50caf,"flixel.system.debug.interaction.tools.Tool.useDefaultCursor","flixel/system/debug/interaction/tools/Tool.hx",89,0xb5d06f0c)
HX_LOCAL_STACK_FRAME(_hx_pos_d2c099c398a4a018_95_onButtonClicked,"flixel.system.debug.interaction.tools.Tool","onButtonClicked",0x655fe417,"flixel.system.debug.interaction.tools.Tool.onButtonClicked","flixel/system/debug/interaction/tools/Tool.hx",95,0xb5d06f0c)
HX_LOCAL_STACK_FRAME(_hx_pos_d2c099c398a4a018_100_getName,"flixel.system.debug.interaction.tools.Tool","getName",0xa49116e2,"flixel.system.debug.interaction.tools.Tool.getName","flixel/system/debug/interaction/tools/Tool.hx",100,0xb5d06f0c)
namespace flixel{
...
void Tool_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_d2c099c398a4a018_15_new)
HXLINE(  21)		this->_name = HX_("(Unknown tool)",73,db,28,1c);
HXLINE(  19)		this->cursorInUse = HX_("",00,00,00,00);
...
void *Tool_obj::_hx_getInterface(int inHash) {
 ...
 ::flixel::_hx_system::debug::interaction::tools::Tool Tool_obj::init( ::flixel::_hx_system::debug::interaction::Interaction brain){
            	HX_STACKFRAME(&_hx_pos_d2c099c398a4a018_26_init)
HXLINE(  27)		this->_brain = brain;
...
void Tool_obj::update(){
            	HX_STACKFRAME(&_hx_pos_d2c099c398a4a018_31_update)
            	}
...
void Tool_obj::draw(){
            	HX_STACKFRAME(&_hx_pos_d2c099c398a4a018_33_draw)
            	}
...
void Tool_obj::activate(){
            	HX_STACKFRAME(&_hx_pos_d2c099c398a4a018_35_activate)
            	}
...
void Tool_obj::deactivate(){
            	HX_STACKFRAME(&_hx_pos_d2c099c398a4a018_37_deactivate)
            	}
...
void Tool_obj::destroy(){
            	HX_STACKFRAME(&_hx_pos_d2c099c398a4a018_39_destroy)
            	}
...
bool Tool_obj::isActive(){
            	HX_STACKFRAME(&_hx_pos_d2c099c398a4a018_43_isActive)
HXDLIN(  43)		if (::hx::IsInstanceEq( this->_brain->activeTool,::hx::ObjectPtr<OBJ_>(this) )) {
HXDLIN(  43)			return this->_brain->get_visible();
            		}
            		else {
...
void Tool_obj::setButton( ::Dynamic icon){
            	HX_GC_STACKFRAME(&_hx_pos_d2c099c398a4a018_47_setButton)
HXLINE(  48)		this->button =  ::flixel::_hx_system::ui::FlxSystemButton_obj::__alloc( HX_CTX ,::flixel::_hx_system::_FlxAssets::FlxGraphicSource_Impl__obj::resolveBitmapData(icon),this->onButtonClicked_dyn(),true);
HXLINE(  49)		this->button->set_toggled(true);
HXLINE(  51)		::String tooltipName = this->_name;
HXLINE(  52)		if (::hx::IsNotNull( this->_shortcut )) {
HXLINE(  53)			tooltipName = (tooltipName + ((HX_(" (",08,1c,00,00) + this->_shortcut) + HX_(")",29,00,00,00)));
            		}
HXLINE(  54)		::flixel::_hx_system::debug::Tooltip_obj::add(this->button,tooltipName);
            	}


HX_DEFINE_DYNAMIC_FUNC1(Tool_obj,setButton,(void))

void Tool_obj::setCursor( ::openfl::display::BitmapData Icon,::hx::Null< Float >  __o_offsetX,::hx::Null< Float >  __o_offsetY){
            		Float offsetX = __o_offsetX.Default(((Float)0.0));
            		Float offsetY = __o_offsetY.Default(((Float)0.0));
            	HX_STACKFRAME(&_hx_pos_d2c099c398a4a018_65_setCursor)
HXLINE(  66)		this->cursor = Icon;
HXLINE(  67)		this->_brain->registerCustomCursor(this->_name,this->cursor,offsetX,offsetY);
            	}


HX_DEFINE_DYNAMIC_FUNC3(Tool_obj,setCursor,(void))

void Tool_obj::setCursorInUse(::String customCursorName){
            	HX_STACKFRAME(&_hx_pos_d2c099c398a4a018_81_setCursorInUse)
HXDLIN(  81)		this->cursorInUse = customCursorName;
            	}
...
void Tool_obj::useDefaultCursor(){
            	HX_STACKFRAME(&_hx_pos_d2c099c398a4a018_89_useDefaultCursor)
HXDLIN(  89)		if ((this->cursorInUse != HX_("",00,00,00,00))) {
HXLINE(  90)			this->cursorInUse = HX_("",00,00,00,00);
            		}
            	}
...
void Tool_obj::onButtonClicked(){
            	HX_STACKFRAME(&_hx_pos_d2c099c398a4a018_95_onButtonClicked)
HXDLIN(  95)		this->_brain->setActiveTool(::hx::ObjectPtr<OBJ_>(this));
            	}
...
::String Tool_obj::getName(){
            	HX_STACKFRAME(&_hx_pos_d2c099c398a4a018_100_getName)
HXDLIN( 100)		return this->_name;
            	}
