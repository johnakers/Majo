...
HXDLIN(  50)			while(true){
HXDLIN(  50)				bool member;
HXDLIN(  50)				if ((_g__cursor < _g__length)) {
HXDLIN(  50)					if (::hx::IsNotNull( _g__groupMembers->__get(_g__cursor).StaticCast<  ::flixel::FlxObject >() )) {
HXDLIN(  50)						if (::hx::IsNotNull( _g__filter )) {
HXDLIN(  50)							member = !(( (bool)(_g__filter(_g__groupMembers->__get(_g__cursor).StaticCast<  ::flixel::FlxObject >())) ));
            						}
            						else {
HXDLIN(  50)							member = false;
            						}
            					}
            					else {
HXDLIN(  50)						member = true;
            					}
            				}
            				else {
HXDLIN(  50)					member = false;
...
HXDLIN(  50)			 ::flixel::FlxObject member1 = member;
HXLINE(  52)			if (::hx::IsNull( member1 )) {
HXLINE(  53)				continue;
            			}
HXLINE(  55)			if (!(::Std_obj::isOfType(member1,::hx::ClassOf< ::flixel::group::FlxTypedGroup >()))) {
HXLINE(  61)				member1->kill();
HXLINE(  62)				if (remove) {
HXLINE(  63)					this->removeFromMemory(member1,::flixel::FlxG_obj::game->_state);
            				}
            			}
            		}
            		_hx_goto_5:;
