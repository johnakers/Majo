...
HXLINE(  59)							this->state = ::flixel::_hx_system::debug::interaction::tools::_Pointer::State_obj::DRAG(startX,startY);
            				...
            				break;
            				case (int)2: {
HXLINE(  61)					Float startX = _g->_hx_getFloat(0);
HXDLIN(  61)					Float startY = _g->_hx_getFloat(1);
HXLINE(  62)					if (this->_brain->pointerJustReleased) {
HXLINE(  64)						 ::flixel::math::FlxRect _this = ::flixel::math::FlxRect_obj::_pool->get().StaticCast<  ::flixel::math::FlxRect >();
HXDLIN(  64)						_this->x = startX;
HXDLIN(  64)						_this->y = startY;
HXDLIN(  64)						_this->width = ( (Float)(0) );
HXDLIN(  64)						_this->height = ( (Float)(0) );
HXDLIN(  64)						 ::flixel::math::FlxRect rect = _this;
HXDLIN(  64)						rect->_inPool = false;
HXDLIN(  64)						 ::flixel::math::FlxRect selection = rect;
HXLINE(  65)						::flixel::_hx_system::debug::interaction::tools::Pointer_obj::setAbsRect(selection,startX,startY,this->_brain->flixelPointer->x,this->_brain->flixelPointer->y);
HXLINE(  66)						::Array< ::Dynamic> items = this->_brain->getItemsWithinState(::flixel::FlxG_obj::game->_state,selection);
HXLINE(  67)						this->updateSelected(::flixel::_hx_system::debug::interaction::tools::_Pointer::Selection_obj::ALL(items));
HXLINE(  68)						if (!(selection->_inPool)) {
HXLINE(  68)							selection->_inPool = true;
HXDLIN(  68)							selection->_weak = false;
HXDLIN(  68)							::flixel::math::FlxRect_obj::_pool->putUnsafe(selection);
            						}
...
HXLINE(  95)						 ::flixel::FlxObject item = _g;
HXDLIN(  95)						if (shift) {
HXLINE(  97)							if (_gthis->_brain->selectedItems->members->contains(item)) {
HXLINE(  98)								selected->remove(item,null()).StaticCast<  ::flixel::FlxObject >();
            							}
            							else {
HXLINE( 100)								selected->add(item).StaticCast<  ::flixel::FlxObject >();
            							}
            						}
            						else {
HXLINE( 101)							 ::flixel::FlxObject item = _g;
HXDLIN( 101)							{
HXLINE( 103)								this->_brain->clearSelection();
HXLINE( 104)								selected->add(item).StaticCast<  ::flixel::FlxObject >();
            							}
            						}
            					}
            				}
            			...
            			break;
            			case (int)1: {
HXLINE( 119)				::Array< ::Dynamic> _g = selection->_hx_getObject(0).StaticCast< ::Array< ::Dynamic> >();
HXDLIN( 119)				if ((_g->length == 0)) {
HXLINE(  86)					bool _hx_tmp;
HXDLIN(  86)					if (!(alt)) {
HXLINE(  86)						_hx_tmp = shift;
            					}
...
HXLINE( 105)					::Array< ::Dynamic> items = _g;
HXDLIN( 105)					if (alt) {
HXLINE( 107)						int _g = 0;
HXDLIN( 107)						while((_g < items->length)){
HXLINE( 107)							 ::flixel::FlxObject item = items->__get(_g).StaticCast<  ::flixel::FlxObject >();
HXDLIN( 107)							_g = (_g + 1);
HXLINE( 109)							if (_gthis->_brain->selectedItems->members->contains(item)) {
HXLINE( 110)								selected->remove(item,null()).StaticCast<  ::flixel::FlxObject >();
            							}
            						}
            					}
            					else {
HXLINE( 112)						::Array< ::Dynamic> items = _g;
HXDLIN( 112)						if (shift) {
HXLINE( 114)							int _g = 0;
HXDLIN( 114)							while((_g < items->length)){
HXLINE( 114)								 ::flixel::FlxObject item = items->__get(_g).StaticCast<  ::flixel::FlxObject >();
HXDLIN( 114)								_g = (_g + 1);
HXLINE( 116)								if (_gthis->_brain->selectedItems->members->contains(item)) {
HXLINE( 117)									selected->add(item).StaticCast<  ::flixel::FlxObject >();
            								}
            							}
            						}
            						else {
HXLINE( 119)							::Array< ::Dynamic> items = _g;
HXDLIN( 119)							{
HXLINE( 121)								this->_brain->clearSelection();
HXLINE( 122)								{
HXLINE( 122)									int _g1 = 0;
HXDLIN( 122)									while((_g1 < items->length)){
HXLINE( 122)										 ::flixel::FlxObject item = items->__get(_g1).StaticCast<  ::flixel::FlxObject >();
HXDLIN( 122)										_g1 = (_g1 + 1);
HXLINE( 123)										selected->add(item).StaticCast<  ::flixel::FlxObject >();
            									}
            								}
            							}
            						}
