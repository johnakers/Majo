...
HXDLIN(  64)				while(true){
HXLINE(  64)					bool member;
HXDLIN(  64)					if ((_g__cursor < _g__length)) {
HXLINE(  64)						if (::hx::IsNotNull( _g__groupMembers->__get(_g__cursor).StaticCast<  ::flixel::FlxObject >() )) {
HXLINE(  64)							if (::hx::IsNotNull( _g__filter )) {
HXLINE(  64)								member = !(( (bool)(_g__filter(_g__groupMembers->__get(_g__cursor).StaticCast<  ::flixel::FlxObject >())) ));
            							}
            							else {
HXLINE(  64)								member = false;
            							}
            						}
            						else {
HXLINE(  64)							member = true;
            						}
            					}
            					else {
HXLINE(  64)						member = false;
...
HXDLIN(  64)				 ::flixel::FlxObject member1 = member;
HXLINE(  66)				bool _hx_tmp;
HXDLIN(  66)				bool _hx_tmp1;
HXDLIN(  66)				if (::hx::IsNotNull( member1 )) {
HXLINE(  66)					_hx_tmp1 = ::hx::IsNotNull( member1->scrollFactor );
            				}
            				else {
HXLINE(  66)					_hx_tmp1 = false;
            				}
HXDLIN(  66)				if (_hx_tmp1) {
HXLINE(  66)					_hx_tmp = member1->isOnScreen(null());
            				}
            				else {
HXLINE(  66)					_hx_tmp = false;
            				}
HXDLIN(  66)				if (_hx_tmp) {
HXLINE(  70)					 ::flixel::FlxSprite target = ( ( ::flixel::FlxSprite)(member1) );
...
HXDLIN(  98)			HX_STACK_DO_THROW(::haxe::Exception_obj::thrown((HX_("Unexpected state: ",c8,45,da,ee) + ::Std_obj::string(found))));
            		}
...
HXLINE( 152)					this->checkMarkers();
            				...
            				break;
            				case (int)2: {
HXLINE( 153)					 ::flixel::FlxSprite target = _g->_hx_getObject(0).StaticCast<  ::flixel::FlxSprite >();
...
HXDLIN( 154)						Float y = (target->y + target->origin->y);
HXDLIN( 154)						this1->set_x((this1->x - (target->x + target->origin->x)));
...
HXLINE( 156)							 ::flixel::math::FlxBasePoint point = ::flixel::math::FlxBasePoint_obj::pool->get().StaticCast<  ::flixel::math::FlxBasePoint >()->set(( (Float)(0) ),( (Float)(0) ));
...
HXDLIN( 156)						Float y2 = (target->y + target->origin->y);
HXDLIN( 156)						this3->set_x((this3->x - (target->x + target->origin->x)));
...
HXDLIN( 172)									target->set_angle(((_hx_tmp1 - (_hx_tmp2 * (( (Float)(180) ) / ::Math_obj::PI))) + startValue));
HXLINE( 174)									 ::flixel::_hx_system::debug::TooltipOverlay _hx_tmp3 = this->tooltip;
HXDLIN( 174)									::String _hx_tmp4 = ((HX_("deg: ",ec,e9,22,d7) + dec(target->angle,1)) + HX_("\n rad: ",25,17,5a,4f));
HXDLIN( 174)									_hx_tmp3->setText((_hx_tmp4 + dec((target->angle * (::Math_obj::PI / ( (Float)(180) ))),2)));
            								}
            							}
            							break;
            							case (int)1: {
HXLINE( 176)								Float startValue = type->_hx_getFloat(0);
HXDLIN( 176)								{
HXLINE( 177)									Float oldProjX = ::Math_obj::sqrt(((mouseStart->x * mouseStart->x) + (mouseStart->y * mouseStart->y)));
HXDLIN( 177)									Float target1 = target->angle;
HXDLIN( 177)									Float degrees = ::flixel::math::_FlxPoint::FlxPoint_Impl__obj::get_radians(mouseStart);
HXDLIN( 177)									Float oldProjX1 = (oldProjX * ::Math_obj::cos(((::Math_obj::PI / ( (Float)(180) )) * (target1 - (degrees * (( (Float)(180) ) / ::Math_obj::PI))))));
HXLINE( 178)									Float projX = ::Math_obj::sqrt(((mouse->x * mouse->x) + (mouse->y * mouse->y)));
HXDLIN( 178)									Float target2 = target->angle;
HXDLIN( 178)									Float degrees1 = ::flixel::math::_FlxPoint::FlxPoint_Impl__obj::get_radians(mouse);
HXDLIN( 178)									Float projX1 = (projX * ::Math_obj::cos(((::Math_obj::PI / ( (Float)(180) )) * (target2 - (degrees1 * (( (Float)(180) ) / ::Math_obj::PI))))));
HXLINE( 180)									target->scale->set_x(((projX1 / oldProjX1) * startValue));
HXLINE( 182)									 ::flixel::_hx_system::debug::TooltipOverlay _hx_tmp = this->tooltip;
HXDLIN( 182)									::String _hx_tmp1 = ((HX_("scale.x: ",3a,ed,5c,17) + dec(target->scale->x,null())) + HX_("\n height: ",23,11,61,14));
HXDLIN( 182)									_hx_tmp->setText((_hx_tmp1 + ::Std_obj::_hx_int((target->scale->x * ( (Float)(target->frameWidth) )))));
            								}
            							}
            							break;
            							case (int)2: {
HXLINE( 184)								Float startValue = type->_hx_getFloat(0);
HXDLIN( 184)								{
HXLINE( 185)									Float oldProjY = ::Math_obj::sqrt(((mouseStart->x * mouseStart->x) + (mouseStart->y * mouseStart->y)));
HXDLIN( 185)									Float target1 = target->angle;
HXDLIN( 185)									Float degrees = ::flixel::math::_FlxPoint::FlxPoint_Impl__obj::get_radians(mouseStart);
HXDLIN( 185)									Float oldProjY1 = (oldProjY * ::Math_obj::sin(((::Math_obj::PI / ( (Float)(180) )) * (target1 - (degrees * (( (Float)(180) ) / ::Math_obj::PI))))));
HXLINE( 186)									Float projY = ::Math_obj::sqrt(((mouse->x * mouse->x) + (mouse->y * mouse->y)));
HXDLIN( 186)									Float target2 = target->angle;
HXDLIN( 186)									Float degrees1 = ::flixel::math::_FlxPoint::FlxPoint_Impl__obj::get_radians(mouse);
HXDLIN( 186)									Float projY1 = (projY * ::Math_obj::sin(((::Math_obj::PI / ( (Float)(180) )) * (target2 - (degrees1 * (( (Float)(180) ) / ::Math_obj::PI))))));
HXLINE( 187)									target->scale->set_y(((projY1 / oldProjY1) * startValue));
HXLINE( 189)									 ::flixel::_hx_system::debug::TooltipOverlay _hx_tmp = this->tooltip;
HXDLIN( 189)									::String _hx_tmp1 = ((HX_("scale.y: ",7b,af,5d,17) + dec(target->scale->y,null())) + HX_("\n height: ",23,11,61,14));
HXDLIN( 189)									_hx_tmp->setText((_hx_tmp1 + ::Std_obj::_hx_int((target->scale->y * ( (Float)(target->frameHeight) )))));
            								}
            							}
            							break;
            							case (int)3: {
...
HXLINE( 194)									Float oldProjX = (oldLen * ::Math_obj::cos(((::Math_obj::PI / ( (Float)(180) )) * (target->angle - oldDeg1))));
HXLINE( 195)									Float oldProjY = (oldLen * ::Math_obj::sin(((::Math_obj::PI / ( (Float)(180) )) * (target->angle - oldDeg1))));
...
HXLINE( 198)									Float projX = (len * ::Math_obj::cos(((::Math_obj::PI / ( (Float)(180) )) * (target->angle - deg1))));
HXLINE( 199)									Float projY = (len * ::Math_obj::sin(((::Math_obj::PI / ( (Float)(180) )) * (target->angle - deg1))));
HXLINE( 201)									target->scale->set_x(((projX / oldProjX) * startValueX));
HXLINE( 202)									target->scale->set_y(((projY / oldProjY) * startValueY));
HXLINE( 203)									::String info = ((HX_("scale - { x: ",30,87,3a,18) + dec(target->scale->x,null())) + HX_(" | y: ",9b,51,9e,46));
HXDLIN( 203)									::String info1 = ((info + dec(target->scale->y,2)) + HX_(" }\n",0d,b5,18,00));
HXLINE( 204)									::String info2 = ((HX_("size   - { x: ",a7,b6,11,cd) + ::Std_obj::_hx_int((target->scale->x * ( (Float)(target->frameWidth) )))) + HX_(" | y: ",9b,51,9e,46));
HXLINE( 203)									::String info3 = (info1 + ((info2 + ::Std_obj::_hx_int((target->scale->y * ( (Float)(target->frameHeight) )))) + HX_(" }",5d,1c,00,00)));
...
HXLINE( 211)								marker->reposition(target);
            							}
            						}
HXLINE( 213)						if (this->_brain->pointerJustReleased) {
HXLINE( 215)							this->state = ::flixel::_hx_system::debug::interaction::tools::_Transform::State_obj::SELECTED(target);
...
HXDLIN( 232)				 ::flixel::FlxSprite target1 = _g->_hx_getObject(0).StaticCast<  ::flixel::FlxSprite >();
HXLINE( 226)				target = target1;
            			}
            			break;
            		}
...
HXLINE( 258)				 ::flixel::_hx_system::debug::interaction::tools::_Transform::Marker marker = _g3->__get(_g2).StaticCast<  ::flixel::_hx_system::debug::interaction::tools::_Transform::Marker >();
HXDLIN( 258)				_g2 = (_g2 + 1);
HXLINE( 260)				Float x = marker->x;
HXLINE( 261)				Float y = marker->y;
HXLINE( 262)				::flixel::_hx_system::debug::interaction::tools::_Transform::Marker_obj::draw(x,y,(marker->type == HX_("transformRotate",e7,c0,75,06)),gfx);
            			}
            		}
            	}
