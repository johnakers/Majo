...
HXDLIN(  48)				while(true){
HXLINE(  48)					bool member;
HXDLIN(  48)					if ((_g__cursor < _g__length)) {
HXLINE(  48)						if (::hx::IsNotNull( _g__groupMembers->__get(_g__cursor).StaticCast<  ::flixel::FlxObject >() )) {
HXLINE(  48)							if (::hx::IsNotNull( _g__filter )) {
HXLINE(  48)								member = !(( (bool)(_g__filter(_g__groupMembers->__get(_g__cursor).StaticCast<  ::flixel::FlxObject >())) ));
            							}
            							else {
HXLINE(  48)								member = false;
            							}
            						}
            						else {
HXLINE(  48)							member = true;
            						}
            					}
            					else {
HXLINE(  48)						member = false;
...
HXDLIN(  48)				 ::flixel::FlxObject member1 = member;
HXLINE(  50)				bool _hx_tmp;
HXDLIN(  50)				if (::hx::IsNotNull( member1 )) {
HXLINE(  50)					_hx_tmp = ::Std_obj::isOfType(member1,::hx::ClassOf< ::flixel::FlxSprite >());
            				}
            				else {
HXLINE(  50)					_hx_tmp = false;
            				}
HXDLIN(  50)				if (_hx_tmp) {
HXLINE(  52)					 ::flixel::FlxSprite sprite = ( ( ::flixel::FlxSprite)(member1) );
HXLINE(  53)					{
