...
HXDLIN(  55)				while(true){
HXLINE(  55)					bool member;
HXDLIN(  55)					if ((_g__cursor < _g__length)) {
HXLINE(  55)						if (::hx::IsNotNull( _g__groupMembers->__get(_g__cursor).StaticCast<  ::flixel::FlxObject >() )) {
HXLINE(  55)							if (::hx::IsNotNull( _g__filter )) {
HXLINE(  55)								member = !(( (bool)(_g__filter(_g__groupMembers->__get(_g__cursor).StaticCast<  ::flixel::FlxObject >())) ));
            							}
            							else {
HXLINE(  55)								member = false;
            							}
            						}
            						else {
HXLINE(  55)							member = true;
            						}
            					}
            					else {
HXLINE(  55)						member = false;
...
HXDLIN(  55)				 ::flixel::FlxObject member1 = member;
HXLINE(  57)				bool _hx_tmp;
HXDLIN(  57)				if (::hx::IsNotNull( member1 )) {
HXLINE(  57)					_hx_tmp = !(member1->ignoreDrawDebug);
            				}
            				else {
...
HXDLIN(  64)			::Array< ::Dynamic> _g1__groupMembers = this->_brain->selectedItems->members;
HXDLIN(  64)			 ::Dynamic _g1__filter = filter1;
HXDLIN(  64)			int _g1__cursor = 0;
HXDLIN(  64)			int _g1__length = _g1__groupMembers->length;
HXDLIN(  64)			while(true){
HXLINE(  64)				while(true){
HXLINE(  64)					bool _hx_tmp;
HXDLIN(  64)					if ((_g1__cursor < _g1__length)) {
HXLINE(  64)						if (::hx::IsNotNull( _g1__groupMembers->__get(_g1__cursor).StaticCast<  ::flixel::FlxObject >() )) {
HXLINE(  64)							if (::hx::IsNotNull( _g1__filter )) {
HXLINE(  64)								_hx_tmp = !(( (bool)(_g1__filter(_g1__groupMembers->__get(_g1__cursor).StaticCast<  ::flixel::FlxObject >())) ));
            							}
            							else {
...
HXDLIN(  64)					_g1__cursor = (_g1__cursor + 1);
            				}
            				_hx_goto_7:;
HXDLIN(  64)				if (!((_g1__cursor < _g1__length))) {
...
HXLINE(  64)						if (::hx::IsNotNull( _g1__groupMembers->__get(_g1__cursor).StaticCast<  ::flixel::FlxObject >() )) {
HXLINE(  64)							if (::hx::IsNotNull( _g1__filter )) {
HXLINE(  64)								member = !(( (bool)(_g1__filter(_g1__groupMembers->__get(_g1__cursor).StaticCast<  ::flixel::FlxObject >())) ));
            							}
            							else {
...
HXDLIN(  64)					_g1__cursor = (_g1__cursor + 1);
            				...
            				_hx_goto_8:;
HXDLIN(  64)				if ((_g1__cursor < _g1__length)) {
HXLINE(  64)					_g1__cursor = (_g1__cursor + 1);
HXDLIN(  64)					member = _g1__groupMembers->__get((_g1__cursor - 1)).StaticCast<  ::flixel::FlxObject >();
            				}
            				else {
HXLINE(  64)					member = null();
            				}
HXDLIN(  64)				 ::flixel::FlxObject member1 = member;
HXLINE(  66)				if (::hx::IsNotNull( member1 )) {
HXLINE(  69)					member1->ignoreDrawDebug = anyEnabled;
            				}
            			}
            			_hx_goto_6:;
            		}
