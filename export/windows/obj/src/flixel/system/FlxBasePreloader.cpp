...
HX_LOCAL_STACK_FRAME(_hx_pos_dc9b83cdd7f291e2_121_create,"flixel.system.FlxBasePreloader","create",0x550716ea,"flixel.system.FlxBasePreloader.create","flixel/system/FlxBasePreloader.hx",121,0x863b5dde)
HX_LOCAL_STACK_FRAME(_hx_pos_dc9b83cdd7f291e2_127_onInit,"flixel.system.FlxBasePreloader","onInit",0xc13cf3bd,"flixel.system.FlxBasePreloader.onInit","flixel/system/FlxBasePreloader.hx",127,0x863b5dde)
HX_LOCAL_STACK_FRAME(_hx_pos_dc9b83cdd7f291e2_151_onUpdate,"flixel.system.FlxBasePreloader","onUpdate",0x30e883f6,"flixel.system.FlxBasePreloader.onUpdate","flixel/system/FlxBasePreloader.hx",151,0x863b5dde)
HX_LOCAL_STACK_FRAME(_hx_pos_dc9b83cdd7f291e2_160_onEnterFrame,"flixel.system.FlxBasePreloader","onEnterFrame",0x1becfc62,"flixel.system.FlxBasePreloader.onEnterFrame","flixel/system/FlxBasePreloader.hx",160,0x863b5dde)
HX_LOCAL_STACK_FRAME(_hx_pos_dc9b83cdd7f291e2_182_destroy,"flixel.system.FlxBasePreloader","destroy",0x24486d4c,"flixel.system.FlxBasePreloader.destroy","flixel/system/FlxBasePreloader.hx",182,0x863b5dde)
HX_LOCAL_STACK_FRAME(_hx_pos_dc9b83cdd7f291e2_189_update,"flixel.system.FlxBasePreloader","update",0x5ffd35f7,"flixel.system.FlxBasePreloader.update","flixel/system/FlxBasePreloader.hx",189,0x863b5dde)
HX_LOCAL_STACK_FRAME(_hx_pos_dc9b83cdd7f291e2_196_onLoaded,"flixel.system.FlxBasePreloader","onLoaded",0x025245f2,"flixel.system.FlxBasePreloader.onLoaded","flixel/system/FlxBasePreloader.hx",196,0x863b5dde)
HX_LOCAL_STACK_FRAME(_hx_pos_dc9b83cdd7f291e2_212_createBitmap,"flixel.system.FlxBasePreloader","createBitmap",0x54baa679,"flixel.system.FlxBasePreloader.createBitmap","flixel/system/FlxBasePreloader.hx",212,0x863b5dde)
HX_LOCAL_STACK_FRAME(_hx_pos_dc9b83cdd7f291e2_236_loadBitmapData,"flixel.system.FlxBasePreloader","loadBitmapData",0x15a00d6d,"flixel.system.FlxBasePreloader.loadBitmapData","flixel/system/FlxBasePreloader.hx",236,0x863b5dde)
HX_LOCAL_STACK_FRAME(_hx_pos_dc9b83cdd7f291e2_250_checkSiteLock,"flixel.system.FlxBasePreloader","checkSiteLock",0x5092d9cc,"flixel.system.FlxBasePreloader.checkSiteLock","flixel/system/FlxBasePreloader.hx",250,0x863b5dde)
...
HXLINE( 104)		this->minDisplayTime = MinDisplayTime;
HXLINE( 105)		if (::hx::IsNotNull( AllowedURLs )) {
HXLINE( 106)			this->allowedURLs = AllowedURLs;
            		}
            		else {
HXLINE( 108)			this->allowedURLs = ::Array_obj< ::String >::__new(0);
            		}
HXLINE( 110)		this->_startTime = ::Date_obj::now()->getTime();
HXLINE( 114)		this->onLoaded();
            	}
...
void FlxBasePreloader_obj::create(){
            	HX_STACKFRAME(&_hx_pos_dc9b83cdd7f291e2_121_create)
            	}
...
void FlxBasePreloader_obj::onInit(){
            	HX_STACKFRAME(&_hx_pos_dc9b83cdd7f291e2_127_onInit)
HXLINE( 128)		this->super::onInit();
HXLINE( 130)		::openfl::Lib_obj::get_current()->stage->set_scaleMode(2);
HXLINE( 131)		::openfl::Lib_obj::get_current()->stage->align = 6;
HXLINE( 132)		this->create();
HXLINE( 133)		this->addEventListener(HX_("enterFrame",f5,03,50,02),this->onEnterFrame_dyn(),null(),null(),null());
HXLINE( 134)		this->checkSiteLock();
            	}


void FlxBasePreloader_obj::onUpdate(int bytesLoaded,int bytesTotal){
            	HX_STACKFRAME(&_hx_pos_dc9b83cdd7f291e2_151_onUpdate)
HXDLIN( 151)		this->super::onUpdate(bytesLoaded,bytesTotal);
            	}


void FlxBasePreloader_obj::onEnterFrame( ::openfl::events::Event E){
            	HX_STACKFRAME(&_hx_pos_dc9b83cdd7f291e2_160_onEnterFrame)
HXLINE( 161)		Float time = ::Date_obj::now()->getTime();
HXDLIN( 161)		Float time1 = (time - this->_startTime);
HXLINE( 162)		Float min = (this->minDisplayTime * ( (Float)(1000) ));
HXLINE( 163)		Float percent = this->_percent;
HXLINE( 164)		bool _hx_tmp;
HXDLIN( 164)		if ((min > 0)) {
HXLINE( 164)			_hx_tmp = (this->_percent > (time1 / min));
            		}
            		else {
HXLINE( 164)			_hx_tmp = false;
            		}
HXDLIN( 164)		if (_hx_tmp) {
HXLINE( 165)			percent = (time1 / min);
            		}
HXLINE( 166)		if (!(this->_destroyed)) {
HXLINE( 167)			this->update(percent);
            		}
HXLINE( 169)		bool _hx_tmp1;
HXDLIN( 169)		if (this->_loaded) {
HXLINE( 169)			if (!((min <= 0))) {
HXLINE( 169)				_hx_tmp1 = ((time1 / min) >= 1);
            			}
            			else {
...
HXLINE( 171)			this->removeEventListener(HX_("enterFrame",f5,03,50,02),this->onEnterFrame_dyn(),null());
HXLINE( 172)			this->super::onLoaded();
HXLINE( 173)			this->destroy();
HXLINE( 174)			this->_destroyed = true;
            		}
            	}
...
void FlxBasePreloader_obj::destroy(){
            	HX_STACKFRAME(&_hx_pos_dc9b83cdd7f291e2_182_destroy)
            	}
...
void FlxBasePreloader_obj::update(Float Percent){
            	HX_STACKFRAME(&_hx_pos_dc9b83cdd7f291e2_189_update)
            	}
...
void FlxBasePreloader_obj::onLoaded(){
            	HX_STACKFRAME(&_hx_pos_dc9b83cdd7f291e2_196_onLoaded)
HXLINE( 197)		this->_loaded = true;
HXLINE( 198)		this->_percent = ( (Float)(1) );
            	}


 ::openfl::display::Bitmap FlxBasePreloader_obj::createBitmap(::hx::Class bitmapDataClass, ::Dynamic onLoad){
            	HX_GC_STACKFRAME(&_hx_pos_dc9b83cdd7f291e2_212_createBitmap)
HXLINE( 218)		 ::openfl::display::Bitmap bmp =  ::openfl::display::Bitmap_obj::__alloc( HX_CTX ,( ( ::openfl::display::BitmapData)(::Type_obj::createInstance(bitmapDataClass,::cpp::VirtualArray_obj::__new(2)->init(0,0)->init(1,0))) ),null(),null());
HXLINE( 219)		onLoad(bmp);
HXLINE( 220)		return bmp;
            	}
...
HX_DEFINE_DYNAMIC_FUNC2(FlxBasePreloader_obj,createBitmap,return )
 ...
 ::openfl::display::BitmapData FlxBasePreloader_obj::loadBitmapData(::hx::Class bitmapDataClass, ::Dynamic onLoad){
            	HX_STACKFRAME(&_hx_pos_dc9b83cdd7f291e2_236_loadBitmapData)
HXLINE( 240)		 ::openfl::display::BitmapData bmpData = ( ( ::openfl::display::BitmapData)(::Type_obj::createInstance(bitmapDataClass,::cpp::VirtualArray_obj::__new(2)->init(0,0)->init(1,0))) );
HXLINE( 241)		onLoad(bmpData);
HXLINE( 242)		return bmpData;
            	}
...
void FlxBasePreloader_obj::checkSiteLock(){
            	HX_STACKFRAME(&_hx_pos_dc9b83cdd7f291e2_250_checkSiteLock)
            	}
