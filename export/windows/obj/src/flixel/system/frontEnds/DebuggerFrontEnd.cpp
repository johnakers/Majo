...
HXLINE( 133)			 ::flixel::_hx_system::debug::FlxDebugger _this = ::flixel::FlxG_obj::game->debugger;
...
HXDLIN( 133)			_this->_windows->push(window);
HXDLIN( 133)			_this->addChild(window);
HXDLIN( 133)			if (::hx::IsNotNull( _this->_screenBounds )) {
HXLINE( 133)				_this->updateBounds();
