...
HXLINE(  43)		this->postGameStart =  ::flixel::util::_FlxSignal::FlxSignal0_obj::__alloc( HX_CTX );
HXLINE(  37)		this->preGameStart =  ::flixel::util::_FlxSignal::FlxSignal0_obj::__alloc( HX_CTX );
HXLINE(  31)		this->postGameReset =  ::flixel::util::_FlxSignal::FlxSignal0_obj::__alloc( HX_CTX );
HXLINE(  30)		this->preGameReset =  ::flixel::util::_FlxSignal::FlxSignal0_obj::__alloc( HX_CTX );
HXLINE(  28)		this->gameResized =  ::flixel::util::_FlxSignal::FlxSignal2_obj::__alloc( HX_CTX );
HXLINE(  22)		this->preStateCreate =  ::flixel::util::_FlxSignal::FlxSignal1_obj::__alloc( HX_CTX );
