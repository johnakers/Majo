...
HX_LOCAL_STACK_FRAME(_hx_pos_ba09e0c9e62cea6b_92_clear,"flixel.system.frontEnds.LogFrontEnd","clear",0x4a0034fb,"flixel.system.frontEnds.LogFrontEnd.clear","flixel/system/frontEnds/LogFrontEnd.hx",92,0x686ab8c3)
...
HXDLIN(  22)		this->advanced(data,::flixel::_hx_system::debug::log::LogStyle_obj::NORMAL,false,pos);
            	}
...
HXDLIN(  27)		this->advanced(data,::flixel::_hx_system::debug::log::LogStyle_obj::WARNING,true,pos);
            	}
...
HXDLIN(  32)		this->advanced(data,::flixel::_hx_system::debug::log::LogStyle_obj::ERROR,true,pos);
            	}
...
HXDLIN(  37)		this->advanced(data,::flixel::_hx_system::debug::log::LogStyle_obj::NOTICE,false,pos);
            	}


HX_DEFINE_DYNAMIC_FUNC2(LogFrontEnd_obj,notice,(void))

void LogFrontEnd_obj::advanced( ::Dynamic data, ::flixel::_hx_system::debug::log::LogStyle style,::hx::Null< bool >  __o_fireOnce, ::Dynamic pos){
...
HXLINE(  59)			this->_standardTraceFunction(arrayData,::hx::SourceInfo(HX_("flixel/system/frontEnds/LogFrontEnd.hx",c3,b8,6a,68),59,HX_("flixel.system.frontEnds.LogFrontEnd",5c,bd,97,07),HX_("advanced",a2,69,7b,3b)));
            		}
            		else {
HXLINE(  61)			if (::flixel::FlxG_obj::game->debugger->log->add(arrayData,style,fireOnce)) {
HXLINE(  64)				if (::hx::IsNotNull( style->errorSound )) {
HXLINE(  66)					 ::openfl::media::Sound sound = ::flixel::_hx_system::FlxAssets_obj::getSoundAddExtension(style->errorSound,null());
...
HXLINE(  80)		style->onLog->dispatch(data,pos);
HXLINE(  82)		if (style->throwException) {
HXLINE(  83)			HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(style->toLogString(arrayData)));
            		}
            	}
...
void LogFrontEnd_obj::clear(){
            	HX_STACKFRAME(&_hx_pos_ba09e0c9e62cea6b_92_clear)
HXDLIN(  92)		::flixel::FlxG_obj::game->debugger->log->clear();
            	}
...
HXLINE( 126)		this->advanced(paramArray,::flixel::_hx_system::debug::log::LogStyle_obj::NORMAL,null(),::hx::SourceInfo(HX_("flixel/system/frontEnds/LogFrontEnd.hx",c3,b8,6a,68),126,HX_("flixel.system.frontEnds.LogFrontEnd",5c,bd,97,07),HX_("processTraceData",e0,2e,f4,70)));
            	}
