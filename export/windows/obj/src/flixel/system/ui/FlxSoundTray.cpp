...
HXLINE( 125)			Float _hx_tmp = this->get_y();
HXDLIN( 125)			if ((_hx_tmp > -(this->get_height()))) {
HXLINE( 127)				Float _hx_tmp = this->get_y();
HXDLIN( 127)				this->set_y((_hx_tmp - (((MS / ( (Float)(1000) )) * this->get_height()) * ((Float)0.5))));
HXLINE( 129)				Float _hx_tmp1 = this->get_y();
HXDLIN( 129)				if ((_hx_tmp1 <= -(this->get_height()))) {
...
HXLINE( 165)				Float _hx_tmp;
HXDLIN( 165)				if ((i < numBars)) {
HXLINE( 165)					_hx_tmp = ((Float)1.0);
            				}
            				else {
HXLINE( 165)					_hx_tmp = ((Float)0.5);
            				}
HXDLIN( 165)				this->_bars->__get(i).StaticCast<  ::openfl::display::Bitmap >()->set_alpha(_hx_tmp);
            			}
            		}
...
HXLINE( 209)			 ::openfl::text::TextField _hx_tmp = this->_label;
HXDLIN( 209)			_hx_tmp->set_width((this->_label->get_textWidth() + 10));
            		}
HXLINE( 211)		 ::openfl::display::Bitmap _hx_tmp1 = this->_bg;
HXDLIN( 211)		Float _hx_tmp2;
HXDLIN( 211)		Float _hx_tmp3 = (this->_label->get_textWidth() + 10);
HXDLIN( 211)		if ((_hx_tmp3 > this->_minWidth)) {
HXLINE( 211)			_hx_tmp2 = (this->_label->get_textWidth() + 10);
            		}
            		else {
HXLINE( 211)			_hx_tmp2 = ( (Float)(this->_minWidth) );
            		}
HXDLIN( 211)		_hx_tmp1->set_width(_hx_tmp2);
HXLINE( 213)		 ::openfl::text::TextField _hx_tmp4 = this->_label;
HXDLIN( 213)		_hx_tmp4->set_width(this->_bg->get_width());
