...
HX_DEFINE_STACK_FRAME(_hx_pos_1b8de2909b3ba780_14_new,"flixel.FlxState","new",0x7e613e23,"flixel.FlxState.new","flixel/FlxState.hx",14,0xdf96844c)
HX_LOCAL_STACK_FRAME(_hx_pos_1b8de2909b3ba780_104_create,"flixel.FlxState","create",0x1148b519,"flixel.FlxState.create","flixel/FlxState.hx",104,0xdf96844c)
HX_LOCAL_STACK_FRAME(_hx_pos_1b8de2909b3ba780_107_draw,"flixel.FlxState","draw",0x1022c8e1,"flixel.FlxState.draw","flixel/FlxState.hx",107,0xdf96844c)
HX_LOCAL_STACK_FRAME(_hx_pos_1b8de2909b3ba780_116_openSubState,"flixel.FlxState","openSubState",0x3d5ea838,"flixel.FlxState.openSubState","flixel/FlxState.hx",116,0xdf96844c)
HX_LOCAL_STACK_FRAME(_hx_pos_1b8de2909b3ba780_126_closeSubState,"flixel.FlxState","closeSubState",0x519577cc,"flixel.FlxState.closeSubState","flixel/FlxState.hx",126,0xdf96844c)
HX_LOCAL_STACK_FRAME(_hx_pos_1b8de2909b3ba780_133_resetSubState,"flixel.FlxState","resetSubState",0x772d18e3,"flixel.FlxState.resetSubState","flixel/FlxState.hx",133,0xdf96844c)
HX_LOCAL_STACK_FRAME(_hx_pos_1b8de2909b3ba780_174_destroy,"flixel.FlxState","destroy",0x2171383d,"flixel.FlxState.destroy","flixel/FlxState.hx",174,0xdf96844c)
HX_LOCAL_STACK_FRAME(_hx_pos_1b8de2909b3ba780_171_destroy,"flixel.FlxState","destroy",0x2171383d,"flixel.FlxState.destroy","flixel/FlxState.hx",171,0xdf96844c)
HX_LOCAL_STACK_FRAME(_hx_pos_1b8de2909b3ba780_198_startOutro,"flixel.FlxState","startOutro",0x6cd6bca6,"flixel.FlxState.startOutro","flixel/FlxState.hx",198,0xdf96844c)
HX_LOCAL_STACK_FRAME(_hx_pos_1b8de2909b3ba780_205_onFocusLost,"flixel.FlxState","onFocusLost",0x8c2b4d80,"flixel.FlxState.onFocusLost","flixel/FlxState.hx",205,0xdf96844c)
HX_LOCAL_STACK_FRAME(_hx_pos_1b8de2909b3ba780_211_onFocus,"flixel.FlxState","onFocus",0x97b2097c,"flixel.FlxState.onFocus","flixel/FlxState.hx",211,0xdf96844c)
HX_LOCAL_STACK_FRAME(_hx_pos_1b8de2909b3ba780_219_onResize,"flixel.FlxState","onResize",0x38e71fd0,"flixel.FlxState.onResize","flixel/FlxState.hx",219,0xdf96844c)
HX_LOCAL_STACK_FRAME(_hx_pos_1b8de2909b3ba780_223_tryUpdate,"flixel.FlxState","tryUpdate",0xc75023a7,"flixel.FlxState.tryUpdate","flixel/FlxState.hx",223,0xdf96844c)
HX_LOCAL_STACK_FRAME(_hx_pos_1b8de2909b3ba780_241_get_bgColor,"flixel.FlxState","get_bgColor",0xc8234a38,"flixel.FlxState.get_bgColor","flixel/FlxState.hx",241,0xdf96844c)
HX_LOCAL_STACK_FRAME(_hx_pos_1b8de2909b3ba780_247_set_bgColor,"flixel.FlxState","set_bgColor",0xd2905144,"flixel.FlxState.set_bgColor","flixel/FlxState.hx",247,0xdf96844c)
HX_LOCAL_STACK_FRAME(_hx_pos_1b8de2909b3ba780_252_get_subStateOpened,"flixel.FlxState","get_subStateOpened",0x2fcc7460,"flixel.FlxState.get_subStateOpened","flixel/FlxState.hx",252,0xdf96844c)
HX_LOCAL_STACK_FRAME(_hx_pos_1b8de2909b3ba780_261_get_subStateClosed,"flixel.FlxState","get_subStateClosed",0x1c89bb63,"flixel.FlxState.get_subStateClosed","flixel/FlxState.hx",261,0xdf96844c)
namespace flixel{

void FlxState_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_1b8de2909b3ba780_14_new)
HXLINE(  70)		this->_requestSubStateReset = false;
HXLINE(  41)		this->destroySubStates = true;
HXLINE(  35)		this->persistentDraw = true;
HXLINE(  23)		this->persistentUpdate = false;
HXLINE(  95)		super::__construct(0);
            	}
...
void FlxState_obj::create(){
            	HX_STACKFRAME(&_hx_pos_1b8de2909b3ba780_104_create)
            	}
...
void FlxState_obj::draw(){
            	HX_STACKFRAME(&_hx_pos_1b8de2909b3ba780_107_draw)
HXLINE( 108)		bool _hx_tmp;
HXDLIN( 108)		if (!(this->persistentDraw)) {
HXLINE( 108)			_hx_tmp = ::hx::IsNull( this->subState );
            		}
            		else {
HXLINE( 108)			_hx_tmp = true;
            		}
HXDLIN( 108)		if (_hx_tmp) {
HXLINE( 109)			this->super::draw();
            		}
HXLINE( 111)		if (::hx::IsNotNull( this->subState )) {
HXLINE( 112)			this->subState->draw();
            		}
            	}


void FlxState_obj::openSubState( ::flixel::FlxSubState SubState){
            	HX_STACKFRAME(&_hx_pos_1b8de2909b3ba780_116_openSubState)
HXLINE( 117)		this->_requestSubStateReset = true;
HXLINE( 118)		this->_requestedSubState = SubState;
            	}
...
void FlxState_obj::closeSubState(){
            	HX_STACKFRAME(&_hx_pos_1b8de2909b3ba780_126_closeSubState)
HXDLIN( 126)		this->_requestSubStateReset = true;
            	}
...
void FlxState_obj::resetSubState(){
            	HX_STACKFRAME(&_hx_pos_1b8de2909b3ba780_133_resetSubState)
HXLINE( 135)		if (::hx::IsNotNull( this->subState )) {
HXLINE( 137)			if (::hx::IsNotNull( this->subState->closeCallback )) {
HXLINE( 138)				this->subState->closeCallback();
            			}
HXLINE( 139)			if (::hx::IsNotNull( this->_subStateClosed )) {
HXLINE( 140)				this->_subStateClosed->dispatch(this->subState);
            			}
HXLINE( 142)			if (this->destroySubStates) {
HXLINE( 143)				this->subState->destroy();
            			}
            		}
HXLINE( 147)		this->subState = this->_requestedSubState;
HXLINE( 148)		this->_requestedSubState = null();
HXLINE( 150)		if (::hx::IsNotNull( this->subState )) {
HXLINE( 153)			if (!(this->persistentUpdate)) {
HXLINE( 154)				::flixel::FlxG_obj::inputs->onStateSwitch();
            			}
HXLINE( 156)			this->subState->_parentState = ::hx::ObjectPtr<OBJ_>(this);
HXLINE( 158)			if (!(this->subState->_created)) {
HXLINE( 160)				this->subState->_created = true;
HXLINE( 161)				this->subState->create();
            			}
HXLINE( 163)			if (::hx::IsNotNull( this->subState->openCallback )) {
HXLINE( 164)				this->subState->openCallback();
            			}
HXLINE( 165)			if (::hx::IsNotNull( this->_subStateOpened )) {
HXLINE( 166)				this->_subStateOpened->dispatch(this->subState);
            			}
            		}
            	}
...
void FlxState_obj::destroy(){
            		HX_BEGIN_LOCAL_FUNC_S0(::hx::LocalFunc,_hx_Closure_0) HXARGC(0)
            		 ::flixel::FlxState _hx_run(){
            			HX_STACKFRAME(&_hx_pos_1b8de2909b3ba780_174_destroy)
HXLINE( 174)			HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(HX_("Attempting to resetState while the current state is destroyed",9b,d7,fc,3b)));
HXDLIN( 174)			return null();
            		}
            		HX_END_LOCAL_FUNC0(return)

            	HX_STACKFRAME(&_hx_pos_1b8de2909b3ba780_171_destroy)
HXLINE( 172)		this->_constructor =  ::Dynamic(new _hx_Closure_0());
HXLINE( 176)		::flixel::util::FlxDestroyUtil_obj::destroy(this->_subStateOpened);
HXLINE( 177)		::flixel::util::FlxDestroyUtil_obj::destroy(this->_subStateClosed);
HXLINE( 179)		if (::hx::IsNotNull( this->subState )) {
HXLINE( 181)			this->subState->destroy();
HXLINE( 182)			this->subState = null();
            		}
HXLINE( 184)		this->super::destroy();
            	}


void FlxState_obj::startOutro( ::Dynamic onOutroComplete){
            	HX_STACKFRAME(&_hx_pos_1b8de2909b3ba780_198_startOutro)
HXDLIN( 198)		onOutroComplete();
            	}
...
void FlxState_obj::onFocusLost(){
            	HX_STACKFRAME(&_hx_pos_1b8de2909b3ba780_205_onFocusLost)
            	}
...
void FlxState_obj::onFocus(){
            	HX_STACKFRAME(&_hx_pos_1b8de2909b3ba780_211_onFocus)
            	}
...
void FlxState_obj::onResize(int Width,int Height){
            	HX_STACKFRAME(&_hx_pos_1b8de2909b3ba780_219_onResize)
            	}
...
void FlxState_obj::tryUpdate(Float elapsed){
            	HX_STACKFRAME(&_hx_pos_1b8de2909b3ba780_223_tryUpdate)
HXLINE( 224)		bool _hx_tmp;
HXDLIN( 224)		if (!(this->persistentUpdate)) {
HXLINE( 224)			_hx_tmp = ::hx::IsNull( this->subState );
            		}
            		else {
HXLINE( 224)			_hx_tmp = true;
            		}
HXDLIN( 224)		if (_hx_tmp) {
HXLINE( 225)			this->update(elapsed);
            		}
HXLINE( 227)		if (this->_requestSubStateReset) {
HXLINE( 229)			this->_requestSubStateReset = false;
HXLINE( 230)			this->resetSubState();
            		}
HXLINE( 232)		if (::hx::IsNotNull( this->subState )) {
HXLINE( 234)			this->subState->tryUpdate(elapsed);
            		}
            	}
...
int FlxState_obj::get_bgColor(){
            	HX_STACKFRAME(&_hx_pos_1b8de2909b3ba780_241_get_bgColor)
HXDLIN( 241)		return ::flixel::FlxG_obj::cameras->get_bgColor();
            	}
...
int FlxState_obj::set_bgColor(int Value){
            	HX_STACKFRAME(&_hx_pos_1b8de2909b3ba780_247_set_bgColor)
HXDLIN( 247)		return ::flixel::FlxG_obj::cameras->set_bgColor(Value);
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(FlxState_obj,set_bgColor,return )
 ...
 ::flixel::util::_FlxSignal::FlxSignal1 FlxState_obj::get_subStateOpened(){
            	HX_GC_STACKFRAME(&_hx_pos_1b8de2909b3ba780_252_get_subStateOpened)
HXLINE( 253)		if (::hx::IsNull( this->_subStateOpened )) {
HXLINE( 254)			this->_subStateOpened =  ::flixel::util::_FlxSignal::FlxSignal1_obj::__alloc( HX_CTX );
            		}
HXLINE( 256)		return this->_subStateOpened;
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(FlxState_obj,get_subStateOpened,return )
 ...
 ::flixel::util::_FlxSignal::FlxSignal1 FlxState_obj::get_subStateClosed(){
            	HX_GC_STACKFRAME(&_hx_pos_1b8de2909b3ba780_261_get_subStateClosed)
HXLINE( 262)		if (::hx::IsNull( this->_subStateClosed )) {
HXLINE( 263)			this->_subStateClosed =  ::flixel::util::_FlxSignal::FlxSignal1_obj::__alloc( HX_CTX );
            		}
HXLINE( 265)		return this->_subStateClosed;
            	}
