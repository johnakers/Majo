...
HXLINE( 666)					_hx_tmp = ( ( ::flixel::FlxBasic)(sprite) )->exists;
            				}
            				else {
...
HXLINE( 749)				_hx_tmp = (this->alpha != 0);
            			}
            			else {
...
HXDLIN(1073)		if (Offset->_weak) {
HXDLIN(1073)			Offset->put();
            		}
            	}
...
HXDLIN(1079)		if (Scale->_weak) {
HXDLIN(1079)			Scale->put();
            		}
            	}
...
HXDLIN(1082)		if (ScrollFactor->_weak) {
HXDLIN(1082)			ScrollFactor->put();
            		}
            	}
...
HXDLIN(1115)		HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(HX_("This function is not supported in FlxSpriteGroup",d4,53,54,91)));
...
HXDLIN(1138)		HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(HX_("This function is not supported in FlxSpriteGroup",d4,53,54,91)));
...
HXDLIN(1150)		HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(HX_("This function is not supported in FlxSpriteGroup",d4,53,54,91)));
