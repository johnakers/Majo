...
HX_DEFINE_STACK_FRAME(_hx_pos_a2c5aad29e94c731_944_new,"flixel.group.FlxTypedGroupIterator","new",0xa7153fe6,"flixel.group.FlxTypedGroupIterator.new","flixel/group/FlxGroup.hx",944,0x1e89d58e)
HX_LOCAL_STACK_FRAME(_hx_pos_a2c5aad29e94c731_953_next,"flixel.group.FlxTypedGroupIterator","next",0x8b82aaad,"flixel.group.FlxTypedGroupIterator.next","flixel/group/FlxGroup.hx",953,0x1e89d58e)
HX_LOCAL_STACK_FRAME(_hx_pos_a2c5aad29e94c731_957_hasNext,"flixel.group.FlxTypedGroupIterator","hasNext",0x559d4ff3,"flixel.group.FlxTypedGroupIterator.hasNext","flixel/group/FlxGroup.hx",957,0x1e89d58e)
namespace flixel{
namespace group{

void FlxTypedGroupIterator_obj::__construct(::cpp::VirtualArray groupMembers, ::Dynamic filter){
            	HX_STACKFRAME(&_hx_pos_a2c5aad29e94c731_944_new)
HXLINE( 945)		this->_groupMembers = groupMembers;
HXLINE( 946)		this->_filter = filter;
HXLINE( 947)		this->_cursor = 0;
HXLINE( 948)		this->_length = this->_groupMembers->get_length();
            	}
...
bool FlxTypedGroupIterator_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Dynamic FlxTypedGroupIterator_obj::next(){
            	HX_STACKFRAME(&_hx_pos_a2c5aad29e94c731_953_next)
HXDLIN( 953)		while(true){
HXDLIN( 953)			bool _hx_tmp;
HXDLIN( 953)			if ((this->_cursor < this->_length)) {
HXDLIN( 953)				if (::hx::IsNotNull( this->_groupMembers->__get(this->_cursor) )) {
HXDLIN( 953)					if (::hx::IsNotNull( this->_filter )) {
HXDLIN( 953)						_hx_tmp = !(( (bool)(this->_filter(this->_groupMembers->__get(this->_cursor))) ));
            					}
            					else {
HXDLIN( 953)						_hx_tmp = false;
            					}
            				}
            				else {
HXDLIN( 953)					_hx_tmp = true;
            				}
            			}
            			else {
HXDLIN( 953)				_hx_tmp = false;
...
HXDLIN( 953)				goto _hx_goto_1;
            			}
HXDLIN( 953)			this->_cursor++;
            		}
            		_hx_goto_1:;
HXDLIN( 953)		if ((this->_cursor < this->_length)) {
HXDLIN( 953)			return this->_groupMembers->__get(this->_cursor++);
            		}
            		else {
HXDLIN( 953)			return null();
            		}
HXDLIN( 953)		return null();
            	}
...
bool FlxTypedGroupIterator_obj::hasNext(){
            	HX_STACKFRAME(&_hx_pos_a2c5aad29e94c731_957_hasNext)
HXLINE( 958)		while(true){
HXLINE( 958)			bool _hx_tmp;
HXDLIN( 958)			if ((this->_cursor < this->_length)) {
HXLINE( 958)				if (::hx::IsNotNull( this->_groupMembers->__get(this->_cursor) )) {
HXLINE( 958)					if (::hx::IsNotNull( this->_filter )) {
HXLINE( 958)						_hx_tmp = !(( (bool)(this->_filter(this->_groupMembers->__get(this->_cursor))) ));
            					}
            					else {
...
HXLINE( 958)				goto _hx_goto_3;
            			}
HXLINE( 960)			this->_cursor++;
            		}
            		_hx_goto_3:;
HXLINE( 962)		return (this->_cursor < this->_length);
            	}
