...
HX_LOCAL_STACK_FRAME(_hx_pos_a86a375242b5e1cf_131_update,"flixel.FlxBasic","update",0x307e9d29,"flixel.FlxBasic.update","flixel/FlxBasic.hx",131,0xd8d6cfcf)
HX_LOCAL_STACK_FRAME(_hx_pos_a86a375242b5e1cf_142_draw,"flixel.FlxBasic","draw",0x12af3b24,"flixel.FlxBasic.draw","flixel/FlxBasic.hx",142,0xd8d6cfcf)
...
HX_LOCAL_STACK_FRAME(_hx_pos_a86a375242b5e1cf_204_getDefaultCamera,"flixel.FlxBasic","getDefaultCamera",0xce4f02f0,"flixel.FlxBasic.getDefaultCamera","flixel/FlxBasic.hx",204,0xd8d6cfcf)
HX_LOCAL_STACK_FRAME(_hx_pos_a86a375242b5e1cf_219_getCameras,"flixel.FlxBasic","getCameras",0x30b63758,"flixel.FlxBasic.getCameras","flixel/FlxBasic.hx",219,0xd8d6cfcf)
HX_LOCAL_STACK_FRAME(_hx_pos_a86a375242b5e1cf_234_getCamerasLegacy,"flixel.FlxBasic","getCamerasLegacy",0xd41137c1,"flixel.FlxBasic.getCamerasLegacy","flixel/FlxBasic.hx",234,0xd8d6cfcf)
HX_LOCAL_STACK_FRAME(_hx_pos_a86a375242b5e1cf_240_get_cameras,"flixel.FlxBasic","get_cameras",0xc9caff25,"flixel.FlxBasic.get_cameras","flixel/FlxBasic.hx",240,0xd8d6cfcf)
HX_LOCAL_STACK_FRAME(_hx_pos_a86a375242b5e1cf_246_set_cameras,"flixel.FlxBasic","set_cameras",0xd4380631,"flixel.FlxBasic.set_cameras","flixel/FlxBasic.hx",246,0xd8d6cfcf)
HX_LOCAL_STACK_FRAME(_hx_pos_a86a375242b5e1cf_254_get_container,"flixel.FlxBasic","get_container",0x970d55f8,"flixel.FlxBasic.get_container","flixel/FlxBasic.hx",254,0xd8d6cfcf)
HX_LOCAL_STACK_FRAME(_hx_pos_a86a375242b5e1cf_18_boot,"flixel.FlxBasic","boot",0x115a9352,"flixel.FlxBasic.boot","flixel/FlxBasic.hx",18,0xd8d6cfcf)
HX_LOCAL_STACK_FRAME(_hx_pos_a86a375242b5e1cf_21_boot,"flixel.FlxBasic","boot",0x115a9352,"flixel.FlxBasic.boot","flixel/FlxBasic.hx",21,0xd8d6cfcf)
...
void FlxBasic_obj::update(Float elapsed){
            	HX_STACKFRAME(&_hx_pos_a86a375242b5e1cf_131_update)
HXDLIN( 131)		::flixel::FlxBasic_obj::activeCount++;
            	}
...
void FlxBasic_obj::draw(){
            	HX_STACKFRAME(&_hx_pos_a86a375242b5e1cf_142_draw)
HXDLIN( 142)		::flixel::FlxBasic_obj::visibleCount++;
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(FlxBasic_obj,set_camera,return )
 ...
 ::flixel::FlxCamera FlxBasic_obj::getDefaultCamera(){
            	HX_STACKFRAME(&_hx_pos_a86a375242b5e1cf_204_getDefaultCamera)
HXLINE( 205)		::Array< ::Dynamic> cameras = this->getCameras();
HXLINE( 207)		bool _hx_tmp;
HXDLIN( 207)		if (::hx::IsNotNull( cameras )) {
HXLINE( 207)			_hx_tmp = (cameras->length == 0);
            		}
            		else {
HXLINE( 207)			_hx_tmp = true;
            		}
HXDLIN( 207)		if (_hx_tmp) {
HXLINE( 207)			return ::flixel::FlxG_obj::camera;
            		}
            		else {
HXLINE( 207)			return cameras->__get(0).StaticCast<  ::flixel::FlxCamera >();
            		}
HXDLIN( 207)		return null();
            	}


HX_DEFINE_DYNAMIC_FUNC0(FlxBasic_obj,getDefaultCamera,return )

::Array< ::Dynamic> FlxBasic_obj::getCameras(){
            	HX_STACKFRAME(&_hx_pos_a86a375242b5e1cf_219_getCameras)
HXDLIN( 219)		if (::hx::IsNotNull( this->_cameras )) {
HXLINE( 220)			return this->_cameras;
            		}
            		else {
HXLINE( 221)			bool _hx_tmp;
HXDLIN( 221)			if (::hx::IsNull( this->_cameras )) {
HXLINE( 221)				_hx_tmp = ::hx::IsNotNull( this->get_container() );
            			}
            			else {
HXLINE( 221)				_hx_tmp = false;
            			}
HXDLIN( 221)			if (_hx_tmp) {
HXLINE( 222)				return this->get_container()->getCameras();
            			}
            			else {
HXLINE( 224)				return ::flixel::FlxCamera_obj::_defaultCameras;
            			}
            		}
...
::Array< ::Dynamic> FlxBasic_obj::getCamerasLegacy(){
            	HX_STACKFRAME(&_hx_pos_a86a375242b5e1cf_234_getCamerasLegacy)
HXDLIN( 234)		if (::hx::IsNull( this->_cameras )) {
HXDLIN( 234)			return ::flixel::FlxCamera_obj::_defaultCameras;
            		}
            		else {
HXDLIN( 234)			return this->_cameras;
            		}
...
::Array< ::Dynamic> FlxBasic_obj::get_cameras(){
            	HX_STACKFRAME(&_hx_pos_a86a375242b5e1cf_240_get_cameras)
HXDLIN( 240)		return this->getCamerasLegacy();
            	}
...
::Array< ::Dynamic> FlxBasic_obj::set_cameras(::Array< ::Dynamic> Value){
            	HX_STACKFRAME(&_hx_pos_a86a375242b5e1cf_246_set_cameras)
HXDLIN( 246)		return (this->_cameras = Value);
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(FlxBasic_obj,set_cameras,return )
 ...
 ::flixel::group::FlxTypedContainer FlxBasic_obj::get_container(){
            	HX_STACKFRAME(&_hx_pos_a86a375242b5e1cf_254_get_container)
HXDLIN( 254)		return this->container;
            	}
...
::hx::Val FlxBasic_obj::__Field(const ::String &inName,::hx::PropertyAccess inCallProp)
{
	...
	case 13:
		...
		break;
	case 16:
		if (HX_FIELD_EQ(inName,"getDefaultCamera") ) { return ::hx::Val( getDefaultCamera_dyn() ); }
...
static ::String FlxBasic_obj_sMemberFields[] = {
	...
	HX_("getDefaultCamera",d0,c3,25,1c),
...
{
{
            	HX_STACKFRAME(&_hx_pos_a86a375242b5e1cf_18_boot)
HXDLIN(  18)		activeCount = 0;
            	}
{
            	HX_STACKFRAME(&_hx_pos_a86a375242b5e1cf_21_boot)
HXDLIN(  21)		visibleCount = 0;
            	}
{
