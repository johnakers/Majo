...
HX_LOCAL_STACK_FRAME(_hx_pos_62eec1d0c4ff3cdd_107_fromType,"flixel.util.typeLimit._NextState.InitialState_Impl_","fromType",0xb9788a3d,"flixel.util.typeLimit._NextState.InitialState_Impl_.fromType","flixel/util/typeLimit/NextState.hx",107,0x086ddfa8)
HX_LOCAL_STACK_FRAME(_hx_pos_62eec1d0c4ff3cdd_113_fromMaker,"flixel.util.typeLimit._NextState.InitialState_Impl_","fromMaker",0x785171e1,"flixel.util.typeLimit._NextState.InitialState_Impl_.fromMaker","flixel/util/typeLimit/NextState.hx",113,0x086ddfa8)
HX_LOCAL_STACK_FRAME(_hx_pos_62eec1d0c4ff3cdd_119_toNextState,"flixel.util.typeLimit._NextState.InitialState_Impl_","toNextState",0xe2b55bca,"flixel.util.typeLimit._NextState.InitialState_Impl_.toNextState","flixel/util/typeLimit/NextState.hx",119,0x086ddfa8)
HX_LOCAL_STACK_FRAME(_hx_pos_62eec1d0c4ff3cdd_123_toNextState,"flixel.util.typeLimit._NextState.InitialState_Impl_","toNextState",0xe2b55bca,"flixel.util.typeLimit._NextState.InitialState_Impl_.toNextState","flixel/util/typeLimit/NextState.hx",123,0x086ddfa8)
namespace flixel{
namespace util{
namespace typeLimit{
...
bool InitialState_Impl__obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Dynamic InitialState_Impl__obj::fromType(::hx::Class state){
            	HX_STACKFRAME(&_hx_pos_62eec1d0c4ff3cdd_107_fromType)
HXDLIN( 107)		return ( ( ::Dynamic)(state) );
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(InitialState_Impl__obj,fromType,return )
 ...
 ::Dynamic InitialState_Impl__obj::fromMaker( ::Dynamic func){
            	HX_STACKFRAME(&_hx_pos_62eec1d0c4ff3cdd_113_fromMaker)
HXDLIN( 113)		return func;
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(InitialState_Impl__obj,fromMaker,return )
 ...
 ::Dynamic InitialState_Impl__obj::toNextState( ::Dynamic this1){
            	HX_STACKFRAME(&_hx_pos_62eec1d0c4ff3cdd_119_toNextState)
HXDLIN( 119)		if (::Std_obj::isOfType(this1,::hx::ClassOf< ::hx::Class >())) {
            			HX_BEGIN_LOCAL_FUNC_S1(::hx::LocalFunc,_hx_Closure_0, ::Dynamic,this1) HXARGC(0)
            			 ::flixel::FlxState _hx_run(){
            				HX_STACKFRAME(&_hx_pos_62eec1d0c4ff3cdd_123_toNextState)
HXLINE( 123)				return ( ( ::flixel::FlxState)(::Type_obj::createInstance(this1,::cpp::VirtualArray_obj::__new(0))) );
            			}
            			HX_END_LOCAL_FUNC0(return)

HXLINE( 121)			return ::flixel::util::typeLimit::_NextState::NextState_Impl__obj::fromMaker( ::Dynamic(new _hx_Closure_0(this1)));
            		}
            		else {
