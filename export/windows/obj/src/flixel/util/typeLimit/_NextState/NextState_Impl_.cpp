...
HX_LOCAL_STACK_FRAME(_hx_pos_27baa0ad328f8c72_52_createInstance,"flixel.util.typeLimit._NextState.NextState_Impl_","createInstance",0xe163b529,"flixel.util.typeLimit._NextState.NextState_Impl_.createInstance","flixel/util/typeLimit/NextState.hx",52,0x086ddfa8)
HX_LOCAL_STACK_FRAME(_hx_pos_27baa0ad328f8c72_62_getConstructor,"flixel.util.typeLimit._NextState.NextState_Impl_","getConstructor",0x54ab967c,"flixel.util.typeLimit._NextState.NextState_Impl_.getConstructor","flixel/util/typeLimit/NextState.hx",62,0x086ddfa8)
HX_LOCAL_STACK_FRAME(_hx_pos_27baa0ad328f8c72_66_getConstructor,"flixel.util.typeLimit._NextState.NextState_Impl_","getConstructor",0x54ab967c,"flixel.util.typeLimit._NextState.NextState_Impl_.getConstructor","flixel/util/typeLimit/NextState.hx",66,0x086ddfa8)
namespace flixel{
namespace util{
namespace typeLimit{
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(NextState_Impl__obj,fromMaker,return )
 ...
 ::flixel::FlxState NextState_Impl__obj::createInstance( ::Dynamic this1){
            	HX_STACKFRAME(&_hx_pos_27baa0ad328f8c72_52_createInstance)
HXDLIN(  52)		if (::Std_obj::isOfType(this1,::hx::ClassOf< ::flixel::FlxState >())) {
HXLINE(  53)			return ( ( ::flixel::FlxState)(this1) );
            		}
            		else {
HXLINE(  54)			if (::Std_obj::isOfType(this1,::hx::ClassOf< ::hx::Class >())) {
HXLINE(  55)				return ( ( ::flixel::FlxState)(::Type_obj::createInstance(this1,::cpp::VirtualArray_obj::__new(0))) );
            			}
            			else {
HXLINE(  57)				return ( ( ::flixel::FlxState)(this1()) );
            			}
            		}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(NextState_Impl__obj,createInstance,return )
 ...
 ::Dynamic NextState_Impl__obj::getConstructor( ::Dynamic this1){
            	HX_STACKFRAME(&_hx_pos_27baa0ad328f8c72_62_getConstructor)
HXDLIN(  62)		if (::Std_obj::isOfType(this1,::hx::ClassOf< ::flixel::FlxState >())) {
            			HX_BEGIN_LOCAL_FUNC_S1(::hx::LocalFunc,_hx_Closure_0, ::Dynamic,this1) HXARGC(0)
            			 ::flixel::FlxState _hx_run(){
            				HX_STACKFRAME(&_hx_pos_27baa0ad328f8c72_66_getConstructor)
HXLINE(  66)				return ( ( ::flixel::FlxState)(::Type_obj::createInstance(::Type_obj::getClass(this1),::cpp::VirtualArray_obj::__new(0))) );
            			}
            			HX_END_LOCAL_FUNC0(return)

HXLINE(  64)			return  ::Dynamic(new _hx_Closure_0(this1));
            		}
            		else {
HXLINE(  70)			return this1;
            		}
