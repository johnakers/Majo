...
HX_LOCAL_STACK_FRAME(_hx_pos_80883519d7ae1644_34_fastSplice_flixel_system_debug_watch_WatchBase_TEntry,"flixel.util.FlxArrayUtil","fastSplice_flixel_system_debug_watch_WatchBase_TEntry",0x6084e522,"flixel.util.FlxArrayUtil.fastSplice_flixel_system_debug_watch_WatchBase_TEntry","flixel/util/FlxArrayUtil.hx",34,0xa0dc755b)
HX_LOCAL_STACK_FRAME(_hx_pos_80883519d7ae1644_34_fastSplice_flixel_system_debug_Window,"flixel.util.FlxArrayUtil","fastSplice_flixel_system_debug_Window",0x3304bcc5,"flixel.util.FlxArrayUtil.fastSplice_flixel_system_debug_Window","flixel/util/FlxArrayUtil.hx",34,0xa0dc755b)
...
::cpp::VirtualArray FlxArrayUtil_obj::fastSplice_flixel_system_debug_watch_WatchBase_TEntry(::cpp::VirtualArray array, ::Dynamic element){
            	HX_STACKFRAME(&_hx_pos_80883519d7ae1644_34_fastSplice_flixel_system_debug_watch_WatchBase_TEntry)
HXLINE(  35)		int index = array->indexOf(element,null());
HXLINE(  36)		if ((index != -1)) {
HXLINE(  37)			array->set(index,array->__get((array->get_length() - 1)));
HXDLIN(  37)			array->pop();
HXDLIN(  37)			return array;
            		}
HXLINE(  38)		return array;
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(FlxArrayUtil_obj,fastSplice_flixel_system_debug_watch_WatchBase_TEntry,return )
...
::Array< ::Dynamic> FlxArrayUtil_obj::fastSplice_flixel_system_debug_Window(::Array< ::Dynamic> array, ::flixel::_hx_system::debug::Window element){
            	HX_STACKFRAME(&_hx_pos_80883519d7ae1644_34_fastSplice_flixel_system_debug_Window)
HXLINE(  35)		int index = array->indexOf(element,null());
HXLINE(  36)		if ((index != -1)) {
HXLINE(  37)			array[index] = array->__get((array->length - 1)).StaticCast<  ::flixel::_hx_system::debug::Window >();
HXDLIN(  37)			array->pop().StaticCast<  ::flixel::_hx_system::debug::Window >();
HXDLIN(  37)			return array;
            		}
HXLINE(  38)		return array;
            	}
...
bool FlxArrayUtil_obj::__GetStatic(const ::String &inName, Dynamic &outValue, ::hx::PropertyAccess inCallProp)
{
	...
	case 37:
		...
		break;
	case 53:
		if (HX_FIELD_EQ(inName,"fastSplice_flixel_system_debug_watch_WatchBase_TEntry") ) { outValue = fastSplice_flixel_system_debug_watch_WatchBase_TEntry_dyn(); return true; }
	}
	return false;
}
...
static ::String FlxArrayUtil_obj_sStaticFields[] = {
	...
	HX_("fastSplice_flixel_system_debug_watch_WatchBase_TEntry",ed,44,54,55),
