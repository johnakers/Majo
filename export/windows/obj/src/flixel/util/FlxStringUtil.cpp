...
HX_LOCAL_STACK_FRAME(_hx_pos_85c2c6c527e56776_567_imageToCSV,"flixel.util.FlxStringUtil","imageToCSV",0xe3229173,"flixel.util.FlxStringUtil.imageToCSV","flixel/util/FlxStringUtil.hx",567,0x4e012e33)
HX_LOCAL_STACK_FRAME(_hx_pos_85c2c6c527e56776_577_getDebugString,"flixel.util.FlxStringUtil","getDebugString",0x47d891d1,"flixel.util.FlxStringUtil.getDebugString","flixel/util/FlxStringUtil.hx",577,0x4e012e33)
HX_LOCAL_STACK_FRAME(_hx_pos_85c2c6c527e56776_597_contains,"flixel.util.FlxStringUtil","contains",0x45000522,"flixel.util.FlxStringUtil.contains","flixel/util/FlxStringUtil.hx",597,0x4e012e33)
HX_LOCAL_STACK_FRAME(_hx_pos_85c2c6c527e56776_605_remove,"flixel.util.FlxStringUtil","remove",0xf6fd7087,"flixel.util.FlxStringUtil.remove","flixel/util/FlxStringUtil.hx",605,0x4e012e33)
HX_LOCAL_STACK_FRAME(_hx_pos_85c2c6c527e56776_613_insert,"flixel.util.FlxStringUtil","insert",0x9052177c,"flixel.util.FlxStringUtil.insert","flixel/util/FlxStringUtil.hx",613,0x4e012e33)
HX_LOCAL_STACK_FRAME(_hx_pos_85c2c6c527e56776_619_sortAlphabetically,"flixel.util.FlxStringUtil","sortAlphabetically",0xf5002ac6,"flixel.util.FlxStringUtil.sortAlphabetically","flixel/util/FlxStringUtil.hx",619,0x4e012e33)
HX_LOCAL_STACK_FRAME(_hx_pos_85c2c6c527e56776_617_sortAlphabetically,"flixel.util.FlxStringUtil","sortAlphabetically",0xf5002ac6,"flixel.util.FlxStringUtil.sortAlphabetically","flixel/util/FlxStringUtil.hx",617,0x4e012e33)
HX_LOCAL_STACK_FRAME(_hx_pos_85c2c6c527e56776_637_isNullOrEmpty,"flixel.util.FlxStringUtil","isNullOrEmpty",0x99779cf6,"flixel.util.FlxStringUtil.isNullOrEmpty","flixel/util/FlxStringUtil.hx",637,0x4e012e33)
HX_LOCAL_STACK_FRAME(_hx_pos_85c2c6c527e56776_645_toUnderscoreCase,"flixel.util.FlxStringUtil","toUnderscoreCase",0x66d9bbe8,"flixel.util.FlxStringUtil.toUnderscoreCase","flixel/util/FlxStringUtil.hx",645,0x4e012e33)
HX_LOCAL_STACK_FRAME(_hx_pos_85c2c6c527e56776_655_toTitleCase,"flixel.util.FlxStringUtil","toTitleCase",0xe7be584a,"flixel.util.FlxStringUtil.toTitleCase","flixel/util/FlxStringUtil.hx",655,0x4e012e33)
...
HX_LOCAL_STACK_FRAME(_hx_pos_85c2c6c527e56776_678_capitalizeFirstLetters,"flixel.util.FlxStringUtil","capitalizeFirstLetters",0xbd6fa48c,"flixel.util.FlxStringUtil.capitalizeFirstLetters","flixel/util/FlxStringUtil.hx",678,0x4e012e33)
HX_LOCAL_STACK_FRAME(_hx_pos_85c2c6c527e56776_687_isRomanNumeral,"flixel.util.FlxStringUtil","isRomanNumeral",0x9ed560ae,"flixel.util.FlxStringUtil.isRomanNumeral","flixel/util/FlxStringUtil.hx",687,0x4e012e33)
HX_LOCAL_STACK_FRAME(_hx_pos_85c2c6c527e56776_674_boot,"flixel.util.FlxStringUtil","boot",0xfe07b1b5,"flixel.util.FlxStringUtil.boot","flixel/util/FlxStringUtil.hx",674,0x4e012e33)
HX_LOCAL_STACK_FRAME(_hx_pos_85c2c6c527e56776_684_boot,"flixel.util.FlxStringUtil","boot",0xfe07b1b5,"flixel.util.FlxStringUtil.boot","flixel/util/FlxStringUtil.hx",684,0x4e012e33)
namespace flixel{
namespace util{
...
::String FlxStringUtil_obj::imageToCSV( ::Dynamic graphic,::hx::Null< bool >  __o_invert,::hx::Null< int >  __o_scale,::Array< int > colorMap){
            		bool invert = __o_invert.Default(false);
            		int scale = __o_scale.Default(1);
            	HX_STACKFRAME(&_hx_pos_85c2c6c527e56776_567_imageToCSV)
HXDLIN( 567)		return ::flixel::util::FlxStringUtil_obj::bitmapToCSV(::flixel::_hx_system::_FlxAssets::FlxGraphicSource_Impl__obj::resolveBitmapData(graphic),invert,scale,colorMap);
            	}
...
::String FlxStringUtil_obj::getDebugString(::Array< ::Dynamic> LabelValuePairs){
            	HX_STACKFRAME(&_hx_pos_85c2c6c527e56776_577_getDebugString)
HXLINE( 578)		::String output = HX_("(",28,00,00,00);
HXLINE( 579)		{
HXLINE( 579)			int _g = 0;
HXDLIN( 579)			while((_g < LabelValuePairs->length)){
HXLINE( 579)				 ::flixel::util::LabelValuePair pair = LabelValuePairs->__get(_g).StaticCast<  ::flixel::util::LabelValuePair >();
HXDLIN( 579)				_g = (_g + 1);
HXLINE( 581)				output = (output + (pair->label + HX_(": ",a6,32,00,00)));
HXLINE( 582)				 ::Dynamic value = pair->value;
HXLINE( 583)				if (::Std_obj::isOfType(value,::hx::ClassOf< ::Float >())) {
HXLINE( 585)					value = ::flixel::math::FlxMath_obj::roundDecimal(( (Float)(value) ),::flixel::FlxG_obj::debugger->precision);
            				}
HXLINE( 587)				output = (output + (::Std_obj::string(value) + HX_(" | ",44,b4,18,00)));
HXLINE( 588)				::flixel::util::LabelValuePair_obj::_pool->put(pair);
            			}
            		}
HXLINE( 591)		output = ::StringTools_obj::trim(output.substr(0,(output.length - 2)));
HXLINE( 592)		return (output + HX_(")",29,00,00,00));
            	}
...
bool FlxStringUtil_obj::contains(::String s,::String str){
            	HX_STACKFRAME(&_hx_pos_85c2c6c527e56776_597_contains)
HXDLIN( 597)		return (s.indexOf(str,null()) != -1);
            	}
...
::String FlxStringUtil_obj::remove(::String s,::String sub){
            	HX_STACKFRAME(&_hx_pos_85c2c6c527e56776_605_remove)
HXDLIN( 605)		return ::StringTools_obj::replace(s,sub,HX_("",00,00,00,00));
            	}
...
::String FlxStringUtil_obj::insert(::String s,int pos,::String insertion){
            	HX_STACKFRAME(&_hx_pos_85c2c6c527e56776_613_insert)
HXDLIN( 613)		::String _hx_tmp = (s.substring(0,pos) + insertion);
HXDLIN( 613)		return (_hx_tmp + s.substr(pos,null()));
            	}
...
::Array< ::String > FlxStringUtil_obj::sortAlphabetically(::Array< ::String > list){
            		...
            		int _hx_run(::String a,::String b){
            			HX_STACKFRAME(&_hx_pos_85c2c6c527e56776_619_sortAlphabetically)
HXLINE( 620)			a = a.toLowerCase();
HXLINE( 621)			b = b.toLowerCase();
HXLINE( 622)			if ((a < b)) {
HXLINE( 623)				return -1;
            			}
HXLINE( 624)			if ((a > b)) {
...
HXLINE( 626)			return 0;
            	...
            	HX_STACKFRAME(&_hx_pos_85c2c6c527e56776_617_sortAlphabetically)
HXLINE( 618)		list->sort( ::Dynamic(new _hx_Closure_0()));
HXLINE( 628)		return list;
            	}
...
bool FlxStringUtil_obj::isNullOrEmpty(::String s){
            	HX_STACKFRAME(&_hx_pos_85c2c6c527e56776_637_isNullOrEmpty)
HXDLIN( 637)		if (::hx::IsNotNull( s )) {
HXDLIN( 637)			return (s.length == 0);
            		}
            		else {
...
::String FlxStringUtil_obj::toUnderscoreCase(::String str){
            	HX_GC_STACKFRAME(&_hx_pos_85c2c6c527e56776_645_toUnderscoreCase)
HXLINE( 646)		 ::EReg regex =  ::EReg_obj::__alloc( HX_CTX ,HX_("[^a-z0-9]+",5f,51,30,53),HX_("g",67,00,00,00));
HXLINE( 647)		return regex->replace(str.toLowerCase(),HX_("_",5f,00,00,00));
            	}
...
::String FlxStringUtil_obj::toTitleCase(::String str){
            	HX_STACKFRAME(&_hx_pos_85c2c6c527e56776_655_toTitleCase)
HXLINE( 656)		::Array< ::String > exempt = ::Array_obj< ::String >::fromData( _hx_array_data_03bd21cb_47,16);
HXLINE( 657)		::Array< ::String > words = str.toLowerCase().split(HX_(" ",20,00,00,00));
HXLINE( 659)		{
HXLINE( 659)			int _g = 0;
HXDLIN( 659)			int _g1 = words->length;
HXDLIN( 659)			while((_g < _g1)){
HXLINE( 659)				_g = (_g + 1);
HXDLIN( 659)				int i = (_g - 1);
HXLINE( 661)				if (::flixel::util::FlxStringUtil_obj::isRomanNumeral(words->__get(i))) {
HXLINE( 662)					words[i] = words->__get(i).toUpperCase();
            				}
            				else {
HXLINE( 663)					bool _hx_tmp;
HXDLIN( 663)					if ((i != 0)) {
HXLINE( 663)						_hx_tmp = (exempt->indexOf(words->__get(i),null()) == -1);
            					}
            					else {
HXLINE( 663)						_hx_tmp = true;
            					}
HXDLIN( 663)					if (_hx_tmp) {
HXLINE( 664)						::String _hx_tmp = words->__get(i).charAt(0).toUpperCase();
HXDLIN( 664)						words[i] = (_hx_tmp + words->__get(i).substr(1,null()));
            					}
            				}
            			}
            		}
HXLINE( 667)		return words->join(HX_(" ",20,00,00,00));
            	}
...
::String FlxStringUtil_obj::capitalizeFirstLetters(::String str){
            		...
            		::String _hx_run( ::EReg r){
            			HX_STACKFRAME(&_hx_pos_85c2c6c527e56776_678_capitalizeFirstLetters)
HXDLIN( 678)			return r->matched(0).toUpperCase();
            		}
            		HX_END_LOCAL_FUNC1(return)

            	HX_STACKFRAME(&_hx_pos_85c2c6c527e56776_678_capitalizeFirstLetters)
HXDLIN( 678)		return ::flixel::util::FlxStringUtil_obj::whitespace->map(str, ::Dynamic(new _hx_Closure_0()));
            	}
...
bool FlxStringUtil_obj::isRomanNumeral(::String str){
            	HX_STACKFRAME(&_hx_pos_85c2c6c527e56776_687_isRomanNumeral)
HXDLIN( 687)		return ::flixel::util::FlxStringUtil_obj::roman->match(str);
            	}
...
{
{
            	HX_GC_STACKFRAME(&_hx_pos_85c2c6c527e56776_674_boot)
HXDLIN( 674)		whitespace =  ::EReg_obj::__alloc( HX_CTX ,HX_("(?<=\r|\\s|^)([a-z])",3e,5b,35,15),HX_("g",67,00,00,00));
            	}
{
            	HX_GC_STACKFRAME(&_hx_pos_85c2c6c527e56776_684_boot)
HXDLIN( 684)		roman =  ::EReg_obj::__alloc( HX_CTX ,HX_("^(?=[MDCLXVI])M*(C[MD]|D?C*)(X[CL]|L?X*)(I[XV]|V?I*)$",19,35,5b,b5),HX_("i",69,00,00,00));
            	}
}
