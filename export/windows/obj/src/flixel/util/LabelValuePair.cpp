...
HX_DEFINE_STACK_FRAME(_hx_pos_53443e31a49e57d3_722_new,"flixel.util.LabelValuePair","new",0x8e753503,"flixel.util.LabelValuePair.new","flixel/util/FlxStringUtil.hx",722,0x4e012e33)
HX_LOCAL_STACK_FRAME(_hx_pos_53443e31a49e57d3_704_create,"flixel.util.LabelValuePair","create",0x3da24a39,"flixel.util.LabelValuePair.create","flixel/util/FlxStringUtil.hx",704,0x4e012e33)
HX_LOCAL_STACK_FRAME(_hx_pos_53443e31a49e57d3_712_put,"flixel.util.LabelValuePair","put",0x8e76c772,"flixel.util.LabelValuePair.put","flixel/util/FlxStringUtil.hx",712,0x4e012e33)
HX_LOCAL_STACK_FRAME(_hx_pos_53443e31a49e57d3_716_destroy,"flixel.util.LabelValuePair","destroy",0xc37a1f1d,"flixel.util.LabelValuePair.destroy","flixel/util/FlxStringUtil.hx",716,0x4e012e33)
HX_LOCAL_STACK_FRAME(_hx_pos_53443e31a49e57d3_697_weak,"flixel.util.LabelValuePair","weak",0x1e0c0675,"flixel.util.LabelValuePair.weak","flixel/util/FlxStringUtil.hx",697,0x4e012e33)
HX_LOCAL_STACK_FRAME(_hx_pos_53443e31a49e57d3_693_boot,"flixel.util.LabelValuePair","boot",0x10322e2f,"flixel.util.LabelValuePair.boot","flixel/util/FlxStringUtil.hx",693,0x4e012e33)
namespace flixel{
namespace util{

void LabelValuePair_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_53443e31a49e57d3_722_new)
            	}
...
void *LabelValuePair_obj::_hx_getInterface(int inHash) {
 ...
 ::flixel::util::LabelValuePair LabelValuePair_obj::create(::String label, ::Dynamic value){
            	HX_STACKFRAME(&_hx_pos_53443e31a49e57d3_704_create)
HXLINE( 705)		this->label = label;
HXLINE( 706)		this->value = value;
...
void LabelValuePair_obj::put(){
            	HX_STACKFRAME(&_hx_pos_53443e31a49e57d3_712_put)
HXDLIN( 712)		::flixel::util::LabelValuePair_obj::_pool->put(::hx::ObjectPtr<OBJ_>(this));
            	}
...
void LabelValuePair_obj::destroy(){
            	HX_STACKFRAME(&_hx_pos_53443e31a49e57d3_716_destroy)
HXLINE( 717)		this->label = null();
HXLINE( 718)		this->value = null();
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(LabelValuePair_obj,destroy,(void))
 ...
 ::flixel::util::LabelValuePair LabelValuePair_obj::weak(::String label, ::Dynamic value){
            	HX_STACKFRAME(&_hx_pos_53443e31a49e57d3_697_weak)
HXDLIN( 697)		 ::flixel::util::LabelValuePair _this = ::flixel::util::LabelValuePair_obj::_pool->get().StaticCast<  ::flixel::util::LabelValuePair >();
HXDLIN( 697)		_this->label = label;
HXDLIN( 697)		_this->value = value;
HXDLIN( 697)		return _this;
            	}
...
{
{
            		HX_BEGIN_LOCAL_FUNC_S0(::hx::LocalFunc,_hx_Closure_0) HXARGC(0)
            		 ::flixel::util::LabelValuePair _hx_run(){
            			HX_GC_STACKFRAME(&_hx_pos_53443e31a49e57d3_693_boot)
HXDLIN( 693)			return  ::flixel::util::LabelValuePair_obj::__alloc( HX_CTX );
            		}
            		HX_END_LOCAL_FUNC0(return)

            	HX_GC_STACKFRAME(&_hx_pos_53443e31a49e57d3_693_boot)
HXDLIN( 693)		_pool =  ::flixel::util::FlxPool_obj::__alloc( HX_CTX , ::Dynamic(new _hx_Closure_0()));
            	}
}
