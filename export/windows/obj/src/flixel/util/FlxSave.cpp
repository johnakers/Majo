...
HXDLIN( 192)						 ::openfl::net::SharedObject sharedObject = _g2;
...
HXLINE( 201)							this->_sharedObject = sharedObject;
HXLINE( 202)							this->data = parsedData;
HXLINE( 204)							sharedObject->data = parsedData;
...
HXDLIN( 208)							 ::openfl::net::SharedObject sharedObject = _g2;
HXLINE( 209)							this->_sharedObject = sharedObject;
...
HXLINE( 211)						return false;
            			...
            			if (_hx_e.IsClass<  ::Dynamic >() ){
            				HX_STACK_BEGIN_CATCH
            				 ::Dynamic _g = _hx_e;
HXLINE( 214)				 ::haxe::Exception e = ::haxe::Exception_obj::caught(_g);
HXLINE( 216)				{
...
HXLINE( 273)					 ::Dynamic _hx_tmp = this->data;
HXDLIN( 273)					::Reflect_obj::setField(_hx_tmp,field,::Reflect_obj::field(sourceData,field));
            				}
            			}
            		}
...
HXDLIN( 359)								_this->advanced(data,::flixel::_hx_system::debug::log::LogStyle_obj::ERROR,true,::hx::SourceInfo(HX_("flixel/util/FlxSave.hx",a9,d0,3c,c4),359,HX_("flixel.util.FlxSave",95,71,4e,bc),HX_("checkStatus",1a,ba,0d,e8)));
            				...
            				break;
            				case (int)3: {
HXLINE( 366)					 ::flixel::util::LoadFailureType _g1 = _g->_hx_getObject(0).StaticCast<  ::flixel::util::LoadFailureType >();
HXDLIN( 366)					switch((int)(_g1->_hx_getIndex())){
            						case (int)0: {
HXLINE( 362)							::String name = _g1->_hx_getString(0);
HXDLIN( 362)							::String reason = _g1->_hx_getString(1);
HXLINE( 363)							{
...
HXDLIN( 363)								::flixel::FlxG_obj::log->advanced(((((HX_("Invalid name:\"",dc,fb,f0,ea) + name) + HX_("\", ",16,f3,19,00)) + _hx_tmp) + HX_(".",2e,00,00,00)),::flixel::_hx_system::debug::log::LogStyle_obj::ERROR,true,::hx::SourceInfo(HX_("flixel/util/FlxSave.hx",a9,d0,3c,c4),363,HX_("flixel.util.FlxSave",95,71,4e,bc),HX_("checkStatus",1a,ba,0d,e8)));
            							}
            						}
            						break;
            						case (int)1: {
HXLINE( 364)							::String path = _g1->_hx_getString(0);
HXDLIN( 364)							::String reason = _g1->_hx_getString(1);
HXLINE( 365)							{
HXLINE( 365)								::String _hx_tmp;
HXDLIN( 365)								if (::hx::IsNull( reason )) {
HXLINE( 365)									_hx_tmp = HX_("",00,00,00,00);
            								}
            								else {
HXLINE( 365)									_hx_tmp = reason;
            								}
HXDLIN( 365)								::flixel::FlxG_obj::log->advanced(((((HX_("Invalid path:\"",b6,79,4a,bc) + path) + HX_("\", ",16,f3,19,00)) + _hx_tmp) + HX_(".",2e,00,00,00)),::flixel::_hx_system::debug::log::LogStyle_obj::ERROR,true,::hx::SourceInfo(HX_("flixel/util/FlxSave.hx",a9,d0,3c,c4),365,HX_("flixel.util.FlxSave",95,71,4e,bc),HX_("checkStatus",1a,ba,0d,e8)));
            							}
            						}
            						break;
            						case (int)2: {
HXLINE( 360)							 ::haxe::Exception e = _g1->_hx_getObject(0).StaticCast<  ::haxe::Exception >();
HXLINE( 361)							{
HXLINE( 361)								 ::flixel::_hx_system::frontEnds::LogFrontEnd _this = ::flixel::FlxG_obj::log;
HXDLIN( 361)								 ::Dynamic data = (HX_("IO ERROR: ",14,4a,e8,7d) + e->get_message());
HXDLIN( 361)								_this->advanced(data,::flixel::_hx_system::debug::log::LogStyle_obj::ERROR,true,::hx::SourceInfo(HX_("flixel/util/FlxSave.hx",a9,d0,3c,c4),361,HX_("flixel.util.FlxSave",95,71,4e,bc),HX_("checkStatus",1a,ba,0d,e8)));
            							}
            						}
            						break;
            						case (int)3: {
HXLINE( 366)							::String rawData = _g1->_hx_getString(0);
HXDLIN( 366)							 ::haxe::Exception e = _g1->_hx_getObject(1).StaticCast<  ::haxe::Exception >();
HXLINE( 367)							{
HXLINE( 367)								 ::flixel::_hx_system::frontEnds::LogFrontEnd _this = ::flixel::FlxG_obj::log;
HXDLIN( 367)								 ::Dynamic data = ((((HX_("Error parsing \"",ba,8d,7f,0a) + rawData) + HX_("\", ",16,f3,19,00)) + e->get_message()) + HX_(".",2e,00,00,00));
HXDLIN( 367)								_this->advanced(data,::flixel::_hx_system::debug::log::LogStyle_obj::ERROR,true,::hx::SourceInfo(HX_("flixel/util/FlxSave.hx",a9,d0,3c,c4),367,HX_("flixel.util.FlxSave",95,71,4e,bc),HX_("checkStatus",1a,ba,0d,e8)));
            							}
            						}
            						break;
            					}
...
HXLINE( 369)					HX_STACK_DO_THROW(::haxe::Exception_obj::thrown((HX_("Unexpected status: ",67,8a,e1,1a) + ::Std_obj::string(found))));
            				}
            			}
            		}
