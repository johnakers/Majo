...
HXLINE( 218)				 ::flixel::math::FlxRect _this = ::flixel::FlxG_obj::worldBounds;
HXDLIN( 218)				_this->x = camera->x;
HXDLIN( 218)				_this->y = camera->y;
HXDLIN( 218)				_this->width = ( (Float)(camera->width) );
HXDLIN( 218)				_this->height = ( (Float)(camera->height) );
            			}
            		}
...
HXLINE( 268)			{
HXLINE( 268)				if (start->_weak) {
HXLINE( 268)					start->put();
            				}
HXDLIN( 268)				if (end->_weak) {
HXLINE( 268)					end->put();
            				}
...
HXLINE( 274)			{
HXLINE( 274)				if (start->_weak) {
HXLINE( 274)					start->put();
            				}
HXDLIN( 274)				if (end->_weak) {
HXLINE( 274)					end->put();
            				}
...
HXDLIN( 279)		if (start->_weak) {
HXLINE( 279)			start->put();
            		}
