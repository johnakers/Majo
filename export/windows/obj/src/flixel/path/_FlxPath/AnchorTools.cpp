...
HXLINE(  63)					Float y = ::hx::TCast<  ::flixel::FlxSprite >::cast(object)->origin->y;
HXDLIN(  63)					result->set_x((result->x + ::hx::TCast<  ::flixel::FlxSprite >::cast(object)->origin->x));
HXDLIN(  63)					result->set_y((result->y + y));
...
HXLINE(  74)				{
HXLINE(  74)					Float y = offset->y;
HXDLIN(  74)					result->set_x((result->x + offset->x));
HXDLIN(  74)					result->set_y((result->y + y));
            				}
