...
HX_DEFINE_STACK_FRAME(_hx_pos_d2197318fd890c91_571_new,"flixel.path.FlxTypedPathfinderData","new",0xf7913c76,"flixel.path.FlxTypedPathfinderData.new","flixel/path/FlxPathfinder.hx",571,0x74454158)
...
void FlxTypedPathfinderData_obj::__construct( ::Dynamic map,int startIndex,int endIndex){
            	HX_STACKFRAME(&_hx_pos_d2197318fd890c91_571_new)
...
HXLINE( 623)			int mapIndex = this->endIndex;
HXDLIN( 623)			if ((mapIndex >= 0)) {
HXLINE( 623)				return (mapIndex < ( ( ::flixel::tile::FlxBaseTilemap)(this->map) )->_data->length);
            			}
            			else {
...
HXDLIN( 667)		 ::Dynamic _this = this->map;
HXDLIN( 667)		int _hx_tmp;
HXDLIN( 667)		bool _hx_tmp1;
HXDLIN( 667)		if ((tile >= 0)) {
HXDLIN( 667)			_hx_tmp1 = (tile < ( ( ::flixel::tile::FlxBaseTilemap)(_this) )->_data->length);
            		}
            		else {
HXDLIN( 667)			_hx_tmp1 = false;
            		}
HXDLIN( 667)		if (_hx_tmp1) {
HXDLIN( 667)			_hx_tmp = ( ( ::flixel::tile::FlxBaseTilemap)(_this) )->_data->__get(tile);
            		}
            		else {
HXDLIN( 667)			_hx_tmp = -1;
            		}
