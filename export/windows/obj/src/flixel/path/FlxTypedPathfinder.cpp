...
HXLINE( 221)				_hx_tmp1 = ( ( ::flixel::tile::FlxBaseTilemap)(data1) )->ray(p1,p2,null());
            			}
            			else {
HXLINE( 221)				_hx_tmp1 = false;
            			}
HXDLIN( 221)			if (_hx_tmp1) {
HXLINE( 224)				 ::Dynamic data1 = ( ( ::flixel::path::FlxTypedPathfinderData)(data) )->map;
HXDLIN( 224)				p1->set_x((p1->x + -(width)));
HXDLIN( 224)				p1->set_y(p1->y);
HXDLIN( 224)				p2->set_x((p2->x + -(width)));
HXDLIN( 224)				p2->set_y(p2->y);
HXLINE( 221)				_hx_tmp = ( ( ::flixel::tile::FlxBaseTilemap)(data1) )->ray(p1,p2,null());
            			}
            			else {
...
HXDLIN( 331)				while((_g1 < neighbors->length)){
HXLINE( 331)					int neighbor = neighbors->__get(_g1);
HXDLIN( 331)					_g1 = (_g1 + 1);
HXLINE( 333)					if (this->isTileSolved(data,neighbor)) {
HXLINE( 334)						( ( ::flixel::path::FlxTypedPathfinderData)(data) )->excluded->push(neighbor);
            					}
            				}
            			}
...
HXLINE( 339)				_hx_tmp = ( ( ::flixel::path::FlxTypedPathfinderData)(data) )->foundEnd;
            			}
            			else {
...
HXDLIN( 358)		HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(HX_("FlxTilemapPathPolicy.getNeighbors should not be called, It must be overriden in derived classes",33,f6,83,a6)));
...
HXDLIN( 372)		HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(HX_("FlxTilemapPathPolicy.getDistance should not be called, It must be overriden in derived classes",bd,c0,de,31)));
HXDLIN( 372)		return 0;
            	}
...
HXLINE( 409)			int tile = ( ( ::flixel::path::FlxTypedPathfinderData)(data) )->endIndex;
HXDLIN( 409)			 ::Dynamic _this = ( ( ::flixel::path::FlxTypedPathfinderData)(data) )->map;
HXDLIN( 409)			int _hx_tmp;
HXDLIN( 409)			bool _hx_tmp1;
HXDLIN( 409)			if ((tile >= 0)) {
HXLINE( 409)				_hx_tmp1 = (tile < ( ( ::flixel::tile::FlxBaseTilemap)(_this) )->_data->length);
            			}
            			else {
HXLINE( 409)				_hx_tmp1 = false;
            			}
HXDLIN( 409)			if (_hx_tmp1) {
HXLINE( 409)				_hx_tmp = ( ( ::flixel::tile::FlxBaseTilemap)(_this) )->_data->__get(tile);
            			}
            			else {
HXLINE( 409)				_hx_tmp = -1;
            			}
HXDLIN( 409)			return (Dynamic( ( ( ::flixel::tile::FlxBaseTilemap)(_this) )->_tileObjects->__get(_hx_tmp)).StaticCast<  ::flixel::FlxObject >()->allowCollisions == 0);
            		}
            		else {
