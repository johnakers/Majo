...
HXDLIN( 173)			switch((int)(this->loopType)){
            				case (int)0: {
HXLINE( 173)					_hx_tmp = -1;
            				}
            				break;
            				case (int)16: {
HXLINE( 173)					_hx_tmp = 0;
            				}
            				break;
            				case (int)4096: {
HXLINE( 178)					this->direction = false;
HXLINE( 173)					_hx_tmp = (this->currentIndex - 1);
            				}
            				break;
            			}
HXDLIN( 173)			this->nextIndex = _hx_tmp;
HXLINE( 181)			this->onEndReached->dispatch(::hx::ObjectPtr<OBJ_>(this));
HXLINE( 182)			return;
            		}
HXLINE( 186)		bool _hx_tmp1;
HXDLIN( 186)		if ((this->currentIndex == 0)) {
HXLINE( 186)			_hx_tmp1 = (this->direction == false);
            		}
            		else {
...
HXDLIN( 188)			switch((int)(this->loopType)){
            				case (int)0: {
HXLINE( 188)					_hx_tmp = -1;
            				}
            				break;
            				case (int)16: {
HXLINE( 188)					_hx_tmp = (this->nodes->length - 1);
            				}
            				break;
            				case (int)4096: {
HXLINE( 193)					this->direction = true;
HXLINE( 188)					_hx_tmp = (this->currentIndex + 1);
            				}
            				break;
            			}
HXDLIN( 188)			this->nextIndex = _hx_tmp;
HXLINE( 196)			this->onEndReached->dispatch(::hx::ObjectPtr<OBJ_>(this));
HXLINE( 197)			return;
            		}
HXLINE( 200)		int _hx_tmp2;
HXDLIN( 200)		if (this->direction) {
HXLINE( 200)			_hx_tmp2 = 1;
            		}
            		else {
HXLINE( 200)			_hx_tmp2 = -1;
            		}
HXDLIN( 200)		this->nextIndex = (this->currentIndex + _hx_tmp2);
            	}
...
HXDLIN( 240)		HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(HX_("isTargetAtNext is not implemented",fe,99,53,eb)));
...
HXLINE( 335)				 ::flixel::math::FlxBasePoint _g1_value = _g_array->__get(_g_current).StaticCast<  ::flixel::math::FlxBasePoint >();
HXDLIN( 335)				_g_current = (_g_current + 1);
HXDLIN( 335)				int _g1_key = (_g_current - 1);
HXDLIN( 335)				int i = _g1_key;
HXDLIN( 335)				 ::flixel::math::FlxBasePoint node = _g1_value;
HXLINE( 336)				{
...
HXLINE( 381)			 ::flixel::math::FlxBasePoint point = ::flixel::math::FlxBasePoint_obj::pool->get().StaticCast<  ::flixel::math::FlxBasePoint >()->set(( (Float)(0) ),( (Float)(0) ));
HXDLIN( 381)			point->_inPool = false;
HXDLIN( 381)			p = point;
            		}
HXDLIN( 381)		Float y = point->y;
HXDLIN( 381)		p->set_x(point->x);
HXDLIN( 381)		p->set_y(y);
HXDLIN( 381)		result = p;
