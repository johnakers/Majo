...
HXLINE( 517)			int _hx_tmp1 = this->get_selectionEndIndex();
HXDLIN( 517)			_hx_tmp = (_hx_tmp1 > this->get_selectionBeginIndex());
            		}
            		else {
HXLINE( 517)			_hx_tmp = false;
            		}
HXDLIN( 517)		if (_hx_tmp) {
HXLINE( 518)			 ::openfl::text::TextField _hx_tmp = this->textField;
HXDLIN( 518)			 ::openfl::text::TextFormat _hx_tmp1 = this->_selectionFormat;
HXDLIN( 518)			int _hx_tmp2 = this->get_selectionBeginIndex();
HXDLIN( 518)			_hx_tmp->setTextFormat(_hx_tmp1,_hx_tmp2,this->get_selectionEndIndex());
            		}
...
HXLINE( 575)			int _hx_tmp = this->text.length;
HXDLIN( 575)			_hx_tmp1 = (_hx_tmp == this->textField->get_maxChars());
            		}
            		else {
...
HXDLIN( 628)			 ::flixel::math::FlxRect _this = ::flixel::math::FlxRect_obj::_pool->get().StaticCast<  ::flixel::math::FlxRect >();
HXDLIN( 628)			_this->x = X;
HXDLIN( 628)			_this->y = Y;
HXDLIN( 628)			_this->width = Width1;
HXDLIN( 628)			_this->height = Height1;
HXDLIN( 628)			 ::flixel::math::FlxRect rect = _this;
HXDLIN( 628)			rect->_inPool = false;
HXDLIN( 628)			bounds = rect;
            		}
            		else {
HXLINE( 629)			Float Width = this->get_width();
HXDLIN( 629)			Float Height = this->get_height();
HXDLIN( 629)			 ::flixel::math::FlxRect _this = ::flixel::math::FlxRect_obj::_pool->get().StaticCast<  ::flixel::math::FlxRect >();
HXDLIN( 629)			_this->x = ( (Float)(0) );
HXDLIN( 629)			_this->y = ( (Float)(0) );
HXDLIN( 629)			_this->width = Width;
HXDLIN( 629)			_this->height = Height;
HXDLIN( 629)			 ::flixel::math::FlxRect rect = _this;
HXDLIN( 629)			rect->_inPool = false;
HXLINE( 628)			bounds = rect;
            		}
...
HXLINE( 673)					pattern =  ::EReg_obj::__alloc( HX_CTX ,((HX_("[^",a3,4f,00,00) + chars) + HX_("]*",2d,51,00,00)),HX_("g",67,00,00,00));
            				...
            				break;
            				default:{
HXLINE( 688)					HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(((HX_("Unknown filterMode (",79,06,14,ea) + ::Std_obj::string(this->filterMode)) + HX_(")",29,00,00,00))));
            				}
            			}
...
HXLINE( 739)					{
HXLINE( 739)						int _g = 0;
HXDLIN( 739)						int _g1 = lineLength;
HXDLIN( 739)						while((_g < _g1)){
HXLINE( 739)							_g = (_g + 1);
HXDLIN( 739)							int _hx_char = (_g - 1);
...
HXLINE( 959)				this->restartCaretTimer();
            			...
            			break;
            			case (int)3: {
HXLINE( 961)				int lineIndex = this->getLineIndexOfChar(this->_caretIndex);
HXLINE( 962)				if ((lineIndex < (this->textField->get_numLines() - 1))) {
HXLINE( 964)					this->_caretIndex = this->getCharIndexOnDifferentLine(this->_caretIndex,(lineIndex + 1));
            				}
...
HXLINE( 999)				this->restartCaretTimer();
            			...
            			break;
            			case (int)7: {
HXLINE(1001)				int lineIndex = this->getLineIndexOfChar(this->_caretIndex);
HXLINE(1002)				if ((lineIndex < (this->textField->get_numLines() - 1))) {
HXLINE(1004)					this->_caretIndex = (this->textField->getLineOffset((lineIndex + 1)) - 1);
            				}
            				else {
...
HXLINE(1021)							_hx_tmp = ::flixel::text::FlxInputText_obj::DELIMITERS->contains(this->text.charAt(this->_caretIndex));
            						}
            						else {
...
HXLINE(1025)							_hx_tmp = !(::flixel::text::FlxInputText_obj::DELIMITERS->contains(this->text.charAt((this->_caretIndex - 1))));
            						}
            						else {
...
HXLINE(1038)						_hx_tmp = !(::flixel::text::FlxInputText_obj::DELIMITERS->contains(this->text.charAt(this->_caretIndex)));
            					}
            					else {
...
HXLINE(1042)						_hx_tmp = ::flixel::text::FlxInputText_obj::DELIMITERS->contains(this->text.charAt(this->_caretIndex));
            					}
            					else {
HXLINE(1042)						_hx_tmp = false;
            					}
...
HXLINE(1079)			 ::flixel::FlxSprite _hx_tmp = this->_backgroundSprite;
HXDLIN(1079)			int _hx_tmp1 = ::Std_obj::_hx_int(this->get_fieldWidth());
HXDLIN(1079)			int _hx_tmp2 = ::Std_obj::_hx_int(this->get_fieldHeight());
HXDLIN(1079)			_hx_tmp->makeGraphic(_hx_tmp1,_hx_tmp2,this->backgroundColor,null(),null());
...
HXLINE(1127)					_hx_tmp = (this->_caretIndex > 0);
            				}
            				else {
...
HXLINE(1146)					_hx_tmp = (this->_caretIndex < this->text.length);
            				}
            				else {
...
HXLINE(1162)					_hx_tmp = !(this->textField->get_displayAsPassword());
            				}
            				else {
...
HXLINE(1167)					_hx_tmp1 = (this->_caretIndex != this->_selectionIndex);
            				}
            				else {
HXLINE(1167)					_hx_tmp1 = false;
            				}
HXDLIN(1167)				if (_hx_tmp1) {
HXLINE(1167)					_hx_tmp = !(this->textField->get_displayAsPassword());
            				}
            				else {
...
HXLINE(1174)					_hx_tmp = ::hx::IsNotNull( ::lime::_hx_system::Clipboard_obj::get_text() );
            				}
            				else {
...
HXLINE(1219)			 ::flixel::FlxSprite _hx_tmp = this->_caret;
HXDLIN(1219)			Float _hx_tmp1 = this->x;
HXDLIN(1219)			Float _hx_tmp2 = (_hx_tmp1 + this->getCaretOffsetX());
HXDLIN(1219)			_hx_tmp->setPosition(_hx_tmp2,(this->y + 2));
            		}
            		else {
...
HXLINE(1226)				 ::flixel::FlxSprite _hx_tmp = this->_caret;
HXDLIN(1226)				Float _hx_tmp1 = this->x;
HXDLIN(1226)				Float _hx_tmp2 = (_hx_tmp1 + boundaries->get_right());
HXDLIN(1226)				Float _hx_tmp3 = (_hx_tmp2 - ( (Float)(this->textField->get_scrollH()) ));
HXDLIN(1226)				Float _hx_tmp4 = (this->y + boundaries->y);
HXDLIN(1226)				_hx_tmp->setPosition(_hx_tmp3,(_hx_tmp4 - this->getScrollVOffset()));
            			}
            			else {
HXLINE(1230)				boundaries = this->getCharBoundaries(this->_caretIndex);
HXLINE(1231)				if (::hx::IsNotNull( boundaries )) {
HXLINE(1233)					 ::flixel::FlxSprite _hx_tmp = this->_caret;
HXDLIN(1233)					Float _hx_tmp1 = (this->x + boundaries->x);
HXDLIN(1233)					Float _hx_tmp2 = (_hx_tmp1 - ( (Float)(this->textField->get_scrollH()) ));
HXDLIN(1233)					Float _hx_tmp3 = (this->y + boundaries->y);
HXDLIN(1233)					_hx_tmp->setPosition(_hx_tmp2,(_hx_tmp3 - this->getScrollVOffset()));
            				}
            				else {
HXLINE(1237)					 ::flixel::FlxSprite _hx_tmp = this->_caret;
HXDLIN(1237)					Float _hx_tmp1 = this->x;
HXDLIN(1237)					Float _hx_tmp2 = (_hx_tmp1 + this->getCaretOffsetX());
HXDLIN(1237)					Float _hx_tmp3 = (this->y + 2);
HXDLIN(1237)					Float _hx_tmp4 = (_hx_tmp3 + this->getLineY(this->getLineIndexOfChar(this->_caretIndex)));
HXDLIN(1237)					_hx_tmp->setPosition(_hx_tmp2,(_hx_tmp4 - this->getScrollVOffset()));
            				}
            			}
            		}
...
HXLINE(1345)				 ::Dynamic _hx_tmp = this->onScrollChange->dispatch;
HXDLIN(1345)				int _hx_tmp1 = this->textField->get_scrollH();
HXDLIN(1345)				_hx_tmp(_hx_tmp1,this->textField->get_scrollV());
            			}
            		}
            	}
...
HXLINE(1368)					 ::flixel::FlxSprite box = _g1->__get(_g).StaticCast<  ::flixel::FlxSprite >();
HXDLIN(1368)					_g = (_g + 1);
HXLINE(1370)					if (::hx::IsNotNull( box )) {
HXLINE(1371)						box->set_visible(false);
            					}
            				}
            			}
HXLINE(1374)			return;
...
HXLINE(1383)		{
HXLINE(1383)			int _g = beginV;
HXDLIN(1383)			int _g1 = this->textField->get_bottomScrollV();
HXDLIN(1383)			while((_g < _g1)){
HXLINE(1383)				_g = (_g + 1);
HXDLIN(1383)				int line = (_g - 1);
HXLINE(1385)				int i = (line - beginV);
HXLINE(1386)				 ::flixel::FlxSprite box = this->_selectionBoxes->__get(i).StaticCast<  ::flixel::FlxSprite >();
HXLINE(1387)				bool _hx_tmp;
HXDLIN(1387)				if ((line >= beginLine)) {
HXLINE(1387)					_hx_tmp = (line <= endLine);
            				}
            				else {
...
HXLINE(1397)						_hx_tmp = (endIndex > startIndex);
            					}
            					else {
...
HXLINE(1405)					bool _hx_tmp1;
HXDLIN(1405)					bool _hx_tmp2;
HXDLIN(1405)					if (::hx::IsNotNull( startBoundaries )) {
HXLINE(1405)						_hx_tmp2 = ::hx::IsNotNull( endBoundaries );
            					}
            					else {
HXLINE(1405)						_hx_tmp2 = false;
            					}
HXDLIN(1405)					if (_hx_tmp2) {
HXLINE(1405)						_hx_tmp1 = (::Math_obj::abs((startBoundaries->y - endBoundaries->y)) <= ((Float)0.0000001));
            					}
            					else {
HXLINE(1405)						_hx_tmp1 = false;
            					}
HXDLIN(1405)					if (_hx_tmp1) {
HXLINE(1407)						if (::hx::IsNull( box )) {
HXLINE(1409)							box = (this->_selectionBoxes[i] =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,null(),null(),null()));
HXLINE(1410)							box->set_color(this->selectionColor);
            						}
...
HXLINE(1418)						box->setPosition((this->x + boxRect->x),(this->y + boxRect->y));
HXLINE(1419)						int _hx_tmp = ::Std_obj::_hx_int(boxRect->width);
HXDLIN(1419)						box->makeGraphic(_hx_tmp,::Std_obj::_hx_int(boxRect->height),null(),null(),null());
HXLINE(1420)						this->clipSprite(box,null());
HXLINE(1421)						box->set_visible(true);
...
HXLINE(1425)						if (::hx::IsNotNull( box )) {
HXLINE(1427)							box->set_visible(false);
            						}
            					}
            				}
            				else {
HXLINE(1430)					if (::hx::IsNotNull( box )) {
HXLINE(1432)						box->set_visible(false);
            					}
            				}
            			}
            		}
...
HXLINE(1488)				_hx_tmp = this->selectable;
            			}
            			else {
...
HXLINE(1493)				_hx_tmp1 = this->mouseWheelEnabled;
            			}
            			else {
...
HXDLIN(1496)				int _hx_tmp;
HXDLIN(1496)				if ((a1 > b)) {
HXLINE(1496)					_hx_tmp = b;
            				}
            				else {
HXLINE(1496)					_hx_tmp = a1;
            				}
HXDLIN(1496)				this->set_scrollV(_hx_tmp);
HXLINE(1497)				if ((this->textField->get_scrollV() != cacheScrollV)) {
HXLINE(1499)					 ::Dynamic _hx_tmp = this->onScrollChange->dispatch;
HXDLIN(1499)					int _hx_tmp1 = this->textField->get_scrollH();
HXDLIN(1499)					_hx_tmp(_hx_tmp1,this->textField->get_scrollV());
            				}
            			}
            		}
            		else {
...
HXLINE(1503)				_hx_tmp = !(this->_justGainedFocus);
            			}
            			else {
...
HXDLIN(1618)			Float relativePos1 = relativePos->x;
HXDLIN(1618)			this->set_scrollH((_hx_tmp + ::Std_obj::_hx_int(::Math_obj::max(::Math_obj::min(((relativePos1 - this->get_width()) * ((Float).1)),( (Float)(10) )),( (Float)(1) )))));
            		}
            		else {
HXLINE(1620)			if ((relativePos->x < 1)) {
HXLINE(1622)				int _hx_tmp = this->textField->get_scrollH();
HXDLIN(1622)				this->set_scrollH((_hx_tmp - ::Std_obj::_hx_int(::Math_obj::max(::Math_obj::min((relativePos->x * ((Float)-.1)),( (Float)(10) )),( (Float)(1) )))));
            			}
            		}
HXLINE(1625)		 ::flixel::text::FlxInputText _hx_tmp = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN(1625)		_hx_tmp->_scrollVCounter = (_hx_tmp->_scrollVCounter + elapsed);
HXLINE(1627)		if ((this->_scrollVCounter > ((Float)0.1))) {
HXLINE(1629)			Float relativePos1 = relativePos->y;
HXDLIN(1629)			if ((relativePos1 > (this->get_height() - ( (Float)(2) )))) {
HXLINE(1631)				int _hx_tmp = this->textField->get_scrollV();
HXDLIN(1631)				Float relativePos1 = relativePos->y;
HXDLIN(1631)				Float _hx_tmp1 = (_hx_tmp + ::Math_obj::max(::Math_obj::min(((relativePos1 - this->get_height()) * ((Float).03)),( (Float)(5) )),( (Float)(1) )));
HXDLIN(1631)				this->set_scrollV(::Std_obj::_hx_int(::Math_obj::min(_hx_tmp1,( (Float)(this->textField->get_maxScrollV()) ))));
            			}
            			else {
HXLINE(1633)				if ((relativePos->y < 2)) {
HXLINE(1635)					int _hx_tmp = this->textField->get_scrollV();
HXDLIN(1635)					this->set_scrollV((_hx_tmp - ::Std_obj::_hx_int(::Math_obj::max(::Math_obj::min((relativePos->y * ((Float)-.03)),( (Float)(5) )),( (Float)(1) )))));
            				}
            			}
...
HXLINE(1640)			_hx_tmp1 = (this->textField->get_scrollV() != cacheScrollV);
            		}
            		else {
HXLINE(1640)			_hx_tmp1 = true;
            		}
HXDLIN(1640)		if (_hx_tmp1) {
HXLINE(1642)			 ::Dynamic _hx_tmp = this->onScrollChange->dispatch;
HXDLIN(1642)			int _hx_tmp1 = this->textField->get_scrollH();
HXDLIN(1642)			_hx_tmp(_hx_tmp1,this->textField->get_scrollV());
            		}
            	}
