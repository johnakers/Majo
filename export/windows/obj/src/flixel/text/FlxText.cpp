...
HXLINE( 332)					_hx_tmp = ::hx::IsNull( rule->format );
            				}
            				else {
...
HXLINE( 370)		{
HXLINE( 370)			int _g1 = 0;
HXDLIN( 370)			while((_g1 < rules->length)){
HXLINE( 370)				 ::flixel::text::FlxTextFormatMarkerPair rule = rules->__get(_g1).StaticCast<  ::flixel::text::FlxTextFormatMarkerPair >();
HXDLIN( 370)				_g1 = (_g1 + 1);
HXLINE( 371)				input = ::StringTools_obj::replace(input,rule->marker,HX_("",00,00,00,00));
            			}
            		}
HXLINE( 374)		{
HXLINE( 374)			int _g2 = 0;
HXDLIN( 374)			int _g3 = rangeStarts->length;
HXDLIN( 374)			while((_g2 < _g3)){
HXLINE( 374)				_g2 = (_g2 + 1);
HXDLIN( 374)				int i = (_g2 - 1);
HXLINE( 377)				int delIndex = rangeStarts->__get(i);
HXLINE( 378)				int markerLength = ::_UnicodeString::UnicodeString_Impl__obj::get_length(rulesToApply->__get(i).StaticCast<  ::flixel::text::FlxTextFormatMarkerPair >()->marker);
HXLINE( 381)				{
HXLINE( 381)					int _g = 0;
HXDLIN( 381)					int _g1 = rangeStarts->length;
HXDLIN( 381)					while((_g < _g1)){
HXLINE( 381)						_g = (_g + 1);
HXDLIN( 381)						int j = (_g - 1);
HXLINE( 383)						if ((rangeStarts->__get(j) > delIndex)) {
HXLINE( 385)							::Array< int > rangeStarts1 = rangeStarts;
HXDLIN( 385)							int j1 = j;
HXDLIN( 385)							rangeStarts1[j1] = (rangeStarts1->__get(j1) - markerLength);
            						}
HXLINE( 387)						if ((rangeEnds->__get(j) > delIndex)) {
HXLINE( 389)							::Array< int > rangeEnds1 = rangeEnds;
HXDLIN( 389)							int j1 = j;
HXDLIN( 389)							rangeEnds1[j1] = (rangeEnds1->__get(j1) - markerLength);
            						}
            					}
            				}
HXLINE( 394)				delIndex = rangeEnds->__get(i);
HXLINE( 397)				{
HXLINE( 397)					int _g3 = 0;
HXDLIN( 397)					int _g4 = rangeStarts->length;
HXDLIN( 397)					while((_g3 < _g4)){
HXLINE( 397)						_g3 = (_g3 + 1);
HXDLIN( 397)						int j = (_g3 - 1);
HXLINE( 399)						if ((rangeStarts->__get(j) > delIndex)) {
HXLINE( 401)							::Array< int > rangeStarts1 = rangeStarts;
HXDLIN( 401)							int j1 = j;
HXDLIN( 401)							rangeStarts1[j1] = (rangeStarts1->__get(j1) - markerLength);
            						}
HXLINE( 403)						if ((rangeEnds->__get(j) > delIndex)) {
HXLINE( 405)							::Array< int > rangeEnds1 = rangeEnds;
HXDLIN( 405)							int j1 = j;
HXDLIN( 405)							rangeEnds1[j1] = (rangeEnds1->__get(j1) - markerLength);
            						}
            					}
            				}
            			}
...
HXDLIN( 414)			int _g5 = rangeStarts->length;
HXDLIN( 414)			while((_g4 < _g5)){
HXLINE( 414)				_g4 = (_g4 + 1);
HXDLIN( 414)				int i = (_g4 - 1);
HXLINE( 415)				this->addFormat(rulesToApply->__get(i).StaticCast<  ::flixel::text::FlxTextFormatMarkerPair >()->format,rangeStarts->__get(i),rangeEnds->__get(i));
            			}
            		}
...
HXLINE( 456)					_hx_tmp = ::hx::IsLessEq( End,range->start );
            				}
            				else {
...
HXLINE( 459)					_hx_tmp1 = ::hx::IsLess( End,range->end );
            				}
            				else {
...
HXLINE( 466)					_hx_tmp2 = ::hx::IsLess( End,range->end );
            				}
            				else {
...
HXLINE( 472)					_hx_tmp3 = ::hx::IsGreaterEq( End,range->end );
            				}
            				else {
...
HXLINE( 885)						_hx_tmp = (this->_shadowOffset->y != 1);
            					}
            					else {
...
HXLINE( 943)			_hx_tmp2 = ::hx::IsNotNull( this->textField->get_text() );
            		}
            		else {
...
HXDLIN(1029)			if (point->_weak) {
HXLINE(1029)				point->put();
            			}
...
HXDLIN(1029)			if (point1->_weak) {
HXLINE(1029)				point1->put();
            			}
            		}
HXLINE(1030)		if (this->isPixelPerfectRender(camera)) {
HXLINE(1031)			 ::flixel::math::FlxBasePoint this1 = this->_point;
HXDLIN(1031)			this1->set_x(( (Float)(::Math_obj::floor(this1->x)) ));
HXDLIN(1031)			this1->set_y(( (Float)(::Math_obj::floor(this1->y)) ));
            		}
HXLINE(1033)		{
HXLINE(1033)			 ::flixel::math::FlxBasePoint this3 = this->_point;
HXDLIN(1033)			 ::openfl::geom::Point p = this->_flashPoint;
HXDLIN(1033)			p->x = this3->x;
HXDLIN(1033)			p->y = this3->y;
            		}
...
HXDLIN(1052)			if (point->_weak) {
HXLINE(1052)				point->put();
            			}
...
HXDLIN(1052)			if (point1->_weak) {
HXLINE(1052)				point1->put();
            			}
            		}
HXLINE(1053)		{
...
HXLINE(1093)							 ::flixel::math::FlxBasePoint this1 = this->_graphicOffset;
HXDLIN(1093)							Float y = -(this->borderSize);
HXDLIN(1093)							this1->set_x(-(this->borderSize));
HXDLIN(1093)							this1->set_y(y);
            						}
            					}
            				}
            				break;
...
HXDLIN(1095)					{
HXLINE(1096)						{
HXLINE(1096)							Float _hx_tmp;
HXDLIN(1096)							if ((offsetX < 0)) {
HXLINE(1096)								_hx_tmp = -(offsetX);
            							}
            							else {
HXLINE(1096)								_hx_tmp = ( (Float)(0) );
            							}
HXDLIN(1096)							this->_graphicOffset->set_x(_hx_tmp);
            						}
HXLINE(1097)						{
HXLINE(1097)							Float _hx_tmp1;
HXDLIN(1097)							if ((offsetY < 0)) {
HXLINE(1097)								_hx_tmp1 = -(offsetY);
            							}
            							else {
HXLINE(1097)								_hx_tmp1 = ( (Float)(0) );
            							}
HXDLIN(1097)							this->_graphicOffset->set_y(_hx_tmp1);
            						}
            					}
            				}
            				break;
...
HXLINE(1100)						 ::flixel::math::FlxBasePoint this1 = this->_graphicOffset;
HXDLIN(1100)						Float y = -(this->borderSize);
HXDLIN(1100)						this1->set_x(-(this->borderSize));
HXDLIN(1100)						this1->set_y(y);
            					}
            					else {
HXLINE(1103)						 ::flixel::math::FlxBasePoint this1 = this->_graphicOffset;
HXDLIN(1103)						this1->set_x(( (Float)(0) ));
...
HXLINE(1109)						_hx_tmp = (this->_shadowOffset->y != 1);
            					}
            					else {
...
HXDLIN(1115)							int _g1 = iterations;
...
HXLINE(1129)						int iterations;
HXDLIN(1129)						if ((this->borderQuality < 1)) {
HXLINE(1129)							iterations = 1;
            						}
            						else {
HXLINE(1129)							iterations = ::Std_obj::_hx_int((::Math_obj::abs(this->borderSize) * this->borderQuality));
            						}
HXLINE(1130)						int i = (iterations + 1);
HXLINE(1131)						while(true){
HXLINE(1131)							i = (i - 1);
HXDLIN(1131)							if (!(((i + 1) > 1))) {
HXLINE(1131)								goto _hx_goto_65;
            							}
HXLINE(1133)							{
HXLINE(1133)								 ::openfl::display::BitmapData graphic;
HXDLIN(1133)								if (this->_hasBorderAlpha) {
HXLINE(1133)									graphic = this->_borderPixels;
            								}
            								else {
HXLINE(1133)									graphic = this->graphic->bitmap;
            								}
HXDLIN(1133)								this->_matrix->translate(((this->borderSize / ( (Float)(iterations) )) * ( (Float)(i) )),((this->borderSize / ( (Float)(iterations) )) * ( (Float)(i) )));
HXDLIN(1133)								this->drawTextFieldTo(graphic);
            							}
...
HXLINE(1143)						Float originX = this->_matrix->tx;
HXLINE(1144)						Float originY = this->_matrix->ty;
HXLINE(1147)						Float size = ::Math_obj::max(shadowX,shadowY);
HXLINE(1148)						int iterations;
HXDLIN(1148)						if ((this->borderQuality < 1)) {
HXLINE(1148)							iterations = 1;
            						}
            						else {
HXLINE(1148)							iterations = ::Std_obj::_hx_int((size * this->borderQuality));
            						}
HXLINE(1149)						int i = (iterations + 1);
HXLINE(1150)						while(true){
HXLINE(1150)							i = (i - 1);
HXDLIN(1150)							if (!(((i + 1) > 1))) {
HXLINE(1150)								goto _hx_goto_66;
            							}
HXLINE(1152)							{
HXLINE(1152)								 ::openfl::display::BitmapData graphic;
HXDLIN(1152)								if (this->_hasBorderAlpha) {
HXLINE(1152)									graphic = this->_borderPixels;
            								}
            								else {
HXLINE(1152)									graphic = this->graphic->bitmap;
            								}
HXDLIN(1152)								this->_matrix->translate(((shadowX / ( (Float)(iterations) )) * ( (Float)(i) )),((shadowY / ( (Float)(iterations) )) * ( (Float)(i) )));
HXDLIN(1152)								this->drawTextFieldTo(graphic);
            							}
HXLINE(1154)							this->_matrix->tx = originX;
HXLINE(1155)							this->_matrix->ty = originY;
            						}
            						_hx_goto_66:;
            					}
            				}
...
HXDLIN(1163)					int iterations;
HXDLIN(1163)					if ((1 > b)) {
HXLINE(1163)						iterations = 1;
            					}
            					else {
HXLINE(1163)						iterations = b;
            					}
HXLINE(1164)					int i = (iterations + 1);
HXLINE(1165)					while(true){
HXLINE(1165)						i = (i - 1);
HXDLIN(1165)						if (!(((i + 1) > 1))) {
HXLINE(1165)							goto _hx_goto_67;
            						}
HXLINE(1167)						Float curDelta = ((this->borderSize / ( (Float)(iterations) )) * ( (Float)(i) ));
HXLINE(1168)						{
HXLINE(1168)							 ::openfl::display::BitmapData graphic;
HXDLIN(1168)							if (this->_hasBorderAlpha) {
HXLINE(1168)								graphic = this->_borderPixels;
            							}
            							else {
HXLINE(1168)								graphic = this->graphic->bitmap;
            							}
HXDLIN(1168)							this->_matrix->translate(-(curDelta),-(curDelta));
HXDLIN(1168)							this->drawTextFieldTo(graphic);
            						}
HXLINE(1169)						{
HXLINE(1169)							 ::openfl::display::BitmapData graphic1;
HXDLIN(1169)							if (this->_hasBorderAlpha) {
HXLINE(1169)								graphic1 = this->_borderPixels;
            							}
            							else {
HXLINE(1169)								graphic1 = this->graphic->bitmap;
            							}
HXDLIN(1169)							this->_matrix->translate(curDelta,( (Float)(0) ));
HXDLIN(1169)							this->drawTextFieldTo(graphic1);
            						}
HXLINE(1170)						{
HXLINE(1170)							 ::openfl::display::BitmapData graphic2;
HXDLIN(1170)							if (this->_hasBorderAlpha) {
HXLINE(1170)								graphic2 = this->_borderPixels;
            							}
            							else {
HXLINE(1170)								graphic2 = this->graphic->bitmap;
            							}
HXDLIN(1170)							this->_matrix->translate(curDelta,( (Float)(0) ));
HXDLIN(1170)							this->drawTextFieldTo(graphic2);
            						}
HXLINE(1171)						{
HXLINE(1171)							 ::openfl::display::BitmapData graphic3;
HXDLIN(1171)							if (this->_hasBorderAlpha) {
HXLINE(1171)								graphic3 = this->_borderPixels;
            							}
            							else {
HXLINE(1171)								graphic3 = this->graphic->bitmap;
            							}
HXDLIN(1171)							this->_matrix->translate(( (Float)(0) ),curDelta);
HXDLIN(1171)							this->drawTextFieldTo(graphic3);
            						}
HXLINE(1172)						{
HXLINE(1172)							 ::openfl::display::BitmapData graphic4;
HXDLIN(1172)							if (this->_hasBorderAlpha) {
HXLINE(1172)								graphic4 = this->_borderPixels;
            							}
            							else {
HXLINE(1172)								graphic4 = this->graphic->bitmap;
            							}
HXDLIN(1172)							this->_matrix->translate(( (Float)(0) ),curDelta);
HXDLIN(1172)							this->drawTextFieldTo(graphic4);
            						}
HXLINE(1173)						{
HXLINE(1173)							 ::openfl::display::BitmapData graphic5;
HXDLIN(1173)							if (this->_hasBorderAlpha) {
HXLINE(1173)								graphic5 = this->_borderPixels;
            							}
            							else {
HXLINE(1173)								graphic5 = this->graphic->bitmap;
            							}
HXDLIN(1173)							this->_matrix->translate(-(curDelta),( (Float)(0) ));
HXDLIN(1173)							this->drawTextFieldTo(graphic5);
            						}
HXLINE(1174)						{
HXLINE(1174)							 ::openfl::display::BitmapData graphic6;
HXDLIN(1174)							if (this->_hasBorderAlpha) {
HXLINE(1174)								graphic6 = this->_borderPixels;
            							}
            							else {
HXLINE(1174)								graphic6 = this->graphic->bitmap;
            							}
HXDLIN(1174)							this->_matrix->translate(-(curDelta),( (Float)(0) ));
HXDLIN(1174)							this->drawTextFieldTo(graphic6);
            						}
HXLINE(1175)						{
HXLINE(1175)							 ::openfl::display::BitmapData graphic7;
HXDLIN(1175)							if (this->_hasBorderAlpha) {
HXLINE(1175)								graphic7 = this->_borderPixels;
            							}
            							else {
HXLINE(1175)								graphic7 = this->graphic->bitmap;
            							}
HXDLIN(1175)							this->_matrix->translate(( (Float)(0) ),-(curDelta));
HXDLIN(1175)							this->drawTextFieldTo(graphic7);
            						}
...
HXLINE(1186)					int b = ::Std_obj::_hx_int((this->borderSize * this->borderQuality));
HXDLIN(1186)					int iterations;
HXDLIN(1186)					if ((1 > b)) {
HXLINE(1186)						iterations = 1;
            					}
            					else {
HXLINE(1186)						iterations = b;
            					}
HXLINE(1187)					int i = (iterations + 1);
HXLINE(1188)					while(true){
HXLINE(1188)						i = (i - 1);
HXDLIN(1188)						if (!(((i + 1) > 1))) {
HXLINE(1188)							goto _hx_goto_68;
            						}
HXLINE(1190)						Float curDelta = ((this->borderSize / ( (Float)(iterations) )) * ( (Float)(i) ));
HXLINE(1191)						{
HXLINE(1191)							 ::openfl::display::BitmapData graphic;
HXDLIN(1191)							if (this->_hasBorderAlpha) {
HXLINE(1191)								graphic = this->_borderPixels;
            							}
            							else {
HXLINE(1191)								graphic = this->graphic->bitmap;
            							}
HXDLIN(1191)							this->_matrix->translate(-(curDelta),-(curDelta));
HXDLIN(1191)							this->drawTextFieldTo(graphic);
            						}
HXLINE(1192)						{
HXLINE(1192)							 ::openfl::display::BitmapData graphic1;
HXDLIN(1192)							if (this->_hasBorderAlpha) {
HXLINE(1192)								graphic1 = this->_borderPixels;
            							}
            							else {
HXLINE(1192)								graphic1 = this->graphic->bitmap;
            							}
HXDLIN(1192)							this->_matrix->translate((curDelta * ( (Float)(2) )),( (Float)(0) ));
HXDLIN(1192)							this->drawTextFieldTo(graphic1);
            						}
HXLINE(1193)						{
HXLINE(1193)							 ::openfl::display::BitmapData graphic2;
HXDLIN(1193)							if (this->_hasBorderAlpha) {
HXLINE(1193)								graphic2 = this->_borderPixels;
            							}
            							else {
HXLINE(1193)								graphic2 = this->graphic->bitmap;
            							}
HXDLIN(1193)							this->_matrix->translate(( (Float)(0) ),(curDelta * ( (Float)(2) )));
HXDLIN(1193)							this->drawTextFieldTo(graphic2);
            						}
HXLINE(1194)						{
HXLINE(1194)							 ::openfl::display::BitmapData graphic3;
HXDLIN(1194)							if (this->_hasBorderAlpha) {
HXLINE(1194)								graphic3 = this->_borderPixels;
            							}
            							else {
HXLINE(1194)								graphic3 = this->graphic->bitmap;
            							}
HXDLIN(1194)							this->_matrix->translate((-(curDelta) * ( (Float)(2) )),( (Float)(0) ));
HXDLIN(1194)							this->drawTextFieldTo(graphic3);
            						}
HXLINE(1196)						this->_matrix->translate(curDelta,-(curDelta));
            					}
            					_hx_goto_68:;
            				}
            				break;
...
HXDLIN(1234)				_g = (_g + 1);
HXLINE(1236)				int _hx_tmp = (this->textField->get_text().length - 1);
HXDLIN(1236)				if (::hx::IsLess( _hx_tmp,formatRange->range->start )) {
...
HXLINE(1245)					 ::Dynamic _hx_tmp;
HXDLIN(1245)					if (UseBorderColor) {
HXLINE(1245)						_hx_tmp = (formatRange->format->borderColor & 16777215);
            					}
            					else {
HXLINE(1245)						_hx_tmp = textFormat->color;
            					}
HXDLIN(1245)					FormatAdjusted->color = _hx_tmp;
            				}
HXLINE(1248)				 ::openfl::text::TextField _hx_tmp1 = this->textField;
HXDLIN(1248)				int formatRange1 = ( (int)(formatRange->range->start) );
HXDLIN(1248)				int formatRange2 = ( (int)(formatRange->range->end) );
HXDLIN(1248)				_hx_tmp1->setTextFormat(FormatAdjusted,formatRange1,::Std_obj::_hx_int(::Math_obj::min(( (Float)(formatRange2) ),( (Float)(this->textField->get_text().length) ))));
            			}
            			_hx_goto_72:;
            		}
            	}
