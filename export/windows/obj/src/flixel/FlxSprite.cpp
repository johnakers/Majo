...
HXDLIN( 404)		 ::flixel::math::FlxBasePoint this1 = point4;
HXDLIN( 404)		this->_scaledOrigin = this1;
            	}
...
HXLINE( 821)					_hx_tmp1 = !(camera->exists);
            				}
            				else {
HXLINE( 821)					_hx_tmp1 = true;
            				}
HXDLIN( 821)				if (!(_hx_tmp1)) {
HXLINE( 821)					_hx_tmp = !(this->isOnScreen(camera));
            				}
            				else {
...
HXLINE( 854)			 ::flixel::math::FlxRect _this = this->_lastClipRect;
HXDLIN( 854)			_this->x = ::Math_obj::NaN;
HXDLIN( 854)			_this->y = ((Float)0.0);
HXDLIN( 854)			_this->width = ((Float)0.0);
HXDLIN( 854)			_this->height = ((Float)0.0);
            		}
            		else {
HXLINE( 856)			 ::flixel::math::FlxRect _this = this->_lastClipRect;
HXDLIN( 856)			 ::flixel::math::FlxRect Rect = this->clipRect;
HXDLIN( 856)			_this->x = Rect->x;
HXDLIN( 856)			_this->y = Rect->y;
HXDLIN( 856)			_this->width = Rect->width;
HXDLIN( 856)			_this->height = Rect->height;
...
HXDLIN( 862)			if (point->_weak) {
HXLINE( 862)				point->put();
            			}
            		}
HXLINE( 863)		if (this->isPixelPerfectRender(camera)) {
HXLINE( 864)			 ::flixel::math::FlxBasePoint this1 = this->_point;
HXDLIN( 864)			this1->set_x(( (Float)(::Math_obj::floor(this1->x)) ));
HXDLIN( 864)			this1->set_y(( (Float)(::Math_obj::floor(this1->y)) ));
            		}
HXLINE( 866)		{
HXLINE( 866)			 ::flixel::math::FlxBasePoint this2 = this->_point;
HXDLIN( 866)			 ::openfl::geom::Point p = this->_flashPoint;
HXDLIN( 866)			p->x = this2->x;
HXDLIN( 866)			p->y = this2->y;
            		}
...
HXLINE( 917)			HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(HX_("Cannot stamp to or from a FlxSprite with no graphics.",72,0b,d4,aa)));
            		}
...
HXLINE(1110)			int _hx_tmp = ::Std_obj::_hx_int(this->_point->x);
HXDLIN(1110)			return frameData->getPixel32(_hx_tmp,::Std_obj::_hx_int(this->_point->y));
            		}
...
HXLINE(1133)			int _hx_tmp = ::Std_obj::_hx_int(this->_point->x);
HXDLIN(1133)			return frameData->getPixel32(_hx_tmp,::Std_obj::_hx_int(this->_point->y));
            		}
...
HXLINE(1154)		if (worldPoint->_weak) {
HXLINE(1154)			worldPoint->put();
            		}
...
HXDLIN(1172)			if (point->_weak) {
HXLINE(1172)				point->put();
            			}
            		}
HXLINE(1173)		{
...
HXDLIN(1173)			if (point1->_weak) {
HXLINE(1173)				point1->put();
            			}
            		}
HXLINE(1174)		{
...
HXDLIN(1176)			if (point2->_weak) {
HXLINE(1176)				point2->put();
            			}
            		}
HXLINE(1178)		if (worldPoint->_weak) {
HXLINE(1178)			worldPoint->put();
            		}
...
HXDLIN(1198)			if (point->_weak) {
HXLINE(1198)				point->put();
            			}
            		}
HXLINE(1199)		{
...
HXDLIN(1199)			if (point1->_weak) {
HXLINE(1199)				point1->put();
            			}
            		}
HXLINE(1200)		{
...
HXDLIN(1202)			if (point2->_weak) {
HXLINE(1202)				point2->put();
            			}
            		}
HXLINE(1204)		if (screenPoint->_weak) {
HXLINE(1204)			screenPoint->put();
            		}
...
HXLINE(1301)		 ::flixel::math::FlxRect rect1 = rect;
HXDLIN(1301)		rect1->x = (rect1->x + ((this->origin->x - this->offset->x) - this->_scaledOrigin->x));
HXLINE(1302)		 ::flixel::math::FlxRect rect2 = rect;
HXDLIN(1302)		rect2->y = (rect2->y + ((this->origin->y - this->offset->y) - this->_scaledOrigin->y));
HXLINE(1303)		{
...
HXLINE(1663)			_hx_tmp = this->dirty;
            		}
            		else {
HXLINE(1663)			_hx_tmp = true;
            		}
HXDLIN(1663)		this->dirty = _hx_tmp;
...
HXLINE(1674)			_hx_tmp = this->dirty;
            		}
            		else {
HXLINE(1674)			_hx_tmp = true;
            		}
HXDLIN(1674)		this->dirty = _hx_tmp;
