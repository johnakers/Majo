...
HXDLIN(  85)					if (::hx::IsEq( id,::flixel::input::gamepad::id::_WiiRemoteID::WiiRemoteID_Impl__obj::LEFT_ANALOG_STICK->rawDown )) {
HXLINE(  85)						return 36;
            					}
            					else {
HXLINE(  86)						int id = rawID;
HXDLIN(  86)						if (::hx::IsEq( id,::flixel::input::gamepad::id::_WiiRemoteID::WiiRemoteID_Impl__obj::LEFT_ANALOG_STICK->rawLeft )) {
HXLINE(  86)							return 37;
            						}
            						else {
HXLINE(  87)							int id = rawID;
HXDLIN(  87)							if (::hx::IsEq( id,::flixel::input::gamepad::id::_WiiRemoteID::WiiRemoteID_Impl__obj::LEFT_ANALOG_STICK->rawRight )) {
HXLINE(  87)								return 35;
            							}
            							else {
