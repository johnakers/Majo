...
HXDLIN(  35)					if (::hx::IsEq( id,this->leftStick->rawDown )) {
HXLINE(  35)						return 36;
            					}
            					else {
HXLINE(  36)						int id = rawID;
HXDLIN(  36)						if (::hx::IsEq( id,this->leftStick->rawLeft )) {
HXLINE(  36)							return 37;
            						}
            						else {
HXLINE(  37)							int id = rawID;
HXDLIN(  37)							if (::hx::IsEq( id,this->leftStick->rawRight )) {
HXLINE(  37)								return 35;
            							}
            							else {
HXLINE(  38)								int id = rawID;
HXDLIN(  38)								if (::hx::IsEq( id,this->rightStick->rawUp )) {
HXLINE(  38)									return 38;
            								}
            								else {
HXLINE(  39)									int id = rawID;
HXDLIN(  39)									if (::hx::IsEq( id,this->rightStick->rawDown )) {
HXLINE(  39)										return 40;
            									}
            									else {
HXLINE(  40)										int id = rawID;
HXDLIN(  40)										if (::hx::IsEq( id,this->rightStick->rawLeft )) {
HXLINE(  40)											return 41;
            										}
            										else {
HXLINE(  41)											int id = rawID;
HXDLIN(  41)											if (::hx::IsEq( id,this->rightStick->rawRight )) {
HXLINE(  41)												return 39;
            											}
            											else {
HXLINE(  42)												return -1;
