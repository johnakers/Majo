...
HXDLIN(  52)					if (::hx::IsEq( id,this->leftStick->rawDown )) {
HXLINE(  52)						return 36;
            					}
            					else {
HXLINE(  53)						int id = rawID;
HXDLIN(  53)						if (::hx::IsEq( id,this->leftStick->rawLeft )) {
HXLINE(  53)							return 37;
            						}
            						else {
HXLINE(  54)							int id = rawID;
HXDLIN(  54)							if (::hx::IsEq( id,this->leftStick->rawRight )) {
HXLINE(  54)								return 35;
            							}
            							else {
HXLINE(  55)								int id = rawID;
HXDLIN(  55)								if (::hx::IsEq( id,this->rightStick->rawUp )) {
HXLINE(  55)									return 38;
            								}
            								else {
HXLINE(  56)									int id = rawID;
HXDLIN(  56)									if (::hx::IsEq( id,this->rightStick->rawDown )) {
HXLINE(  56)										return 40;
            									}
            									else {
HXLINE(  57)										int id = rawID;
HXDLIN(  57)										if (::hx::IsEq( id,this->rightStick->rawLeft )) {
HXLINE(  57)											return 41;
            										}
            										else {
HXLINE(  58)											int id = rawID;
HXDLIN(  58)											if (::hx::IsEq( id,this->rightStick->rawRight )) {
HXLINE(  58)												return 39;
            											}
            											else {
HXLINE(  59)												return -1;
