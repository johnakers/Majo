...
HXDLIN(  32)					if (::hx::IsEq( id,this->leftStick->rawDown )) {
HXLINE(  32)						return 34;
            					}
            					else {
HXLINE(  33)						int id = rawID;
HXDLIN(  33)						if (::hx::IsEq( id,this->leftStick->rawLeft )) {
HXLINE(  33)							return 37;
            						}
            						else {
HXLINE(  34)							int id = rawID;
HXDLIN(  34)							if (::hx::IsEq( id,this->leftStick->rawRight )) {
HXLINE(  34)								return 35;
            							}
            							else {
HXLINE(  35)								int id = rawID;
HXDLIN(  35)								if (::hx::IsEq( id,this->rightStick->rawUp )) {
HXLINE(  35)									return 38;
            								}
            								else {
HXLINE(  36)									int id = rawID;
HXDLIN(  36)									if (::hx::IsEq( id,this->rightStick->rawDown )) {
HXLINE(  36)										return 40;
            									}
            									else {
HXLINE(  37)										int id = rawID;
HXDLIN(  37)										if (::hx::IsEq( id,this->rightStick->rawLeft )) {
HXLINE(  37)											return 41;
            										}
            										else {
HXLINE(  38)											int id = rawID;
HXDLIN(  38)											if (::hx::IsEq( id,this->rightStick->rawRight )) {
HXLINE(  38)												return 39;
            											}
            											else {
HXLINE(  39)												return -1;
