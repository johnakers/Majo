...
HXDLIN(  55)					if (::hx::IsEq( id,this->leftStick->rawDown )) {
HXLINE(  55)						return 36;
            					}
            					else {
HXLINE(  56)						int id = rawID;
HXDLIN(  56)						if (::hx::IsEq( id,this->leftStick->rawLeft )) {
HXLINE(  56)							return 37;
            						}
            						else {
HXLINE(  57)							int id = rawID;
HXDLIN(  57)							if (::hx::IsEq( id,this->leftStick->rawRight )) {
HXLINE(  57)								return 35;
            							}
            							else {
HXLINE(  58)								int id = rawID;
HXDLIN(  58)								if (::hx::IsEq( id,this->rightStick->rawUp )) {
HXLINE(  58)									return 38;
            								}
            								else {
HXLINE(  59)									int id = rawID;
HXDLIN(  59)									if (::hx::IsEq( id,this->rightStick->rawDown )) {
HXLINE(  59)										return 40;
            									}
            									else {
HXLINE(  60)										int id = rawID;
HXDLIN(  60)										if (::hx::IsEq( id,this->rightStick->rawLeft )) {
HXLINE(  60)											return 41;
            										}
            										else {
HXLINE(  61)											int id = rawID;
HXDLIN(  61)											if (::hx::IsEq( id,this->rightStick->rawRight )) {
HXLINE(  61)												return 39;
            											}
            											else {
HXLINE(  62)												return -1;
