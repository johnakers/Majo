...
HXDLIN(  56)					if (::hx::IsEq( id,this->leftStick->rawDown )) {
HXLINE(  56)						return 36;
            					}
            					else {
HXLINE(  57)						int id = rawID;
HXDLIN(  57)						if (::hx::IsEq( id,this->leftStick->rawLeft )) {
HXLINE(  57)							return 37;
            						}
            						else {
HXLINE(  58)							int id = rawID;
HXDLIN(  58)							if (::hx::IsEq( id,this->leftStick->rawRight )) {
HXLINE(  58)								return 35;
            							}
            							else {
HXLINE(  59)								int id = rawID;
HXDLIN(  59)								if (::hx::IsEq( id,this->rightStick->rawUp )) {
HXLINE(  59)									return 38;
            								}
            								else {
HXLINE(  60)									int id = rawID;
HXDLIN(  60)									if (::hx::IsEq( id,this->rightStick->rawDown )) {
HXLINE(  60)										return 40;
            									}
            									else {
HXLINE(  61)										int id = rawID;
HXDLIN(  61)										if (::hx::IsEq( id,this->rightStick->rawLeft )) {
HXLINE(  61)											return 41;
            										}
            										else {
HXLINE(  62)											int id = rawID;
HXDLIN(  62)											if (::hx::IsEq( id,this->rightStick->rawRight )) {
HXLINE(  62)												return 39;
            											}
            											else {
HXLINE(  63)												return -1;
...
HXLINE(  85)					int id = rawID;
HXDLIN(  85)					if (::hx::IsEq( id,::flixel::input::gamepad::id::_MayflashWiiRemoteID::MayflashWiiRemoteID_Impl__obj::LEFT_ANALOG_STICK->rawDown )) {
HXLINE(  85)						return 36;
            					}
            					else {
HXLINE(  86)						int id = rawID;
HXDLIN(  86)						if (::hx::IsEq( id,::flixel::input::gamepad::id::_MayflashWiiRemoteID::MayflashWiiRemoteID_Impl__obj::LEFT_ANALOG_STICK->rawLeft )) {
HXLINE(  86)							return 37;
            						}
            						else {
HXLINE(  87)							int id = rawID;
HXDLIN(  87)							if (::hx::IsEq( id,::flixel::input::gamepad::id::_MayflashWiiRemoteID::MayflashWiiRemoteID_Impl__obj::LEFT_ANALOG_STICK->rawRight )) {
HXLINE(  87)								return 35;
            							}
            							else {
HXLINE(  88)								return -1;
