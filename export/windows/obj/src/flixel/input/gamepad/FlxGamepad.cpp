...
HXLINE( 256)				 ::flixel::input::gamepad::FlxGamepadButton button = _g3->__get(_g2).StaticCast<  ::flixel::input::gamepad::FlxGamepadButton >();
HXDLIN( 256)				_g2 = (_g2 + 1);
HXLINE( 258)				if (::hx::IsNotNull( button )) {
HXLINE( 260)					button->update();
            				}
            			}
            		}
            	}
...
HXLINE( 591)				_hx_tmp = (AxisIndex == rightStick->y);
            			}
            			else {
...
HXLINE( 785)			bool stick1;
HXDLIN( 785)			bool stick2;
HXDLIN( 785)			if (::hx::IsNotNull( rightStick )) {
HXLINE( 785)				stick2 = (axis == rightStick->x);
            			}
            			else {
HXLINE( 785)				stick2 = false;
            			}
HXDLIN( 785)			if (!(stick2)) {
HXLINE( 785)				stick1 = (axis == rightStick->y);
            			}
            			else {
HXLINE( 785)				stick1 = true;
            			}
...
HXDLIN( 785)		 ::flixel::input::gamepad::FlxTypedGamepadAnalogStick stick3 = stick;
HXLINE( 786)		bool _hx_tmp;
HXDLIN( 786)		if (::hx::IsPointerNotEq( stick3->mode,::flixel::input::gamepad::FlxAnalogToDigitalMode_obj::ONLY_DIGITAL_dyn() )) {
HXLINE( 786)			_hx_tmp = ::hx::IsPointerEq( stick3->mode,::flixel::input::gamepad::FlxAnalogToDigitalMode_obj::BOTH_dyn() );
            		}
            		else {
...
HXLINE( 789)			this->handleAxisMoveSub(stick3,axis,newValue,oldValue,((Float)-1.0));
HXLINE( 791)			bool _hx_tmp = ::hx::IsPointerEq( stick3->mode,::flixel::input::gamepad::FlxAnalogToDigitalMode_obj::ONLY_DIGITAL_dyn() );
            		}
            	}
...
HXLINE( 821)				_hx_tmp = (oldValueSign > threshold);
            			}
            			else {
HXLINE( 821)				_hx_tmp = false;
            			}
HXDLIN( 821)			if (_hx_tmp) {
HXLINE( 823)				 ::flixel::input::gamepad::FlxGamepadButton btn = this->getButton(digitalButton);
HXLINE( 824)				if (::hx::IsNotNull( btn )) {
HXLINE( 825)					btn->release();
            				}
            			}
            		}
            	}
