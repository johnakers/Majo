...
HXDLIN( 388)		HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(HX_("createTile not implemented",5f,7a,88,7e)));
...
HXLINE( 591)				{
HXLINE( 591)					int _g = 0;
HXDLIN( 591)					int _g1 = screenColumns;
HXDLIN( 591)					while((_g < _g1)){
HXLINE( 591)						_g = (_g + 1);
HXDLIN( 591)						int column = (_g - 1);
HXLINE( 593)						int tile;
...
HXDLIN( 637)		if (point->_weak) {
HXLINE( 637)			point->put();
            		}
...
HXLINE( 667)					::Array< ::Dynamic> _hx_tmp = this->_buffers;
HXDLIN( 667)					 ::flixel::tile::FlxTilemapBuffer buffer =  ::flixel::tile::FlxTilemapBuffer_obj::__alloc( HX_CTX ,this->tileWidth,this->tileHeight,this->widthInTiles,this->heightInTiles,camera,this->scale->x,this->scale->y);
HXDLIN( 667)					buffer->pixelPerfectRender = this->pixelPerfectRender;
HXDLIN( 667)					buffer->antialiasing = this->antialiasing;
HXDLIN( 667)					_hx_tmp[i] = buffer;
            				}
...
HXDLIN( 676)						if (point->_weak) {
HXLINE( 676)							point->put();
            						}
...
HXDLIN( 705)					 ::flixel::tile::FlxTilemapBuffer buffer =  ::flixel::tile::FlxTilemapBuffer_obj::__alloc( HX_CTX ,this->tileWidth,this->tileHeight,this->widthInTiles,this->heightInTiles,camera,this->scale->x,this->scale->y);
HXDLIN( 705)					buffer->pixelPerfectRender = this->pixelPerfectRender;
HXDLIN( 705)					buffer->antialiasing = this->antialiasing;
HXDLIN( 705)					_hx_tmp[i] = buffer;
            				}
            				else {
...
HXLINE( 755)			if (position->_weak) {
HXLINE( 755)				position->put();
            			}
            		}
...
HXLINE( 772)				{
HXLINE( 772)					int _g1 = minTileX2;
HXDLIN( 772)					int _g2 = maxTileX2;
HXDLIN( 772)					while((_g1 < _g2)){
HXLINE( 772)						_g1 = (_g1 + 1);
HXDLIN( 772)						int column = (_g1 - 1);
...
HXLINE( 811)				bool each;
HXDLIN( 811)				if (!(((( ( ::flixel::FlxObject)(tile) )->allowCollisions & 4369) > 0))) {
HXLINE( 811)					each = !(isCollision);
            				}
            				else {
HXLINE( 811)					each = true;
            				}
HXDLIN( 811)				if (each) {
...
HXLINE( 908)		if (start->_weak) {
HXLINE( 908)			start->put();
            		}
HXLINE( 909)		if (end->_weak) {
HXLINE( 909)			end->put();
            		}
...
HXDLIN( 935)				if (start->_weak) {
HXLINE( 935)					start->put();
            				}
            			}
HXLINE( 937)			{
...
HXLINE( 950)				_hx_tmp = ::hx::IsNotNull( result );
            			}
            			else {
...
HXDLIN( 953)					if (p1) {
HXLINE( 953)						int column = ::hx::Mod(hitIndex,this->widthInTiles);
HXDLIN( 953)						int row = ::Std_obj::_hx_int((( (Float)(hitIndex) ) / ( (Float)(this->widthInTiles) )));
HXDLIN( 953)						Float x = this->getColumnPos(( (Float)(column) ),midpoint);
HXDLIN( 953)						Float y = this->getRowPos(row,midpoint);
HXDLIN( 953)						 ::flixel::math::FlxBasePoint point = ::flixel::math::FlxBasePoint_obj::pool->get().StaticCast<  ::flixel::math::FlxBasePoint >()->set(x,y);
...
HXDLIN( 953)					{
HXLINE( 953)						Float y = p->y;
HXDLIN( 953)						result->set_x(p->x);
HXDLIN( 953)						result->set_y(y);
            					}
HXDLIN( 953)					if (p->_weak) {
HXLINE( 953)						p->put();
            					}
            				}
...
HXLINE( 987)				_hx_tmp = ::hx::IsNotNull( result );
            			}
            			else {
...
HXLINE( 989)				{
HXLINE( 989)					bool midpoint = false;
HXDLIN( 989)					 ::flixel::math::FlxBasePoint p;
HXDLIN( 989)					bool p1;
HXDLIN( 989)					if ((hitIndex >= 0)) {
HXLINE( 989)						p1 = (hitIndex < this->_data->length);
            					}
            					else {
HXLINE( 989)						p1 = false;
            					}
HXDLIN( 989)					if (p1) {
HXLINE( 989)						int column = ::hx::Mod(hitIndex,this->widthInTiles);
HXDLIN( 989)						int row = ::Std_obj::_hx_int((( (Float)(hitIndex) ) / ( (Float)(this->widthInTiles) )));
HXDLIN( 989)						Float x = this->getColumnPos(( (Float)(column) ),midpoint);
HXDLIN( 989)						Float y = this->getRowPos(row,midpoint);
HXDLIN( 989)						 ::flixel::math::FlxBasePoint point = ::flixel::math::FlxBasePoint_obj::pool->get().StaticCast<  ::flixel::math::FlxBasePoint >()->set(x,y);
HXDLIN( 989)						point->_inPool = false;
HXDLIN( 989)						p = point;
            					}
            					else {
HXLINE( 989)						p = null();
...
HXDLIN( 989)					{
HXLINE( 989)						Float y = p->y;
HXDLIN( 989)						result->set_x(p->x);
HXDLIN( 989)						result->set_y(y);
            					}
HXDLIN( 989)					if (p->_weak) {
HXLINE( 989)						p->put();
            					}
            				}
...
HXLINE(1080)		int i = 0;
HXLINE(1082)		if (start->_weak) {
HXLINE(1082)			start->put();
            		}
HXLINE(1083)		if (end->_weak) {
HXLINE(1083)			end->put();
            		}
...
HXLINE(1122)					_hx_tmp = (ry <= (tileY + this->scaledTileHeight));
            				}
            				else {
...
HXLINE(1144)					_hx_tmp1 = (rx <= (tileX + this->scaledTileWidth));
            				}
            				else {
...
HXLINE(1148)						 ::flixel::math::FlxBasePoint point = ::flixel::math::FlxBasePoint_obj::pool->get().StaticCast<  ::flixel::math::FlxBasePoint >()->set(( (Float)(0) ),( (Float)(0) ));
HXDLIN(1148)						point->_inPool = false;
HXDLIN(1148)						result = point;
            					}
HXLINE(1151)					{
HXLINE(1151)						Float y = (ry + this->y);
HXDLIN(1151)						result->set_x((rx + this->x));
HXDLIN(1151)						result->set_y(y);
            					}
...
HXLINE(1197)			int _hx_tmp;
HXDLIN(1197)			bool _hx_tmp1;
HXDLIN(1197)			bool _hx_tmp2;
HXDLIN(1197)			if ((tileX >= 0)) {
HXLINE(1197)				_hx_tmp2 = (tileX < this->widthInTiles);
            			}
            			else {
...
HXLINE(1197)					_hx_tmp1 = (tileY < this->heightInTiles);
            				}
            				else {
...
HXLINE(1197)				_hx_tmp = ((tileY * this->widthInTiles) + tileX);
            			}
            			else {
HXLINE(1197)				_hx_tmp = -1;
            			}
HXDLIN(1197)			this->setTileHelper(_hx_tmp,newTile,true);
            		}
...
HXDLIN(1235)				if (point->_weak) {
HXLINE(1235)					point->put();
            				}
...
HXLINE(1275)				{
HXLINE(1275)					int _g1 = 0;
HXDLIN(1275)					int _g2 = screenColumns;
HXDLIN(1275)					while((_g1 < _g2)){
HXLINE(1275)						_g1 = (_g1 + 1);
HXDLIN(1275)						int column = (_g1 - 1);
...
HXLINE(1279)							_hx_tmp1 = tile->visible;
            						}
            						else {
HXLINE(1279)							_hx_tmp1 = false;
            						}
HXDLIN(1279)						if (_hx_tmp1) {
HXLINE(1279)							_hx_tmp = (tile->frame->type != 2);
            						}
            						else {
...
HXLINE(1288)									_hx_tmp = !(this->ignoreDrawDebug);
            								}
            								else {
...
HXLINE(1303)									{
HXLINE(1303)										 ::flixel::math::FlxBasePoint this1 = this->offset;
HXDLIN(1303)										 ::openfl::geom::Point p = this->_flashPoint;
HXDLIN(1303)										 ::openfl::geom::Point p1 = p;
HXDLIN(1303)										p1->x = (p1->x + this1->x);
HXDLIN(1303)										 ::openfl::geom::Point p2 = p;
HXDLIN(1303)										p2->y = (p2->y + this1->y);
            									}
HXLINE(1304)									buffer->pixels->copyPixels(debugTile,this->_debugRect,this->_flashPoint,null(),null(),true);
HXLINE(1305)									{
HXLINE(1305)										 ::flixel::math::FlxBasePoint this2 = this->offset;
HXDLIN(1305)										 ::openfl::geom::Point p3 = this->_flashPoint;
HXDLIN(1305)										 ::openfl::geom::Point p4 = p3;
HXDLIN(1305)										p4->x = (p4->x - this2->x);
HXDLIN(1305)										 ::openfl::geom::Point p5 = p3;
HXDLIN(1305)										p5->y = (p5->y - this2->y);
            									}
            								}
            							}
            							else {
...
HXLINE(1338)					 ::openfl::geom::Point fh = this->_flashPoint;
HXDLIN(1338)					fh->y = (fh->y + this->tileHeight);
            				}
...
HXLINE(1479)			 ::openfl::geom::ColorTransform transform = this->colorTransform;
HXDLIN(1479)			transform->redMultiplier = ( (Float)(1) );
HXDLIN(1479)			transform->greenMultiplier = ( (Float)(1) );
HXDLIN(1479)			transform->blueMultiplier = ( (Float)(1) );
HXDLIN(1479)			transform->alphaMultiplier = ( (Float)(1) );
            		}
