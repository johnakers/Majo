...
HXLINE( 107)			Float object1 = object->x;
HXDLIN( 107)			Float _hx_tmp = ( ( ::flixel::FlxObject)(__this) )->x;
HXLINE( 106)			_hx_tmp2 = (object1 < (_hx_tmp + ( ( ::flixel::FlxObject)(__this) )->get_width()));
            		}
            		else {
HXDLIN( 106)			_hx_tmp2 = false;
            		}
HXDLIN( 106)		if (_hx_tmp2) {
HXLINE( 108)			Float object1 = object->y;
HXDLIN( 108)			Float _hx_tmp = (object1 + object->get_height());
HXLINE( 106)			_hx_tmp1 = (_hx_tmp > ( ( ::flixel::FlxObject)(__this) )->y);
            		}
            		else {
HXDLIN( 106)			_hx_tmp1 = false;
            		}
HXDLIN( 106)		if (_hx_tmp1) {
HXLINE( 109)			Float object1 = object->y;
HXDLIN( 109)			Float _hx_tmp1 = ( ( ::flixel::FlxObject)(__this) )->y;
HXLINE( 106)			_hx_tmp = (object1 < (_hx_tmp1 + ( ( ::flixel::FlxObject)(__this) )->get_height()));
            		}
            		else {
