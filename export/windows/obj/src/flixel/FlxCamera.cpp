...
HXLINE( 611)			HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(HX_("Attempted to queue an invalid FlxDrawItem, did you destroy a cached sprite?",e4,69,53,a4)));
            		}
...
HXLINE( 769)					_hx_tmp = this->antialiasing;
            				}
            				else {
HXLINE( 769)					_hx_tmp = true;
            				}
HXDLIN( 769)				this->buffer->draw(pixels,this->_helperMatrix,null(),blend,null(),_hx_tmp);
            			}
            		}
            		else {
...
HXDLIN( 802)					int _hx_tmp = ::Std_obj::_hx_int(this->viewMarginX);
HXDLIN( 802)					this->_helperPoint->x = (destPoint1 - ( (Float)(_hx_tmp) ));
HXLINE( 803)					Float destPoint2 = destPoint->y;
HXDLIN( 803)					int _hx_tmp1 = ::Std_obj::_hx_int(this->viewMarginY);
HXDLIN( 803)					this->_helperPoint->y = (destPoint2 - ( (Float)(_hx_tmp1) ));
...
HXLINE( 846)			{
HXLINE( 846)				::Dynamic this1 = ::flixel::FlxCamera_obj::drawVertices;
HXDLIN( 846)				int deleteCount = ::flixel::FlxCamera_obj::drawVertices->get_length();
HXDLIN( 846)				::cpp::VirtualArray this2 = ::cpp::VirtualArray_obj::__new(0);
HXDLIN( 846)				this1->__SetField(HX_("__tempIndex",3e,e8,54,22),0,::hx::paccDynamic);
HXDLIN( 846)				{
HXLINE( 846)					int _g_current = 0;
HXDLIN( 846)					::cpp::VirtualArray _g_args = this2;
...
HXDLIN( 846)						( ( ::openfl::_Vector::FloatVector)(this1) )->insertAt(( (int)(this1->__Field(HX_("__tempIndex",3e,e8,54,22),::hx::paccDynamic)) ),( (Float)(item) ));
HXDLIN( 846)						::hx::FieldRef((this1).mPtr,HX_("__tempIndex",3e,e8,54,22))++;
            					}
            				}
HXDLIN( 846)				( ( ::openfl::_Vector::FloatVector)(this1) )->splice(( (int)(this1->__Field(HX_("__tempIndex",3e,e8,54,22),::hx::paccDynamic)) ),deleteCount);
            			}
...
HXLINE( 862)						 ::flixel::math::FlxRect bounds1 = bounds;
HXDLIN( 862)						bounds1->height = (bounds1->height + (bounds->y - tempY));
...
HXLINE( 868)			if (position->_weak) {
HXLINE( 868)				position->put();
            			}
HXLINE( 870)			 ::flixel::math::FlxRect _this2 = this->_bounds;
HXDLIN( 870)			bool result;
HXDLIN( 870)			bool result1;
HXDLIN( 870)			bool result2;
HXDLIN( 870)			if (((bounds->x + bounds->width) > _this2->x)) {
HXLINE( 870)				result2 = (bounds->x < (_this2->x + _this2->width));
            			}
            			else {
HXLINE( 870)				result2 = false;
            			}
HXDLIN( 870)			if (result2) {
HXLINE( 870)				result1 = ((bounds->y + bounds->height) > _this2->y);
            			}
            			else {
HXLINE( 870)				result1 = false;
            			}
HXDLIN( 870)			if (result1) {
HXLINE( 870)				result = (bounds->y < (_this2->y + _this2->height));
            			}
            			else {
...
HXLINE( 872)				::Dynamic this1 = ::flixel::FlxCamera_obj::drawVertices;
HXDLIN( 872)				::cpp::VirtualArray this2 = ::cpp::VirtualArray_obj::__new(0);
HXDLIN( 872)				this1->__SetField(HX_("__tempIndex",3e,e8,54,22),(::flixel::FlxCamera_obj::drawVertices->get_length() - verticesLength),::hx::paccDynamic);
HXDLIN( 872)				{
HXLINE( 872)					int _g_current = 0;
HXDLIN( 872)					::cpp::VirtualArray _g_args = this2;
...
HXDLIN( 872)						( ( ::openfl::_Vector::FloatVector)(this1) )->insertAt(( (int)(this1->__Field(HX_("__tempIndex",3e,e8,54,22),::hx::paccDynamic)) ),( (Float)(item) ));
HXDLIN( 872)						::hx::FieldRef((this1).mPtr,HX_("__tempIndex",3e,e8,54,22))++;
            					}
            				}
HXDLIN( 872)				( ( ::openfl::_Vector::FloatVector)(this1) )->splice(( (int)(this1->__Field(HX_("__tempIndex",3e,e8,54,22),::hx::paccDynamic)) ),verticesLength);
            			}
            			else {
...
HXLINE( 908)			{
HXLINE( 908)				 ::flixel::math::FlxRect _this = this->_bounds;
HXDLIN( 908)				_this->x = ( (Float)(0) );
HXDLIN( 908)				_this->y = ( (Float)(0) );
HXDLIN( 908)				_this->width = ( (Float)(this->width) );
HXDLIN( 908)				_this->height = ( (Float)(this->height) );
            			}
...
HXLINE( 936)				 ::flixel::math::FlxRect rect1 = rect;
HXDLIN( 936)				rect1->x = (rect1->x * this->zoom);
HXLINE( 937)				 ::flixel::math::FlxRect rect2 = rect;
HXDLIN( 937)				rect2->y = (rect2->y * this->zoom);
HXLINE( 938)				 ::flixel::math::FlxRect rect3 = rect;
HXDLIN( 938)				rect3->width = (rect3->width * this->zoom);
HXLINE( 939)				 ::flixel::math::FlxRect rect4 = rect;
HXDLIN( 939)				rect4->height = (rect4->height * this->zoom);
            			}
            		}
...
HXLINE(1214)					Float _hx_tmp = (targetY + this->target->get_height());
HXDLIN(1214)					if ((_hx_tmp < (this->scroll->y + this->viewMarginY))) {
...
HXDLIN(1251)					Float y = this->target->y;
HXDLIN(1251)					 ::flixel::math::FlxBasePoint point = ::flixel::math::FlxBasePoint_obj::pool->get().StaticCast<  ::flixel::math::FlxBasePoint >()->set(x,y);
HXDLIN(1251)					point->_inPool = false;
HXDLIN(1251)					this->_lastTargetPosition = point;
            				}
...
HXLINE(1307)			 ::flixel::FlxCamera _hx_tmp = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN(1307)			_hx_tmp->_fxFadeAlpha = (_hx_tmp->_fxFadeAlpha + (elapsed / this->_fxFadeDuration));
...
HXDLIN(1344)					Float _hx_tmp = fh->get_x();
HXDLIN(1344)					fh->set_x((_hx_tmp + ((shakePixels1 * this->zoom) * ::flixel::FlxG_obj::scaleMode->scale->x)));
            				}
HXLINE(1347)				int this2 = this->_fxShakeAxes;
HXDLIN(1347)				bool _hx_tmp1;
HXDLIN(1347)				if ((this2 != 16)) {
HXLINE(1347)					_hx_tmp1 = (this2 == 17);
            				}
            				else {
HXLINE(1347)					_hx_tmp1 = true;
            				}
HXDLIN(1347)				if (_hx_tmp1) {
HXLINE(1349)					Float shakePixels = ::flixel::FlxG_obj::random->_hx_float(-1,1,null());
HXDLIN(1349)					Float shakePixels1 = ((shakePixels * this->_fxShakeIntensity) * ( (Float)(this->height) ));
HXLINE(1350)					if (( (bool)(pixelPerfect) )) {
HXLINE(1351)						shakePixels1 = ( (Float)(::Math_obj::round(shakePixels1)) );
            					}
HXLINE(1353)					 ::openfl::display::Sprite fh = this->flashSprite;
HXDLIN(1353)					Float _hx_tmp = fh->get_y();
HXDLIN(1353)					fh->set_y((_hx_tmp + ((shakePixels1 * this->zoom) * ::flixel::FlxG_obj::scaleMode->scale->y)));
            				}
            			}
            		}
            	}
...
HXDLIN(1475)				this->deadzone = rect;
            			...
            			break;
            			case (int)1: {
HXLINE(1478)				Float w = (( (Float)(this->width) ) / ( (Float)(8) ));
HXLINE(1479)				Float h = (( (Float)(this->height) ) / ( (Float)(3) ));
HXLINE(1480)				Float X = ((( (Float)(this->width) ) - w) / ( (Float)(2) ));
HXDLIN(1480)				Float Y = (((( (Float)(this->height) ) - h) / ( (Float)(2) )) - (h * ((Float)0.25)));
HXDLIN(1480)				 ::flixel::math::FlxRect _this = ::flixel::math::FlxRect_obj::_pool->get().StaticCast<  ::flixel::math::FlxRect >();
HXDLIN(1480)				_this->x = X;
HXDLIN(1480)				_this->y = Y;
HXDLIN(1480)				_this->width = w;
HXDLIN(1480)				_this->height = h;
HXDLIN(1480)				 ::flixel::math::FlxRect rect = _this;
HXDLIN(1480)				rect->_inPool = false;
HXDLIN(1480)				this->deadzone = rect;
            			}
            			break;
            			case (int)2: {
HXLINE(1483)				Float helper = (::Math_obj::max(( (Float)(this->width) ),( (Float)(this->height) )) / ( (Float)(4) ));
HXLINE(1484)				Float X = ((( (Float)(this->width) ) - helper) / ( (Float)(2) ));
HXDLIN(1484)				Float Y = ((( (Float)(this->height) ) - helper) / ( (Float)(2) ));
HXDLIN(1484)				 ::flixel::math::FlxRect _this = ::flixel::math::FlxRect_obj::_pool->get().StaticCast<  ::flixel::math::FlxRect >();
HXDLIN(1484)				_this->x = X;
HXDLIN(1484)				_this->y = Y;
HXDLIN(1484)				_this->width = helper;
HXDLIN(1484)				_this->height = helper;
HXDLIN(1484)				 ::flixel::math::FlxRect rect = _this;
HXDLIN(1484)				rect->_inPool = false;
HXDLIN(1484)				this->deadzone = rect;
            			}
            			break;
            			case (int)3: {
HXLINE(1487)				Float helper = (::Math_obj::max(( (Float)(this->width) ),( (Float)(this->height) )) / ( (Float)(8) ));
HXLINE(1488)				Float X = ((( (Float)(this->width) ) - helper) / ( (Float)(2) ));
HXDLIN(1488)				Float Y = ((( (Float)(this->height) ) - helper) / ( (Float)(2) ));
HXDLIN(1488)				 ::flixel::math::FlxRect _this = ::flixel::math::FlxRect_obj::_pool->get().StaticCast<  ::flixel::math::FlxRect >();
HXDLIN(1488)				_this->x = X;
HXDLIN(1488)				_this->y = Y;
HXDLIN(1488)				_this->width = helper;
HXDLIN(1488)				_this->height = helper;
HXDLIN(1488)				 ::flixel::math::FlxRect rect = _this;
HXDLIN(1488)				rect->_inPool = false;
HXDLIN(1488)				this->deadzone = rect;
            			}
            			break;
            			case (int)4: {
HXLINE(1491)				Float Width = ( (Float)(this->width) );
HXDLIN(1491)				Float Height = ( (Float)(this->height) );
HXDLIN(1491)				 ::flixel::math::FlxRect _this = ::flixel::math::FlxRect_obj::_pool->get().StaticCast<  ::flixel::math::FlxRect >();
HXDLIN(1491)				_this->x = ( (Float)(0) );
HXDLIN(1491)				_this->y = ( (Float)(0) );
HXDLIN(1491)				_this->width = Width;
HXDLIN(1491)				_this->height = Height;
HXDLIN(1491)				 ::flixel::math::FlxRect rect = _this;
HXDLIN(1491)				rect->_inPool = false;
HXDLIN(1491)				this->deadzone = rect;
            			}
            			break;
            			case (int)5: {
...
HXLINE(1516)		if (point->_weak) {
HXLINE(1516)			point->put();
            		}
            	}
...
HXLINE(1651)				{
HXLINE(1651)					 ::flixel::math::FlxRect _this = this->deadzone;
HXDLIN(1651)					 ::flixel::math::FlxRect Rect = Camera->deadzone;
HXDLIN(1651)					_this->x = Rect->x;
HXDLIN(1651)					_this->y = Rect->y;
HXDLIN(1651)					_this->width = Rect->width;
HXDLIN(1651)					_this->height = Rect->height;
...
HXLINE(1720)				int color = this->_fxFadeColor;
HXLINE(1721)				{
HXLINE(1721)					Float Value = ((( (Float)(((color >> 24) & 255)) ) / ( (Float)(255) )) * this->_fxFadeAlpha);
HXDLIN(1721)					{
HXLINE(1721)						int Value1 = ::Math_obj::round((Value * ( (Float)(255) )));
HXDLIN(1721)						color = (color & 16777215);
HXDLIN(1721)						int color1;
HXDLIN(1721)						if ((Value1 > 255)) {
HXLINE(1721)							color1 = 255;
            						}
            						else {
HXLINE(1721)							if ((Value1 < 0)) {
HXLINE(1721)								color1 = 0;
            							}
            							else {
HXLINE(1721)								color1 = Value1;
            							}
            						}
HXDLIN(1721)						color = (color | (color1 << 24));
            					}
            				}
HXLINE(1722)				this->fill(color,null(),null(),null());
            			}
            			else {
HXLINE(1726)				Float alpha = ((( (Float)(((this->_fxFadeColor >> 24) & 255)) ) / ( (Float)(255) )) * this->_fxFadeAlpha);
HXLINE(1727)				int _hx_tmp = (this->_fxFadeColor & 16777215);
HXDLIN(1727)				this->fill(_hx_tmp,true,alpha,this->canvas->get_graphics());
            			}
            		}
            	}
...
HXLINE(1898)		if (point->_weak) {
HXLINE(1898)			point->put();
            		}
...
HXDLIN(2125)		HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(HX_("don't reference camera.camera",c9,e5,ca,73)));
...
HXDLIN(2129)		HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(HX_("don't reference camera.camera",c9,e5,ca,73)));
...
HXDLIN(2133)		HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(HX_("don't reference camera.cameras",8a,2a,be,dd)));
...
HXDLIN(2137)		HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(HX_("don't reference camera.cameras",8a,2a,be,dd)));
