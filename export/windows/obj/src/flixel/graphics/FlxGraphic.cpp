...
HXLINE(  54)		 ::flixel::_hx_system::debug::log::LogStyle logStyle = null();
HXDLIN(  54)		bitmap = ( ( ::openfl::display::BitmapData)(::flixel::FlxG_obj::assets->getAsset(Source,HX_("image",5b,1f,69,bd),false,logStyle)) );
