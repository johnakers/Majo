...
HXLINE( 196)			HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(((HX_("addNode can't find BitmapData with specified key: ",7b,9b,ce,f1) + ::Std_obj::string(Graphic)) + HX_(". Please provide valid value.",84,e6,88,32))));
            		}
...
HXLINE( 628)			HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(((HX_("addNodeWithSpacings can't find BitmapData with specified key: ",e5,6a,ec,e9) + ::Std_obj::string(Graphic)) + HX_(". Please provide valid value.",84,e6,88,32))));
            		}
...
HXLINE( 639)			HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(((HX_("addNodeWithSpacings can't insert provided image: ",a1,49,3a,35) + ::Std_obj::string(Graphic)) + HX_(") in atlas. It's probably too big.",a7,39,69,92))));
            		}
