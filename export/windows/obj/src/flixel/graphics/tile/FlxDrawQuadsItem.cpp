...
HX_LOCAL_STACK_FRAME(_hx_pos_6d98322fc3998392_143_setParameterValue,"flixel.graphics.tile.FlxDrawQuadsItem","setParameterValue",0x1b657834,"flixel.graphics.tile.FlxDrawQuadsItem.setParameterValue","flixel/graphics/tile/FlxDrawQuadsItem.hx",143,0x0f089c65)
...
HXLINE( 136)		camera->canvas->get_graphics()->overrideBlendMode(this->blend);
HXLINE( 137)		camera->canvas->get_graphics()->beginShaderFill(shader,null());
HXLINE( 138)		camera->canvas->get_graphics()->drawQuads(this->rects,null(),this->transforms);
HXLINE( 139)		this->super::render(camera);
            	}


void FlxDrawQuadsItem_obj::setParameterValue( ::openfl::display::ShaderParameter_Bool parameter,bool value){
            	HX_STACKFRAME(&_hx_pos_6d98322fc3998392_143_setParameterValue)
HXLINE( 144)		if (::hx::IsNull( parameter->value )) {
HXLINE( 145)			parameter->value = ::Array_obj< bool >::__new(0);
            		}
HXLINE( 146)		parameter->value[0] = value;
            	}
