...
HXLINE(  93)		if (::flixel::FlxG_obj::debugger->drawDebug) {
HXLINE(  95)			 ::openfl::display::Graphics gfx = camera->debugLayer->get_graphics();
HXLINE(  96)			gfx->lineStyle(1,-16776961,((Float)0.5),null(),null(),null(),null(),null());
HXLINE(  97)			gfx->drawTriangles(this->vertices,this->indices,this->uvtData,null());
            		}
...
HXLINE( 169)			if ((i == 0)) {
HXLINE( 171)				 ::flixel::math::FlxRect _this = this->bounds;
HXDLIN( 171)				_this->x = tempX;
HXDLIN( 171)				_this->y = tempY;
...
HXLINE( 175)					 ::flixel::math::FlxRect bounds1 = bounds;
HXDLIN( 175)					bounds1->height = (bounds1->height + (bounds->y - tempY));
...
HXLINE( 184)			::Dynamic this1 = this->vertices;
HXDLIN( 184)			::cpp::VirtualArray this2 = ::cpp::VirtualArray_obj::__new(0);
HXDLIN( 184)			this1->__SetField(HX_("__tempIndex",3e,e8,54,22),(this->vertices->get_length() - verticesLength),::hx::paccDynamic);
HXDLIN( 184)			{
HXLINE( 184)				int _g_current = 0;
HXDLIN( 184)				::cpp::VirtualArray _g_args = this2;
...
HXDLIN( 184)					( ( ::openfl::_Vector::FloatVector)(this1) )->insertAt(( (int)(this1->__Field(HX_("__tempIndex",3e,e8,54,22),::hx::paccDynamic)) ),( (Float)(item) ));
HXDLIN( 184)					::hx::FieldRef((this1).mPtr,HX_("__tempIndex",3e,e8,54,22))++;
            				}
            			}
HXDLIN( 184)			( ( ::openfl::_Vector::FloatVector)(this1) )->splice(( (int)(this1->__Field(HX_("__tempIndex",3e,e8,54,22),::hx::paccDynamic)) ),verticesLength);
            		}
            		else {
...
HXLINE( 191)					{
HXLINE( 191)						::Dynamic this1 = this->uvtData;
HXDLIN( 191)						( ( ::openfl::_Vector::FloatVector)(this1) )->set((prevUVTDataLength + i),uvtData->get(i));
            					}
            				}
            			}
HXLINE( 194)			{
...
HXDLIN( 194)					int i = (_g2 - 1);
HXLINE( 196)					{
HXLINE( 196)						::Dynamic this1 = this->indices;
HXDLIN( 196)						( ( ::openfl::_Vector::IntVector)(this1) )->set((prevIndicesLength + i),(indices->get(i) + prevNumberOfVertices));
            					}
            				}
            			}
...
HXLINE( 201)				{
HXLINE( 201)					int _g = 0;
HXDLIN( 201)					int _g1 = numberOfVertices;
HXDLIN( 201)					while((_g < _g1)){
HXLINE( 201)						_g = (_g + 1);
HXDLIN( 201)						int i = (_g - 1);
HXLINE( 203)						{
HXLINE( 203)							::Dynamic this1 = this->colors;
HXDLIN( 203)							( ( ::openfl::_Vector::IntVector)(this1) )->set((prevColorsLength + i),colors->get(i));
            						}
            					}
            				}
...
HXLINE( 209)			 ::flixel::graphics::tile::FlxDrawTrianglesItem _hx_tmp = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 209)			_hx_tmp->verticesPosition = (_hx_tmp->verticesPosition + verticesLength);
HXLINE( 210)			 ::flixel::graphics::tile::FlxDrawTrianglesItem _hx_tmp1 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 210)			_hx_tmp1->indicesPosition = (_hx_tmp1->indicesPosition + indicesLength);
            		}
HXLINE( 213)		if (position->_weak) {
HXLINE( 213)			position->put();
            		}
...
HXLINE( 217)		{
HXLINE( 217)			int _g = 0;
HXDLIN( 217)			int _g1 = indicesLength;
HXDLIN( 217)			while((_g < _g1)){
HXLINE( 217)				_g = (_g + 1);
HXDLIN( 217)				int _ = (_g - 1);
HXLINE( 219)				Float _hx_tmp;
HXDLIN( 219)				if (::hx::IsNotNull( transform )) {
HXLINE( 219)					_hx_tmp = transform->alphaMultiplier;
            				}
            				else {
HXLINE( 219)					_hx_tmp = ((Float)1.0);
            				}
HXDLIN( 219)				this->alphas->push(_hx_tmp);
            			}
            		}
HXLINE( 222)		bool _hx_tmp;
HXDLIN( 222)		if (!(this->colored)) {
HXLINE( 222)			_hx_tmp = this->hasColorOffsets;
            		}
            		else {
...
HXLINE( 230)			{
HXLINE( 230)				int _g = 0;
HXDLIN( 230)				int _g1 = indicesLength;
HXDLIN( 230)				while((_g < _g1)){
HXLINE( 230)					_g = (_g + 1);
HXDLIN( 230)					int _ = (_g - 1);
...
HXDLIN( 375)		_hx_tmp->verticesPosition = (_hx_tmp->verticesPosition + 8);
HXLINE( 376)		 ::flixel::graphics::tile::FlxDrawTrianglesItem _hx_tmp1 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 376)		_hx_tmp1->indicesPosition = (_hx_tmp1->indicesPosition + 6);
            	}
...
HXLINE( 278)			 ::flixel::math::FlxRect bounds1 = bounds;
HXDLIN( 278)			bounds1->height = (bounds1->height + (bounds->y - y));
