...
HXDLIN( 218)				::flixel::FlxG_obj::log->advanced(_hx_tmp,::flixel::_hx_system::debug::log::LogStyle_obj::WARNING,true,::hx::SourceInfo(HX_("flixel/graphics/frames/FlxFramesCollection.hx",00,d2,9d,e0),245,HX_("flixel.graphics.frames.FlxFramesCollection",ff,be,62,54),HX_("forEachByPrefix",93,be,d0,ba)));
            			}
            		}
...
HXDLIN( 245)			::flixel::FlxG_obj::log->advanced(_hx_tmp,::flixel::_hx_system::debug::log::LogStyle_obj::WARNING,true,::hx::SourceInfo(HX_("flixel/graphics/frames/FlxFramesCollection.hx",00,d2,9d,e0),245,HX_("flixel.graphics.frames.FlxFramesCollection",ff,be,62,54),HX_("forEachByPrefix",93,be,d0,ba)));
            		}
            	}
...
HXLINE( 264)			::flixel::FlxG_obj::log->advanced((HX_("No frame called ",11,02,4c,19) + name),::flixel::_hx_system::debug::log::LogStyle_obj::WARNING,true,::hx::SourceInfo(HX_("flixel/graphics/frames/FlxFramesCollection.hx",00,d2,9d,e0),264,HX_("flixel.graphics.frames.FlxFramesCollection",ff,be,62,54),HX_("setFrameOffset",1e,9f,45,e6)));
            		}
            	}
...
HXLINE( 283)			::flixel::FlxG_obj::log->advanced((HX_("No frame called ",11,02,4c,19) + name),::flixel::_hx_system::debug::log::LogStyle_obj::WARNING,true,::hx::SourceInfo(HX_("flixel/graphics/frames/FlxFramesCollection.hx",00,d2,9d,e0),283,HX_("flixel.graphics.frames.FlxFramesCollection",ff,be,62,54),HX_("addFrameOffset",ff,6a,5e,d4)));
            		}
            	}
...
HXDLIN( 299)			::flixel::FlxG_obj::log->advanced(_hx_tmp,::flixel::_hx_system::debug::log::LogStyle_obj::WARNING,true,::hx::SourceInfo(HX_("flixel/graphics/frames/FlxFramesCollection.hx",00,d2,9d,e0),245,HX_("flixel.graphics.frames.FlxFramesCollection",ff,be,62,54),HX_("forEachByPrefix",93,be,d0,ba)));
            		}
            	}
...
HXDLIN( 315)			::flixel::FlxG_obj::log->advanced(_hx_tmp,::flixel::_hx_system::debug::log::LogStyle_obj::WARNING,true,::hx::SourceInfo(HX_("flixel/graphics/frames/FlxFramesCollection.hx",00,d2,9d,e0),245,HX_("flixel.graphics.frames.FlxFramesCollection",ff,be,62,54),HX_("forEachByPrefix",93,be,d0,ba)));
            		}
            	}
...
HXLINE( 333)			::flixel::FlxG_obj::log->advanced((HX_("No frame called ",11,02,4c,19) + name),::flixel::_hx_system::debug::log::LogStyle_obj::WARNING,true,::hx::SourceInfo(HX_("flixel/graphics/frames/FlxFramesCollection.hx",00,d2,9d,e0),333,HX_("flixel.graphics.frames.FlxFramesCollection",ff,be,62,54),HX_("setFrameDuration",9f,4f,cd,ad)));
            		}
            	}
...
HXLINE( 354)			::flixel::FlxG_obj::log->advanced(((HX_("The frame ",42,8b,9d,3a) + name) + HX_(" has incorrect data and results in an image with the size of (0, 0)",63,cf,34,3e)),::flixel::_hx_system::debug::log::LogStyle_obj::WARNING,true,::hx::SourceInfo(HX_("flixel/graphics/frames/FlxFramesCollection.hx",00,d2,9d,e0),354,HX_("flixel.graphics.frames.FlxFramesCollection",ff,be,62,54),HX_("checkFrame",45,7a,73,16)));
            		}
