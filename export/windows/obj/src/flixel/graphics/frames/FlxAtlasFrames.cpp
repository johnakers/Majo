...
HXDLIN(  92)				 ::Dynamic _g1_value = ::Reflect_obj::field(_g_access,key);
HXDLIN(  92)				::String _g1_key = key;
HXDLIN(  92)				::String name = _g1_key;
HXDLIN(  92)				 ::Dynamic frame = _g1_value;
HXLINE(  93)				::flixel::graphics::frames::FlxAtlasFrames_obj::texturePackerHelper(name,frame,frames,useFrameDuration);
            			}
            		}
...
HXLINE( 120)			Float X = ( (Float)(frame->__Field(HX_("x",78,00,00,00),::hx::paccDynamic)) );
HXDLIN( 120)			Float Y = ( (Float)(frame->__Field(HX_("y",79,00,00,00),::hx::paccDynamic)) );
HXDLIN( 120)			Float Width = ( (Float)(frame->__Field(HX_("w",77,00,00,00),::hx::paccDynamic)) );
HXDLIN( 120)			Float Height = ( (Float)(frame->__Field(HX_("h",68,00,00,00),::hx::paccDynamic)) );
HXDLIN( 120)			 ::flixel::math::FlxRect _this = ::flixel::math::FlxRect_obj::_pool->get().StaticCast<  ::flixel::math::FlxRect >();
HXDLIN( 120)			_this->x = X;
HXDLIN( 120)			_this->y = Y;
HXDLIN( 120)			_this->width = Width;
HXDLIN( 120)			_this->height = Height;
HXDLIN( 120)			 ::flixel::math::FlxRect rect = _this;
HXDLIN( 120)			rect->_inPool = false;
HXDLIN( 120)			frameRect = rect;
            		}
...
HXLINE( 252)			HX_STACK_DO_THROW(::haxe::Exception_obj::thrown((HX_("Invalid nodeType ",3b,e0,cb,e1) + ::_Xml::XmlType_Impl__obj::toString(x->nodeType))));
            		}
HXDLIN( 252)		 ::Xml this1 = x;
HXDLIN( 252)		 ::Xml data = this1;
HXLINE( 254)		{
HXLINE( 254)			int _g = 0;
...
HXLINE( 256)					_hx_tmp = ::haxe::xml::_Access::HasAttribAccess_Impl__obj::resolve(texture,HX_("w",77,00,00,00));
            				}
            				else {
HXLINE( 256)					_hx_tmp = false;
            				}
HXDLIN( 256)				if (_hx_tmp) {
HXLINE( 257)					HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(HX_("Sparrow v1 is not supported, use Sparrow v2",19,0e,b0,4e)));
            				}
...
HXLINE( 270)					Float X = ( (Float)(::Std_obj::parseInt(::haxe::xml::_Access::AttribAccess_Impl__obj::resolve(texture,HX_("frameX",8b,af,85,ac)))) );
HXDLIN( 270)					Float Y = ( (Float)(::Std_obj::parseInt(::haxe::xml::_Access::AttribAccess_Impl__obj::resolve(texture,HX_("frameY",8c,af,85,ac)))) );
HXDLIN( 270)					Float Width = ( (Float)(::Std_obj::parseInt(::haxe::xml::_Access::AttribAccess_Impl__obj::resolve(texture,HX_("frameWidth",99,ea,88,ad)))) );
HXDLIN( 270)					Float Height = ( (Float)(::Std_obj::parseInt(::haxe::xml::_Access::AttribAccess_Impl__obj::resolve(texture,HX_("frameHeight",f4,d3,93,e0)))) );
...
HXLINE( 268)					size = rect;
            				}
            				else {
HXLINE( 275)					Float Width = rect1->width;
HXDLIN( 275)					Float Height = rect1->height;
HXDLIN( 275)					 ::flixel::math::FlxRect _this = ::flixel::math::FlxRect_obj::_pool->get().StaticCast<  ::flixel::math::FlxRect >();
HXDLIN( 275)					_this->x = ( (Float)(0) );
HXDLIN( 275)					_this->y = ( (Float)(0) );
HXDLIN( 275)					_this->width = Width;
HXDLIN( 275)					_this->height = Height;
HXDLIN( 275)					 ::flixel::math::FlxRect rect = _this;
HXDLIN( 275)					rect->_inPool = false;
HXLINE( 268)					size = rect;
            				}
...
HXLINE( 288)					_hx_tmp2 = (rect1->height == 0);
            				}
            				else {
...
HXLINE( 345)					{
HXLINE( 345)						Float x = ( (Float)(::Std_obj::parseInt(sprite1->get(HX_("oX",09,61,00,00)))) );
HXDLIN( 345)						Float y = ( (Float)(::Std_obj::parseInt(sprite1->get(HX_("oY",0a,61,00,00)))) );
HXDLIN( 345)						offset->set_x(x);
HXDLIN( 345)						offset->set_y(y);
            					}
HXLINE( 346)					{
HXLINE( 346)						Float x1 = ( (Float)(::Std_obj::parseInt(sprite1->get(HX_("oW",08,61,00,00)))) );
HXDLIN( 346)						Float y1 = ( (Float)(::Std_obj::parseInt(sprite1->get(HX_("oH",f9,60,00,00)))) );
HXDLIN( 346)						sourceSize->set_x(x1);
HXDLIN( 346)						sourceSize->set_y(y1);
            					}
            				}
