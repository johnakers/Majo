...
HXDLIN(  25)				HX_STACK_DO_THROW(::haxe::Exception_obj::thrown((HX_("Bad node type, expected Element but found ",d8,90,8b,bb) + ::_Xml::XmlType_Impl__obj::toString(this1->nodeType))));
            			}
...
HXLINE(  55)			HX_STACK_DO_THROW(::haxe::Exception_obj::thrown((HX_("Invalid nodeType ",3b,e0,cb,e1) + ::_Xml::XmlType_Impl__obj::toString(xml->nodeType))));
            		}
HXLINE(  52)		 ::Xml this1 = xml;
...
HXLINE(  64)			HX_STACK_DO_THROW(::haxe::Exception_obj::thrown((HX_("Cannot access document attribute ",ca,30,fe,c0) + name)));
            		}
...
HXLINE(  80)					HX_STACK_DO_THROW(::haxe::Exception_obj::thrown((HX_("Invalid nodeType ",3b,e0,cb,e1) + ::_Xml::XmlType_Impl__obj::toString(xml1->nodeType))));
            				}
HXDLIN(  80)				 ::Xml this1 = xml1;
HXDLIN(  80)				_g->push(this1);
            			}
            		}
HXLINE(  78)		return _g;
            	}
