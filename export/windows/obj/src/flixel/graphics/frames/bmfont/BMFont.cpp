...
HXLINE( 100)			::flixel::FlxG_obj::log->advanced(HX_("The BMFont parser is made to work on files with version 3. Using earlier versions can cause issues!",db,84,bd,6a),::flixel::_hx_system::debug::log::LogStyle_obj::WARNING,true,::hx::SourceInfo(HX_("flixel/graphics/frames/bmfont/BMFont.hx",e7,9e,ad,28),100,HX_("flixel.graphics.frames.bmfont.BMFont",37,ee,9f,e7),HX_("fromBytes",a1,f2,20,72)));
            		}
