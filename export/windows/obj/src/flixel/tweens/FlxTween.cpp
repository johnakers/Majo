...
HXLINE( 645)			Float _hx_tmp;
HXDLIN( 645)			if (this->backward) {
HXLINE( 645)				_hx_tmp = ( (Float)(0) );
            			}
            			else {
HXLINE( 645)				_hx_tmp = ( (Float)(1) );
            			}
HXDLIN( 645)			this->scale = _hx_tmp;
...
HXLINE( 725)				_hx_tmp = ::hx::IsNotNull( this->manager );
            			}
            			else {
...
HXLINE( 736)				_hx_tmp1 = (this->scale > 0);
            			}
            			else {
HXLINE( 736)				_hx_tmp1 = false;
            			}
HXDLIN( 736)			if (_hx_tmp1) {
HXLINE( 736)				_hx_tmp = (this->scale < 1);
            			}
            			else {
