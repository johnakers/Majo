...
HXDLIN( 267)				return true;
            			...
            			break;
            			case (int)6: {
HXLINE( 271)				::String _g = e->_hx_getString(0);
HXDLIN( 271)				 ::hscript::Expr _g1 = e->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
...
HXDLIN( 273)				return this->isBlock(e1);
            			...
            			break;
            			case (int)11: {
HXLINE( 275)				::String _g = e->_hx_getString(0);
HXDLIN( 275)				 ::hscript::Expr _g1 = e->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 275)				 ::hscript::Expr e1 = e->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
HXDLIN( 275)				return this->isBlock(e1);
            			}
            			break;
            			case (int)14: {
HXLINE( 268)				::Array< ::Dynamic> _g = e->_hx_getObject(0).StaticCast< ::Array< ::Dynamic> >();
HXDLIN( 268)				::String _g1 = e->_hx_getString(2);
HXDLIN( 268)				 ::hscript::CType _g2 = e->_hx_getObject(3).StaticCast<  ::hscript::CType >();
...
HXLINE( 276)					return false;
            			...
            			break;
            			case (int)20: {
HXLINE( 277)				 ::hscript::Expr _g = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXDLIN( 277)				::String _g1 = e->_hx_getString(1);
HXDLIN( 277)				 ::hscript::CType _g2 = e->_hx_getObject(2).StaticCast<  ::hscript::CType >();
...
HXDLIN( 267)				return true;
            			...
            			break;
            			case (int)23: {
HXLINE( 267)				 ::hscript::Expr _g = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXDLIN( 267)				::Array< ::Dynamic> _g1 = e->_hx_getObject(1).StaticCast< ::Array< ::Dynamic> >();
HXDLIN( 267)				 ::hscript::Expr _g2 = e->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
HXDLIN( 267)				return true;
            			}
            			break;
            			case (int)24: {
...
HXDLIN( 274)				return this->isBlock(e1);
            			...
            			break;
            			case (int)25: {
HXLINE( 278)				::String _g = e->_hx_getString(0);
HXDLIN( 278)				::Array< ::Dynamic> _g1 = e->_hx_getObject(1).StaticCast< ::Array< ::Dynamic> >();
...
HXDLIN( 289)					 ::hscript::Expr _g2 = e->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
...
HXLINE( 295)			_hx_tmp = ::hx::IsPointerNotEq( tk,::hscript::Token_obj::TEof_dyn() );
            		}
            		else {
...
HXLINE( 449)								_hx_tmp = ::hx::IsPointerNotEq( tk,::hscript::Token_obj::TEof_dyn() );
            							}
            							else {
...
HXDLIN( 457)						switch((int)(_g->_hx_getIndex())){
            							case (int)10: {
HXLINE( 458)								 ::hscript::Expr _g1 = _g->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
...
HXLINE( 465)								return this->parseExprNext(e);
            							...
            							break;
            							case (int)11: {
HXLINE( 458)								::String _g1 = _g->_hx_getString(0);
HXDLIN( 458)								 ::hscript::Expr _g2 = _g->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 458)								 ::hscript::Expr _g3 = _g->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
HXLINE( 459)								::String tmp = (HX_("__a_",fe,af,13,3f) + this->uid++);
HXLINE( 460)								 ::hscript::Expr e = ::hscript::Expr_obj::EBlock(::Array_obj< ::Dynamic>::__new(3)->init(0,::hscript::Expr_obj::EVar(tmp,null(),::hscript::Expr_obj::EArrayDecl(::Array_obj< ::Dynamic>::__new(0))))->init(1,this->mapCompr(tmp,a->__get(0).StaticCast<  ::hscript::Expr >()))->init(2,::hscript::Expr_obj::EIdent(tmp)));
HXLINE( 465)								return this->parseExprNext(e);
            							}
...
HXDLIN( 492)			if (!(__hxcpp_enum_eq(t,::hscript::Token_obj::TOp(HX_("->",71,27,00,00))))) {
...
HXDLIN( 530)				 ::hscript::Expr e2 = e->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
...
HXLINE( 523)					edef = ::hscript::Expr_obj::ECall(::hscript::Expr_obj::EField(::hscript::Expr_obj::EIdent(tmp),HX_("push",da,11,61,4a)),::Array_obj< ::Dynamic>::__new(1)->init(0,e));
            			...
            			break;
            			case (int)10: {
HXLINE( 526)				 ::hscript::Expr cond = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXDLIN( 526)				 ::hscript::Expr e2 = e->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
...
HXDLIN( 524)				 ::hscript::Expr e2 = e->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
HXLINE( 523)				edef = ::hscript::Expr_obj::EFor(v,it,this->mapCompr(tmp,e2));
            			}
            			break;
            			case (int)24: {
HXLINE( 528)				 ::hscript::Expr cond = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXDLIN( 528)				 ::hscript::Expr e2 = e->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
...
HXLINE( 545)		switch((int)(e->_hx_getIndex())){
            			case (int)6: {
HXLINE( 546)				::String bop = e->_hx_getString(0);
HXDLIN( 546)				 ::hscript::Expr e1 = e->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 546)				 ::hscript::Expr e2 = e->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
HXDLIN( 546)				return ::hscript::Expr_obj::EBinop(bop,this->makeUnop(op,e1),e2);
            			}
            			break;
            			case (int)22: {
HXLINE( 547)				 ::hscript::Expr e1 = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXDLIN( 547)				 ::hscript::Expr e2 = e->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 547)				 ::hscript::Expr e3 = e->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
...
HXLINE( 555)		switch((int)(e->_hx_getIndex())){
            			case (int)6: {
HXLINE( 556)				::String op2 = e->_hx_getString(0);
HXDLIN( 556)				 ::hscript::Expr e2 = e->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 556)				 ::hscript::Expr e3 = e->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
...
HXLINE( 560)					return ::hscript::Expr_obj::EBinop(op,e1,e);
            			...
            			break;
            			case (int)22: {
HXLINE( 561)				 ::hscript::Expr e2 = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXDLIN( 561)				 ::hscript::Expr e3 = e->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 561)				 ::hscript::Expr e4 = e->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
...
HXDLIN( 577)				if (::hx::IsPointerNotEq( t,::hscript::Token_obj::TPOpen_dyn() )) {
...
HXDLIN( 579)				if (::hx::IsPointerNotEq( t1,::hscript::Token_obj::TPClose_dyn() )) {
...
HXLINE( 584)			if (::hx::IsPointerEq( tk,::hscript::Token_obj::TSemicolon_dyn() )) {
HXLINE( 585)				semic = true;
HXLINE( 586)				tk = this->token();
            			}
HXLINE( 588)			if (__hxcpp_enum_eq(tk,::hscript::Token_obj::TId(HX_("else",b9,e4,14,43)))) {
...
HXDLIN( 649)			if (::hx::IsPointerEq( tk,::hscript::Token_obj::TSemicolon_dyn() )) {
HXLINE( 649)				e = null();
            			}
            			else {
...
HXDLIN( 688)				if (::hx::IsPointerNotEq( t,::hscript::Token_obj::TBrOpen_dyn() )) {
...
HXDLIN( 730)									if (::hx::IsPointerNotEq( t,::hscript::Token_obj::TDoubleDot_dyn() )) {
...
HXDLIN( 673)				if (!(__hxcpp_enum_eq(t,::hscript::Token_obj::TId(HX_("catch",3b,7c,21,41))))) {
HXLINE( 673)					this->unexpected(t);
            				}
            			}
HXLINE( 674)			{
HXLINE( 674)				 ::hscript::Token t1 = this->token();
HXDLIN( 674)				if (::hx::IsPointerNotEq( t1,::hscript::Token_obj::TPOpen_dyn() )) {
...
HXDLIN( 676)				if (::hx::IsPointerNotEq( t2,::hscript::Token_obj::TDoubleDot_dyn() )) {
...
HXDLIN( 681)				if (!(__hxcpp_enum_eq(t,::hscript::Token_obj::TId(HX_("Dynamic",5f,c7,66,03))))) {
HXLINE( 681)					this->unexpected(t);
            				}
            			}
HXLINE( 682)			{
HXLINE( 682)				 ::hscript::Token t4 = this->token();
HXDLIN( 682)				if (::hx::IsPointerNotEq( t4,::hscript::Token_obj::TPClose_dyn() )) {
...
HXDLIN( 599)			if (::hx::IsPointerEq( tk,::hscript::Token_obj::TDoubleDot_dyn() )) {
...
HXLINE( 604)			if (__hxcpp_enum_eq(tk,::hscript::Token_obj::TOp(HX_("=",3d,00,00,00)))) {
...
HXLINE( 774)									::String i = _hx_tmp->_hx_getString(0);
...
HXDLIN( 811)						if (::hx::IsPointerNotEq( t,::hscript::Token_obj::TBkClose_dyn() )) {
...
HXDLIN( 815)						if (::hx::IsPointerNotEq( t,::hscript::Token_obj::TDoubleDot_dyn() )) {
...
HXDLIN( 972)										if (::hx::IsPointerNotEq( t1,::hscript::Token_obj::TPClose_dyn() )) {
...
HXDLIN( 988)											if (::hx::IsPointerNotEq( t,::hscript::Token_obj::TDoubleDot_dyn() )) {
...
HXDLIN( 991)											if (::hx::IsPointerNotEq( t1,::hscript::Token_obj::TSemicolon_dyn() )) {
...
HXDLIN( 993)												if (::hx::IsPointerNotEq( t1,::hscript::Token_obj::TDoubleDot_dyn() )) {
...
HXDLIN(1157)				if (::hx::IsPointerNotEq( t,::hscript::Token_obj::TBrOpen_dyn() )) {
...
HXLINE(1121)				if (::hx::IsPointerNotEq( t,::hscript::Token_obj::TDot_dyn() )) {
HXLINE(1122)					{
...
HXDLIN(1135)				if (::hx::IsPointerNotEq( t,::hscript::Token_obj::TSemicolon_dyn() )) {
...
HXDLIN(1114)				if (::hx::IsPointerNotEq( t,::hscript::Token_obj::TSemicolon_dyn() )) {
...
HXDLIN(1174)				if (!(__hxcpp_enum_eq(t,::hscript::Token_obj::TOp(HX_("=",3d,00,00,00))))) {
...
HXDLIN(1236)						if (::hx::IsPointerNotEq( t,::hscript::Token_obj::TSemicolon_dyn() )) {
...
HXDLIN(1240)						if (::hx::IsPointerNotEq( t,::hscript::Token_obj::TSemicolon_dyn() )) {
...
HXLINE(1579)					 ::hscript::Expr e1 = _g;
...
HXLINE(1581)					 ::hscript::Expr e1 = _g;
HXDLIN(1581)					 ::hscript::Expr e2 = _g1;
