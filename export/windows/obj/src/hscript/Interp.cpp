...
HXLINE( 129)				v = this->set(this->expr(e),f,v);
            			...
            			break;
            			case (int)16: {
HXLINE( 130)				 ::hscript::Expr e = e1->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
...
HXLINE( 164)					v = this->set(obj,f,v);
            			...
            			break;
            			case (int)16: {
HXLINE( 165)				 ::hscript::Expr e = e1->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
...
HXLINE( 205)				return v;
            			...
            			break;
            			case (int)16: {
HXLINE( 206)				 ::hscript::Expr e1 = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
...
HXDLIN( 244)				 ::Dynamic _g1 = ::haxe::Exception_obj::caught(_g)->unwrap();
HXLINE( 242)				if (::Std_obj::isOfType(_g1,::hx::ClassOf< ::hscript::_Interp::Stop >())) {
HXLINE( 244)					 ::hscript::_Interp::Stop e = _g1;
...
HXLINE( 321)				return v;
            			...
            			break;
            			case (int)5: {
HXLINE( 322)				 ::hscript::Expr e1 = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXDLIN( 322)				::String f = e->_hx_getString(1);
...
HXDLIN( 324)				 ::hscript::Expr e2 = e->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
...
HXLINE( 327)				return fop(e1,e2);
            			...
            			break;
            			case (int)7: {
HXLINE( 328)				::String op = e->_hx_getString(0);
HXDLIN( 328)				bool prefix = e->_hx_getBool(1);
HXDLIN( 328)				 ::hscript::Expr e1 = e->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
...
HXDLIN( 341)					HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(e));
            			...
            			break;
            			case (int)8: {
HXLINE( 343)				 ::hscript::Expr e1 = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
...
HXLINE( 349)					 ::hscript::Expr e = e1->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXDLIN( 349)					::String f = e1->_hx_getString(1);
...
HXDLIN( 356)				 ::hscript::Expr e2 = e->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
...
HXLINE( 357)						return this->expr(e2);
            			...
            			break;
            			case (int)10: {
HXLINE( 358)				 ::hscript::Expr econd = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXDLIN( 358)				 ::hscript::Expr e1 = e->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXLINE( 359)				this->whileLoop(econd,e1);
HXLINE( 360)				return null();
            			}
            			break;
            			case (int)11: {
HXLINE( 364)				::String v = e->_hx_getString(0);
HXDLIN( 364)				 ::hscript::Expr it = e->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 364)				 ::hscript::Expr e1 = e->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
...
HXDLIN( 415)								 ::Dynamic e = ::haxe::Exception_obj::caught(_g)->unwrap();
...
HXLINE( 373)				HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(::hscript::_Interp::Stop_obj::SReturn_dyn()));
            			...
            			break;
            			case (int)16: {
HXLINE( 469)				 ::hscript::Expr e1 = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
...
HXLINE( 447)						 ::hscript::Expr _g1 = _g->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 447)						 ::hscript::Expr _g2 = _g->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
...
HXLINE( 452)									 ::hscript::Expr eKey = e->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 452)									 ::hscript::Expr eValue = e->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
HXDLIN( 452)									{
...
HXDLIN( 475)				::Array< ::Dynamic> params = e->_hx_getObject(1).StaticCast< ::Array< ::Dynamic> >();
...
HXLINE( 509)				return o;
            			...
            			break;
            			case (int)22: {
HXLINE( 510)				 ::hscript::Expr econd = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXDLIN( 510)				 ::hscript::Expr e1 = e->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 510)				 ::hscript::Expr e2 = e->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
...
HXLINE( 528)				return val;
            			...
            			break;
            			case (int)24: {
HXLINE( 361)				 ::hscript::Expr econd = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXDLIN( 361)				 ::hscript::Expr e1 = e->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXLINE( 362)				this->doWhileLoop(econd,e1);
HXLINE( 363)				return null();
            			}
            			break;
            			case (int)25: {
HXLINE( 529)				::String _g = e->_hx_getString(0);
HXDLIN( 529)				::Array< ::Dynamic> _g1 = e->_hx_getObject(1).StaticCast< ::Array< ::Dynamic> >();
...
HXDLIN( 587)					 ::Dynamic _g1 = ::haxe::Exception_obj::caught(_g)->unwrap();
HXLINE( 540)					if (::Std_obj::isOfType(_g1,::hx::ClassOf< ::hscript::_Interp::Stop >())) {
HXLINE( 587)						 ::hscript::_Interp::Stop err = _g1;
