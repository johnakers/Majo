...
HXLINE( 564)			_g(gamepad1,axis,value);
            		}
...
HXLINE( 565)			_g1(gamepad2,button);
            		}
...
HXLINE( 566)			_g2(gamepad3,button);
            		}
            		HX_END_LOCAL_FUNC1((void))
...
HXLINE( 565)		 ::Dynamic _g1 = this->onGamepadButtonDown_dyn();
...
HXLINE( 566)		 ::Dynamic _g2 = this->onGamepadButtonUp_dyn();
...
HXLINE( 567)		 ::Dynamic _g3 = this->onGamepadDisconnect_dyn();
...
HXLINE( 574)			_g(joystick1,axis,value);
            		}
            		HX_END_LOCAL_FUNC2((void))
...
HXLINE( 575)			_g1(joystick2,button);
            		}
            		HX_END_LOCAL_FUNC1((void))
...
HXLINE( 576)			_g2(joystick3,button);
            		}
            		HX_END_LOCAL_FUNC1((void))
...
HXLINE( 575)		 ::Dynamic _g1 = this->onJoystickButtonDown_dyn();
...
HXLINE( 576)		 ::Dynamic _g2 = this->onJoystickButtonUp_dyn();
...
HXLINE( 577)		 ::Dynamic _g3 = this->onJoystickDisconnect_dyn();
...
HXLINE( 578)		 ::Dynamic _g4 = this->onJoystickHatMove_dyn();
